...
var by;
function e_() {
  return by || (by = 1, kd.exports = WE()), kd.exports;
}
var b = e_(), Bd = { exports: {} }, Ve = {};
/**
 * @license React
 * react.production.js
 *
...
var wy;
function Ko() {
  return wy || (wy = 1, Bd.exports = t_()), Bd.exports;
}
var _ = Ko();
const ye = /* @__PURE__ */ Qh(_), n_ = /* @__PURE__ */ JE({
  __proto__: null,
  default: ye
}, [_]);
var Ud = { exports: {} }, Eo = {}, Vd = { exports: {} }, qd = {};
/**
 * @license React
...
var Ey;
function i_() {
  return Ey || (Ey = 1, Vd.exports = a_()), Vd.exports;
}
var $d = { exports: {} }, fn = {};
/**
 * @license React
...
function Qb() {
  ...
  return e(), $d.exports = r_(), $d.exports;
}
/**
 * @license React
...
function l_() {
  ...
  function ze(t) {
    ...
    var n = ne.current, i = $0(n, t.type);
    n !== i && (P(se, t), P(ne, i));
  }
  function Re(t) {
    se.current === t && (H(ne), H(se)), me.current === t && (H(me), vo._currentValue = F);
  }
  var Se, xe;
  function Ce(t) {
    if (Se === void 0)
...
` + o.stack;
  ...
  function Bm(t, n, i) {
    var o = n.indexOf("--") === 0;
    i == null || typeof i == "boolean" || i === "" ? o ? t.setProperty(n, "") : n === "float" ? t.cssFloat = "" : t[n] = "" : o ? t.setProperty(n, i) : typeof i != "number" || i === 0 || Fw.has(n) ? n === "float" ? t.cssFloat = i : t[n] = ("" + i).trim() : t[n] = i + "px";
  }
  function Um(t, n, i) {
    ...
    if (t = t.style, i != null) {
      ...
      for (var f in n)
        o = n[f], n.hasOwnProperty(f) && i[f] !== o && Bm(t, f, o);
    } else
      for (var h in n)
        n.hasOwnProperty(h) && Bm(t, h, n[h]);
  }
  function zc(t) {
  ...
  function ss(t) {
    return Qw.test("" + t) ? "javascript:throw new Error('React has blocked a javascript: URL as a security precaution.')" : t;
  }
  function Ya() {
  }
  var Oc = null;
  ...
  function qm(t, n, i) {
    ...
    try {
      ...
      if (Lc = !1, (Ar !== null || zr !== null) && (Qs(), Ar && (n = Ar, t = zr, zr = Ar = null, Vm(n), t)))
        for (n = 0; n < t.length; n++) Vm(t[n]);
    }
  }
  function jl(t, n) {
    var i = t.stateNode;
  ...
  var Ia = !(typeof window > "u" || typeof window.document > "u" || typeof window.document.createElement > "u"), Hc = !1;
  if (Ia)
    try {
      var Ll = {};
  ...
  var bi = null, kc = null, us = null;
  function $m() {
    if (us) return us;
    var t, n = kc, i = n.length, o, f = "value" in bi ? bi.value : bi.textContent, h = f.length;
  ...
  function _n(t) {
    function n(i, o, f, h, w) {
      ...
      return this.isDefaultPrevented = (h.defaultPrevented != null ? h.defaultPrevented : h.returnValue === !1) ? fs : Ym, this.isPropagationStopped = Ym, this;
    }
  ...
  var Pi = {
    ...
    defaultPrevented: 0,
    isTrusted: 0
  }, ds = _n(Pi), Hl = g({}, Pi, { view: 0, detail: 0 }), Pw = _n(Hl), Bc, Uc, kl, hs = g({}, Hl, {
    screenX: 0,
    screenY: 0,
    clientX: 0,
    clientY: 0,
    ...
    movementX: function(t) {
      return "movementX" in t ? t.movementX : (t !== kl && (kl && t.type === "mousemove" ? (Bc = t.screenX - kl.screenX, Uc = t.screenY - kl.screenY) : Uc = Bc = 0, kl = t), Bc);
    },
    movementY: function(t) {
      return "movementY" in t ? t.movementY : Uc;
    }
  }), Im = _n(hs), Kw = g({}, hs, { dataTransfer: 0 }), Jw = _n(Kw), Ww = g({}, Hl, { relatedTarget: 0 }), Vc = _n(Ww), eS = g({}, Pi, {
    animationName: 0,
    elapsedTime: 0,
    pseudoElement: 0
  }), tS = _n(eS), nS = g({}, Pi, {
  ...
  }), aS = _n(nS), iS = g({}, Pi, { data: 0 }), Gm = _n(iS), rS = {
    Esc: "Escape",
    Spacebar: " ",
    Left: "ArrowLeft",
    Up: "ArrowUp",
  ...
  var uS = g({}, Hl, {
    key: function(t) {
      ...
      return t.type === "keypress" ? (t = cs(t), t === 13 ? "Enter" : String.fromCharCode(t)) : t.type === "keydown" || t.type === "keyup" ? lS[t.keyCode] || "Unidentified" : "";
    },
    code: 0,
    location: 0,
    ctrlKey: 0,
    ...
    newState: 0,
    oldState: 0
  }), bS = _n(vS), xS = [9, 13, 27, 32], $c = Ia && "CompositionEvent" in window, Bl = null;
  Ia && "documentMode" in document && (Bl = document.documentMode);
  var wS = Ia && "TextEvent" in window && !Bl, Fm = Ia && (!$c || Bl && 8 < Bl && 11 >= Bl), Zm = " ", Qm = !1;
  function Pm(t, n) {
    switch (t) {
      case "keyup":
  ...
  function SS(t, n) {
    switch (t) {
      case "compositionend":
        return Km(n);
      case "keypress":
        return n.which !== 32 ? null : (Qm = !0, Zm);
      case "textInput":
        return t = n.data, t === Zm && Qm ? null : t;
      default:
        return null;
    }
  }
  function ES(t, n) {
    if (Or)
      return t === "compositionend" || !$c && Pm(t, n) ? (t = $m(), us = kc = bi = null, Or = !1, t) : null;
    switch (t) {
      case "paste":
        return null;
      case "keypress":
  ...
  function Jm(t) {
    ...
    return n === "input" ? !!_S[t.type] : n === "textarea";
  }
  function Wm(t, n, i, o) {
  ...
  if (Ia) {
    ...
    if (Ia) {
      ...
      if (!Ic) {
        ...
        np.setAttribute("oninput", "return;"), Ic = typeof np.oninput == "function";
      }
      Yc = Ic;
    } else Yc = !1;
    tp = Yc && (!document.documentMode || 9 < document.documentMode);
  }
  function ap() {
    Ul && (Ul.detachEvent("onpropertychange", ip), Vl = Ul = null);
  }
  function ip(t) {
  ...
  function CS(t, n, i) {
    t === "focusin" ? (ap(), Ul = n, Vl = i, Ul.attachEvent("onpropertychange", ip)) : t === "focusout" && ap();
  }
  function RS(t) {
  ...
  function op(t, n) {
    return t && n ? t === n ? !0 : t && t.nodeType === 3 ? !1 : n && n.nodeType === 3 ? op(t, n.parentNode) : "contains" in t ? t.contains(n) : t.compareDocumentPosition ? !!(t.compareDocumentPosition(n) & 16) : !1 : !1;
  }
  function sp(t) {
  ...
  var AS = Ia && "documentMode" in document && 11 >= document.documentMode, jr = null, Xc = null, $l = null, Fc = !1;
  function up(t, n, i) {
    var o = i.window === i ? i.document : i.nodeType === 9 ? i : i.ownerDocument;
    Fc || jr == null || jr !== dt(o) || (o = jr, "selectionStart" in o && Gc(o) ? o = { start: o.selectionStart, end: o.selectionEnd } : (o = (o.ownerDocument && o.ownerDocument.defaultView || window).getSelection(), o = {
      anchorNode: o.anchorNode,
      anchorOffset: o.anchorOffset,
      focusNode: o.focusNode,
      focusOffset: o.focusOffset
    }), $l && ql($l, o) || ($l = o, o = nu(Xc, "onSelect"), 0 < o.length && (n = new ds(
      "onSelect",
      "select",
      null,
      n,
  ...
  Ia && (cp = document.createElement("div").style, "AnimationEvent" in window || (delete Lr.animationend.animation, delete Lr.animationiteration.animation, delete Lr.animationstart.animation), "TransitionEvent" in window || delete Lr.transitionend.transition);
  function Ji(t) {
    if (Zc[t]) return Zc[t];
    if (!Lr[t]) return t;
    var n = Lr[t], i;
  ...
  var fp = Ji("animationend"), dp = Ji("animationiteration"), hp = Ji("animationstart"), zS = Ji("transitionrun"), OS = Ji("transitionstart"), jS = Ji("transitioncancel"), mp = Ji("transitionend"), pp = /* @__PURE__ */ new Map(), Qc = "abort auxClick beforeToggle cancel canPlay canPlayThrough click close contextMenu copy cut drag dragEnd dragEnter dragExit dragLeave dragOver dragStart drop durationChange emptied encrypted ended error gotPointerCapture input invalid keyDown keyPress keyUp load loadedData loadedMetadata loadStart lostPointerCapture mouseDown mouseMove mouseOut mouseOver mouseUp paste pause play playing pointerCancel pointerDown pointerMove pointerOut pointerOver pointerUp progress rateChange reset resize seeked seeking stalled submit suspend timeUpdate touchCancel touchEnd touchStart volumeChange scroll toggle touchMove waiting wheel".split(
    " "
  );
  Qc.push("scrollEnd");
  function ha(t, n) {
  ...
  function ys(t, n, i, o) {
    Qn[Hr++] = t, Qn[Hr++] = n, Qn[Hr++] = i, Qn[Hr++] = o, Pc |= o, t.lanes |= o, t = t.alternate, t !== null && (t.lanes |= o);
  }
  function Kc(t, n, i, o) {
  ...
  function vs(t) {
    if (50 < co)
      throw co = 0, od = null, Error(l(185));
  ...
  function bs(t, n, i, o, f, h) {
    var w = 0;
    if (o = t, typeof t == "function") Jc(t) && (w = 1);
  ...
  var Br = [], Ur = 0, xs = null, Yl = 0, Kn = [], Jn = 0, xi = null, Ca = 1, Ra = "";
  function Xa(t, n) {
    Br[Ur++] = Yl, Br[Ur++] = xs, xs = t, Yl = n;
  }
  function xp(t, n, i) {
  ...
  function tf(t) {
    t.return !== null && (Xa(t, 1), xp(t, 1, 0));
  }
  function nf(t) {
    for (; t === xs; )
      xs = Br[--Ur], Br[Ur] = null, Yl = Br[--Ur], Br[Ur] = null;
    for (; t === xi; )
  ...
  var rn = null, Tt = null, it = !1, wi = null, Wn = !1, af = Error(l(519));
  function Si(t) {
    var n = Error(
      l(
        418,
  ...
  function Sp(t) {
    ...
    switch (n[ve] = t, n[we] = o, i) {
      ...
      case "select":
        ...
        break;
      case "textarea":
        Ke("invalid", n), km(n, o.value, o.defaultValue, o.children);
    }
    i = o.children, typeof i != "string" && typeof i != "number" && typeof i != "bigint" || n.textContent === "" + i || o.suppressHydrationWarning === !0 || U0(n.textContent, i) ? (o.popover != null && (Ke("beforetoggle", n), Ke("toggle", n)), o.onScroll != null && Ke("scroll", n), o.onScrollEnd != null && Ke("scrollend", n), o.onClick != null && (n.onclick = Ya), n = !0) : n = !1, n || Si(t, !0);
  }
  function Ep(t) {
    for (rn = t.return; rn; )
      switch (rn.tag) {
  ...
  function Vr(t) {
    if (t !== rn) return !1;
    if (!it) return Ep(t), it = !0, !1;
    var n = t.tag, i;
    if ((i = n !== 3 && n !== 27) && ((i = n === 5) && (i = t.type, i = !(i !== "form" && i !== "button") || Sd(t.type, t.memoizedProps)), i = !i), i && Tt && Si(t), Ep(t), n === 13) {
      ...
      n === 27 ? (n = Tt, Hi(t.type) ? (t = Rd, Rd = null, Tt = t) : Tt = n) : Tt = rn ? ta(t.stateNode.nextSibling) : null;
    return !0;
  }
  function tr() {
    Tt = rn = null, it = !1;
  ...
  var lf = D(null), nr = null, Fa = null;
  function Ei(t, n, i) {
    P(lf, n._currentValue), n._currentValue = i;
  }
  function Za(t) {
    t._currentValue = lf.current, H(lf);
  }
  function of(t, n, i) {
    for (; t !== null; ) {
      var o = t.alternate;
      ...
      if (h !== null) {
        ...
        e: for (; h !== null; ) {
          ...
          for (var q = 0; q < n.length; q++)
            if (M.context === n[q]) {
              h.lanes |= i, M = h.alternate, M !== null && (M.lanes |= i), of(
                h.return,
                i,
                t
              ), o || (w = null);
        ...
        w.lanes |= i, h = w.alternate, h !== null && (h.lanes |= i), of(w, i, t), w = null;
      } else w = f.child;
  ...
  }, kS = e.unstable_scheduleCallback, BS = e.unstable_NormalPriority, Gt = {
    $$typeof: E,
    Consumer: null,
    Provider: null,
    _currentValue: null,
  ...
  var Cp = T.S;
  T.S = function(t, n) {
    u0 = Qe(), typeof n == "object" && n !== null && typeof n.then == "function" && US(t, n), Cp !== null && Cp(t, n);
  };
  var ir = D(null);
  function ff() {
    var t = ir.current;
  ...
  var Ir = Error(l(460)), df = Error(l(474)), _s = Error(l(542)), Ns = { then: function() {
  } };
  function Tp(t) {
  ...
  function Cs(t) {
    var n = Fl;
    return Fl += 1, Gr === null && (Gr = []), Mp(Gr, t, n);
  }
  function Zl(t, n) {
  ...
  function zp(t) {
    ...
    function M(J, X, ae, ce) {
      return X === null || X.tag !== 6 ? (X = Wc(ae, J.mode, ce), X.return = J, X) : (X = f(X, ae), X.return = J, X);
    }
    function q(J, X, ae, ce) {
      ...
      return Oe === N ? ue(
        ...
        ce,
        ae.key
      ) : X !== null && (X.elementType === Oe || typeof Oe == "object" && Oe !== null && Oe.$$typeof === A && rr(Oe) === X.type) ? (X = f(X, ae.props), Zl(X, ae), X.return = J, X) : (X = bs(
        ae.type,
        ae.key,
        ae.props,
        null,
        J.mode,
        ce
      ), Zl(X, ae), X.return = J, X);
    }
    function ie(J, X, ae, ce) {
      return X === null || X.tag !== 4 || X.stateNode.containerInfo !== ae.containerInfo || X.stateNode.implementation !== ae.implementation ? (X = ef(ae, J.mode, ce), X.return = J, X) : (X = f(X, ae.children || []), X.return = J, X);
    }
    ...
    function Le(J, X, ae, ce) {
      ...
      return t && Ne.forEach(function(KE) {
        return n(J, KE);
      }), it && Xa(J, Ie), Oe;
    }
    function Nt(J, X, ae, ce) {
        ...
        switch (ae.$$typeof) {
                ...
                if (X.key === Oe) {
                  if (Oe = ae.type, Oe === N) {
                    ...
                    i(
                      J,
                      X.sibling
                    ), ce = f(X, ae.props), Zl(ce, ae), ce.return = J, J = ce;
                    break e;
                  }
                  i(J, X);
                  break;
          ...
          case S:
            e: {
              ...
              ce = ef(ae, J.mode, ce), ce.return = J, J = ce;
            }
            return w(J);
          case A:
            return ae = rr(ae), Nt(
      ...
      return typeof ae == "string" && ae !== "" || typeof ae == "number" || typeof ae == "bigint" ? (ae = "" + ae, X !== null && X.tag === 6 ? (i(J, X.sibling), ce = f(X, ae), ce.return = J, J = ce) : (i(J, X), ce = Wc(ae, J.mode, ce), ce.return = J, J = ce), w(J)) : i(J, X);
    }
  ...
  function Ci(t, n, i) {
    ...
    if (o = o.shared, (ht & 2) !== 0) {
      var f = o.pending;
      return f === null ? n.next = n : (n.next = f.next, f.next = n), o.pending = n, n = vs(t), gp(t, null, i), n;
    }
    ...
    if (h !== null) {
      ...
      do {
        ...
        if (oe ? (et & re) === re : (o & re) === re) {
          re !== 0 && re === $r && (gf = !0), ue !== null && (ue = ue.next = {
            lane: 0,
            tag: M.tag,
            payload: M.payload,
            callback: null,
  ...
  function Ms(t) {
    for (var n = t; n !== null; ) {
      if (n.tag === 13) {
        ...
        if (i !== null && (i = i.dehydrated, i === null || Nd(i) || Cd(i)))
          return n;
  ...
  var Qa = 0, qe = null, Et = null, Xt = null, Ds = !1, Fr = !1, sr = !1, As = 0, Jl = 0, Zr = null, qS = 0;
  function kt() {
    throw Error(l(321));
  }
  function xf(t, n) {
  ...
  function wf(t, n, i, o, f, h) {
    return Qa = h, qe = n, n.memoizedState = null, n.updateQueue = null, n.lanes = 0, T.H = t === null || t.memoizedState === null ? xg : Hf, sr = !1, h = i(o, f), sr = !1, Fr && (h = Up(
      n,
      i,
      o,
      f
  ...
  function Wl(t) {
    var n = Jl;
    return Jl += 1, Zr === null && (Zr = []), t = Mp(Zr, t, n), n = qe, (Xt === null ? n.memoizedState : Xt.next) === null && (n = n.alternate, T.H = n === null || n.memoizedState === null ? xg : Hf), t;
  }
  function Os(t) {
  ...
  function Vp(t, n, i) {
    ...
    if (w && (f.memoizedState = i, Ft = !0), f = f.queue, Df(Yp.bind(null, o, f, t), [
      t
  ...
  function $p(t, n, i, o) {
    n.value = i, n.getSnapshot = o, Ip(n) && Gp(t);
  }
  function Yp(t, n, i) {
    return i(function() {
      Ip(n) && Gp(t);
  ...
  function Xp(t, n, i, o) {
    return t.baseState = i, Cf(
      t,
      Et,
      typeof o == "function" ? o : Pa
    );
  }
  function YS(t, n, i, o, f) {
    ...
    if (t = n.action, t !== null) {
      ...
      T.T !== null ? i(!0) : h.isTransition = !1, o(h), i = n.pending, i === null ? (h.next = n.pending = h, Fp(n, h)) : (h.next = i.next, n.pending = i.next = h);
    }
  }
  function Fp(t, n) {
  ...
  function Qp(t, n, i) {
    n.status = "fulfilled", n.value = i, Pp(n), t.state = i, n = t.pending, n !== null && (i = n.next, i === n ? t.pending = null : (i = i.next, n.next = i, Fp(t, i)));
  }
  function Mf(t, n, i) {
    var o = t.pending;
    if (t.pending = null, o !== null) {
      o = o.next;
      do
        n.status = "rejected", n.reason = i, Pp(n), n = n.next;
      while (n !== o);
    }
    t.action = null;
  }
  ...
  function Hs(t, n, i, o) {
    ...
    Et !== null && o !== null && xf(o, Et.memoizedState.deps) ? f.memoizedState = Qr(n, h, i, o) : (qe.flags |= t, f.memoizedState = Qr(
      1 | n,
      h,
      i,
      o
  ...
  function sg(t, n, i) {
    i = i != null ? i.concat([t]) : null, Hs(4, 4, og.bind(null, n, t), i);
  }
  function Af() {
  }
  function ug(t, n) {
    ...
    return n !== null && xf(n, o[1]) ? o[0] : (i.memoizedState = [t, n], t);
  }
  function cg(t, n) {
    var i = $t();
    n = n === void 0 ? null : n;
  ...
  function zf(t, n, i) {
    return i === void 0 || (Qa & 1073741824) !== 0 && (et & 261930) === 0 ? t.memoizedState = n : (t.memoizedState = i, t = f0(), qe.lanes |= t, Ai |= t, i);
  }
  function fg(t, n, i, o) {
    return Hn(i, n) ? i : Xr.current !== null ? (t = zf(t, i, o), Hn(t, n) || (Ft = !0), t) : (Qa & 42) === 0 || (Qa & 1073741824) !== 0 && (et & 261930) === 0 ? (Ft = !0, t.memoizedState = i) : (t = f0(), qe.lanes |= t, Ai |= t, n);
  }
    ...
    for (var n = t.return; n !== null; ) {
      switch (n.tag) {
        ...
        case 3:
          ...
          t = Ni(i);
          var o = Ci(n, t, i);
          o !== null && (Mn(o, n, i), Ql(o, n, i)), n = { cache: uf() }, t.payload = n;
          return;
      }
      n = n.return;
    }
  ...
  function ZS(t, n, i) {
    ...
    i = {
      ...
      eagerState: null,
      next: null
    }, ks(t) ? vg(n, i) : (i = Kc(t, n, i, o), i !== null && (Mn(i, t, o), bg(i, n, o)));
  }
  function yg(t, n, i) {
    var o = $n();
    eo(t, n, i, o);
  ...
  function eo(t, n, i, o) {
    ...
    if (ks(t)) vg(n, f);
      ...
      if (i = Kc(t, n, f, o), i !== null)
        return Mn(i, t, o), bg(i, n, o), !0;
    }
    return !1;
  }
  function Lf(t, n, i, o) {
  ...
  var xg = {
    ...
    useState: function(t) {
      t = Tf(t);
      var n = t.queue, i = yg.bind(null, qe, n);
    ...
    useSyncExternalStore: function(t, n, i) {
      ...
      return f.queue = h, ag(Yp.bind(null, o, h, t), [
        t
      ]), o.flags |= 2048, Qr(
        9,
        { destroy: void 0 },
    ...
    useCacheRefresh: function() {
      return yn().memoizedState = FS.bind(
        null,
        qe
      );
    },
  ...
  var wg = {
    ...
    useTransition: function() {
      var t = Rf(Pa)[0], n = $t().memoizedState;
      return [
        typeof t == "boolean" ? t : Wl(t),
        n
      ];
    ...
    useOptimistic: function(t, n) {
      var i = $t();
      return Et !== null ? Xp(i, Et, t, n) : (i.baseState = t, [t, i.queue.dispatch]);
    },
    useMemoCache: Nf,
    useCacheRefresh: gg
  };
  wg.useEffectEvent = ig;
  function kf(t, n, i, o) {
  ...
  function Eg(t, n, i, o) {
    t = n.state, typeof n.componentWillReceiveProps == "function" && n.componentWillReceiveProps(i, o), typeof n.UNSAFE_componentWillReceiveProps == "function" && n.UNSAFE_componentWillReceiveProps(i, o), n.state !== t && Bf.enqueueReplaceState(n, n.state, null);
  }
  function ur(t, n) {
    var i = n;
    if ("ref" in n) {
  ...
  function Mg(t, n, i, o) {
    ...
    w !== null && typeof w.componentDidCatch == "function" && (t.callback = function() {
      Rg(n, i, o), typeof f != "function" && (zi === null ? zi = /* @__PURE__ */ new Set([this]) : zi.add(this));
      var M = o.stack;
  ...
  function QS(t, n, i, o, f) {
    if (i.flags |= 32768, o !== null && typeof o == "object" && typeof o.then == "function") {
      if (n = i.alternate, n !== null && qr(
        ...
        switch (i.tag) {
          case 31:
          case 13:
            return ea === null ? Ps() : i.alternate === null && Bt === 0 && (Bt = 3), i.flags &= -257, i.flags |= 65536, i.lanes = f, o === Ns ? i.flags |= 16384 : (n = i.updateQueue, n === null ? i.updateQueue = /* @__PURE__ */ new Set([o]) : n.add(o), cd(t, o, f)), !1;
          case 22:
      ...
      return cd(t, o, f), Ps(), !1;
    }
    if (it)
      return n = Bn.current, n !== null ? ((n.flags & 65536) === 0 && (n.flags |= 256), n.flags |= 65536, n.lanes = f, o !== af && (t = Error(l(422), { cause: o }), Il(Pn(t, i)))) : (o !== af && (n = Error(l(423), {
        cause: o
      }), Il(
        Pn(n, i)
      )), t = t.current.alternate, t.flags |= 65536, f &= -f, t.lanes |= f, o = Pn(o, i), f = Uf(
        t.stateNode,
        o,
        f
      ), pf(t, f), Bt !== 4 && (Bt = 2)), !1;
    ...
    do {
      switch (i.tag) {
        case 3:
          return i.flags |= 65536, t = f & -f, i.lanes |= t, t = Uf(i.stateNode, o, t), pf(i, t), !1;
        case 1:
          if (n = i.type, h = i.stateNode, (i.flags & 128) === 0 && (typeof n.getDerivedStateFromError == "function" || h !== null && typeof h.componentDidCatch == "function" && (zi === null || !zi.has(h))))
            return i.flags |= 65536, f &= -f, i.lanes |= f, f = Tg(f), Mg(
              f,
              t,
              i,
              o
  ...
  var Vf = Error(l(461)), Ft = !1;
  function on(t, n, i, o) {
    n.child = t === null ? Op(n, null, i, o) : or(
      n,
      t.child,
      i,
      o
  ...
  function Dg(t, n, i, o, f) {
    ...
    return ar(n), o = wf(
      ...
      h,
      f
    ), M = Sf(), t !== null && !Ft ? (Ef(t, n, f), Ka(t, n, f)) : (it && M && tf(n), n.flags |= 1, on(t, n, o, f), n.child);
  }
  function Ag(t, n, i, o, f) {
    if (t === null) {
      var h = i.type;
      return typeof h == "function" && !Jc(h) && h.defaultProps === void 0 && i.compare === null ? (n.tag = 15, n.type = h, zg(
        t,
        n,
        h,
        o,
  ...
  function zg(t, n, i, o, f) {
    if (t !== null) {
      ...
      if (ql(h, o) && t.ref === n.ref)
        if (Ft = !1, n.pendingProps = o = h, Zf(t, f))
  ...
  function Og(t, n, i, o) {
    ...
    if (t === null && n.stateNode === null && (n.stateNode = {
      ...
      h !== null ? (Es(n, h.cachePool), Hp(n, h), Ti(), n.memoizedState = null) : (t !== null && Es(n, null), yf(), Ti());
  ...
  function jg(t, n, i, o, f) {
    ...
    return h = h === null ? null : { parent: Gt._currentValue, pool: h }, n.memoizedState = {
      baseLanes: i,
      cachePool: h
    }, t !== null && Es(n, null), yf(), kp(n), t !== null && qr(t, n, o, !0), n.childLanes = f, null;
  }
  function Us(t, n) {
    return n = qs(
  ...
  function PS(t, n, i) {
    ...
    if (n.flags &= -129, t === null) {
      if (it) {
        ...
        }, i = vp(t), i.return = n, n.child = i, rn = n, Tt = null)) : t = null, t === null) throw Si(n);
    ...
    if (h !== null) {
      ...
      if (bf(n), f)
        ...
        if (o = Rt, o !== null && (w = U(o, i), w !== 0 && w !== h.retryLane))
          throw h.retryLane = w, Wi(t, w), Mn(o, t, w), Vf;
        Ps(), n = Lg(
          t,
          n,
          i
        ...
        t = h.treeContext, Tt = ta(w.nextSibling), rn = n, it = !0, wi = null, Wn = !1, t !== null && wp(n, t), n = Us(n, o), n.flags |= 4096;
      return n;
    }
    return t = Ga(t.child, {
      mode: o.mode,
  ...
  function qf(t, n, i, o, f) {
    return ar(n), i = wf(
      ...
      void 0,
      f
    ), o = Sf(), t !== null && !Ft ? (Ef(t, n, f), Ka(t, n, f)) : (it && o && tf(n), n.flags |= 1, on(t, n, i, f), n.child);
  }
  function Hg(t, n, i, o, f, h) {
    return ar(n), n.updateQueue = null, i = Up(
      n,
      o,
      i,
      f
    ), Bp(t), o = Sf(), t !== null && !Ft ? (Ef(t, n, h), Ka(t, n, h)) : (it && o && tf(n), n.flags |= 1, on(t, n, i, h), n.child);
  }
  function kg(t, n, i, o, f) {
    if (ar(n), n.stateNode === null) {
      var h = kr, w = i.contextType;
      typeof w == "object" && w !== null && (h = ln(w)), h = new i(o, h), n.memoizedState = h.state !== null && h.state !== void 0 ? h.state : null, h.updater = Bf, n.stateNode = h, h._reactInternals = n, h = n.stateNode, h.props = o, h.state = n.memoizedState, h.refs = {}, hf(n), w = i.contextType, h.context = typeof w == "object" && w !== null ? ln(w) : kr, h.state = n.memoizedState, w = i.getDerivedStateFromProps, typeof w == "function" && (kf(
        n,
        i,
        w,
        o
      ), h.state = n.memoizedState), typeof i.getDerivedStateFromProps == "function" || typeof h.getSnapshotBeforeUpdate == "function" || typeof h.UNSAFE_componentWillMount != "function" && typeof h.componentWillMount != "function" || (w = h.state, typeof h.componentWillMount == "function" && h.componentWillMount(), typeof h.UNSAFE_componentWillMount == "function" && h.UNSAFE_componentWillMount(), w !== h.state && Bf.enqueueReplaceState(h, h.state, null), Kl(n, o, h, f), Pl(), h.state = n.memoizedState), typeof h.componentDidMount == "function" && (n.flags |= 4194308), o = !0;
    } else if (t === null) {
      h = n.stateNode;
      ...
      ue = typeof fe == "function" || typeof h.getSnapshotBeforeUpdate == "function", M = n.pendingProps !== M, ue || typeof h.UNSAFE_componentWillReceiveProps != "function" && typeof h.componentWillReceiveProps != "function" || (M || ie !== w) && Eg(
        n,
        h,
        o,
        w
      ...
      h.state = re, Kl(n, o, h, f), Pl(), ie = n.memoizedState, M || re !== ie || _i ? (typeof fe == "function" && (kf(
        n,
        i,
        fe,
        o
      ), ie = n.memoizedState), (q = _i || Sg(
        n,
        i,
        q,
        o,
      ...
      h = n.stateNode, mf(t, n), w = n.memoizedProps, ue = ur(i, w), h.props = ue, fe = n.pendingProps, re = h.context, ie = i.contextType, q = kr, typeof ie == "object" && ie !== null && (q = ln(ie)), M = i.getDerivedStateFromProps, (ie = typeof M == "function" || typeof h.getSnapshotBeforeUpdate == "function") || typeof h.UNSAFE_componentWillReceiveProps != "function" && typeof h.componentWillReceiveProps != "function" || (w !== fe || re !== q) && Eg(
        n,
        h,
        o,
        q
      ), _i = !1, re = n.memoizedState, h.state = re, Kl(n, o, h, f), Pl();
      var oe = n.memoizedState;
      w !== fe || re !== oe || _i || t !== null && t.dependencies !== null && ws(t.dependencies) ? (typeof M == "function" && (kf(
        n,
        i,
        M,
        o
      ), oe = n.memoizedState), (ue = _i || Sg(
        n,
        i,
        ue,
        o,
        ...
        oe,
        q
      ) || t !== null && t.dependencies !== null && ws(t.dependencies)) ? (ie || typeof h.UNSAFE_componentWillUpdate != "function" && typeof h.componentWillUpdate != "function" || (typeof h.componentWillUpdate == "function" && h.componentWillUpdate(o, oe, q), typeof h.UNSAFE_componentWillUpdate == "function" && h.UNSAFE_componentWillUpdate(
        o,
        oe,
        q
  ...
  function Ug(t, n, i) {
    ...
    if ((w = h) || (w = t !== null && t.memoizedState === null ? !1 : (qt.current & 2) !== 0), w && (f = !0, n.flags &= -129), w = (n.flags & 32) !== 0, n.flags &= -33, t === null) {
      if (it) {
        ...
        return Cd(t) ? n.lanes = 32 : n.lanes = 536870912, null;
      }
      var M = o.children;
      return o = o.fallback, f ? (Ti(), f = n.mode, M = qs(
        ...
        i,
        null
      ), M.return = n, o.return = n, M.sibling = o, n.child = M, o = n.child, o.memoizedState = Yf(i), o.childLanes = If(
        t,
        w,
        i
      ), n.memoizedState = $f, no(null, o)) : (Ri(n), Gf(n, M));
    }
    var q = t.memoizedState;
    if (q !== null && (M = q.dehydrated, M !== null)) {
      if (h)
        n.flags & 256 ? (Ri(n), n.flags &= -257, n = Xf(
          t,
          n,
          i
          ...
          null,
          i
        ), o = n.child, o.memoizedState = Yf(i), o.childLanes = If(
          t,
          w,
          i
        ), n.memoizedState = $f, n = no(null, o));
      else if (Ri(n), Cd(M)) {
        if (w = M.nextSibling && M.nextSibling.dataset, w) var ie = w.dgst;
        w = ie, o = Error(l(419)), o.stack = "", o.digest = w, Il({ value: o, source: null, stack: null }), n = Xf(
          t,
          n,
          i
        );
        ...
        if (w = Rt, w !== null && (o = U(w, i), o !== 0 && o !== q.retryLane))
          throw q.retryLane = o, Wi(t, o), Mn(w, t, o), Vf;
        Nd(M) || Ps(), n = Xf(
          t,
          n,
          i
        ...
        Nd(M) ? (n.flags |= 192, n.child = t.child, n = null) : (t = q.treeContext, Tt = ta(
          M.nextSibling
        ), rn = n, it = !0, wi = null, Wn = !1, t !== null && wp(n, t), n = Gf(
          n,
          o.children
        ), n.flags |= 4096);
      return n;
    ...
    return f ? (Ti(), M = o.fallback, f = n.mode, q = t.child, ie = q.sibling, o = Ga(q, {
      ...
      i,
      null
    ), M.flags |= 2), M.return = n, o.return = n, o.sibling = M, n.child = o, no(null, o), o = n.child, M = t.child.memoizedState, M === null ? M = Yf(i) : (f = M.cachePool, f !== null ? (q = Gt._currentValue, f = f.parent !== q ? { parent: q, pool: q } : f) : f = Rp(), M = {
      baseLanes: M.baseLanes | i,
      cachePool: f
    }), o.memoizedState = M, o.childLanes = If(
      t,
      w,
      i
    ), n.memoizedState = $f, no(t.child, o)) : (Ri(n), i = t.child, t = i.sibling, i = Ga(i, {
      mode: "visible",
      children: o.children
  ...
  function Xf(t, n, i) {
    return or(n, t.child, null, i), t = Gf(
      n,
  ...
  function Vg(t, n, i) {
    t.lanes |= n;
    var o = t.alternate;
    o !== null && (o.lanes |= n), of(t.return, n, i);
  }
  function Ff(t, n, i, o, f, h) {
  ...
  function qg(t, n, i) {
    ...
    switch (f) {
      case "forwards":
        ...
        i = f, i === null ? (f = n.child, n.child = null) : (f = i.sibling, i.sibling = null), Ff(
          n,
          !1,
          f,
          i,
  ...
  function KS(t, n, i) {
    switch (n.tag) {
      ...
      case 13:
        ...
        if (o !== null)
          return o.dehydrated !== null ? (Ri(n), n.flags |= 128, null) : (i & n.child.childLanes) !== 0 ? Ug(t, n, i) : (Ri(n), t = Ka(
            t,
            n,
            i
  ...
  function $g(t, n, i) {
    if (t !== null)
      ...
      Ft = !1, it && (n.flags & 1048576) !== 0 && xp(n, Yl, n.index);
    switch (n.lanes = 0, n.tag) {
      case 16:
        e: {
          var o = n.pendingProps;
          if (t = rr(n.elementType), n.type = t, typeof t == "function")
            Jc(t) ? (o = ur(t, o), n.tag = 1, n = kg(
              null,
              n,
              t,
              o,
      ...
      case 3:
        e: {
          ...
          f = h.element, mf(t, n), Kl(n, o, null, i);
          var w = n.memoizedState;
          if (o = w.cache, Ei(n, Gt, o), o !== h.cache && sf(
            n,
            [Gt],
            i,
            !0
            ...
            if (h = {
              ...
              for (Tt = ta(t.firstChild), rn = n, it = !0, wi = null, Wn = !0, i = Op(
                n,
                null,
                o,
                i
      ...
      case 26:
        return Vs(t, n), t === null ? (i = W0(
          ...
          he.current
        ).createElement(i), o[ve] = n, o[we] = t, sn(o, i, t), at(o), n.stateNode = o) : n.memoizedState = W0(
          n.type,
          t.memoizedProps,
          n.pendingProps,
          t.memoizedState
      ...
      case 27:
        return ze(n), t === null && it && (o = n.stateNode = P0(
          n.type,
          n.pendingProps,
          he.current
        ), rn = n, Wn = !0, f = Tt, Hi(n.type) ? (Rd = f, Tt = ta(o.firstChild)) : Tt = f), on(
          t,
          n,
          n.pendingProps.children,
          i
      ...
      case 5:
        return t === null && it && ((f = o = Tt) && (o = RE(
          ...
          n.pendingProps,
          Wn
        ), o !== null ? (n.stateNode = o, rn = n, Tt = ta(o.firstChild), Wn = !1, f = !0) : f = !1), f || Si(n)), ze(n), f = n.type, h = n.pendingProps, w = t !== null ? t.memoizedProps : null, o = h.children, Sd(f, h) ? o = null : w !== null && Sd(f, w) && (n.flags |= 32), n.memoizedState !== null && (f = wf(
          t,
          n,
          $S,
          null,
      ...
      case 24:
        return ar(n), o = ln(Gt), t === null ? (f = ff(), f === null && (f = Rt, h = uf(), f.pooledCache = h, h.refCount++, h !== null && (f.pooledCacheLanes |= i), f = h), n.memoizedState = { parent: o, cache: f }, hf(n), Ei(n, Gt, f)) : ((t.lanes & i) !== 0 && (mf(t, n), Kl(n, null, null, i), Pl()), f = t.memoizedState, h = n.memoizedState, f.parent !== o ? (f = { parent: o, cache: o }, n.memoizedState = f, n.lanes === 0 && (n.memoizedState = n.updateQueue.baseState = f), Ei(n, Gt, o)) : (o = h.cache, Ei(n, Gt, o), o !== f.cache && sf(
          n,
          [Gt],
          i,
          !0
  ...
  function JS(t, n, i) {
    ...
    switch (nf(n), n.tag) {
      ...
      case 1:
        return Mt(n), null;
      case 3:
        return i = n.stateNode, o = null, t !== null && (o = t.memoizedState.cache), n.memoizedState.cache !== o && (n.flags |= 2048), Za(Gt), ge(), i.pendingContext && (i.context = i.pendingContext, i.pendingContext = null), (t === null || t.child === null) && (Vr(n) ? Ja(n) : t === null || t.memoizedState.isDehydrated && (n.flags & 256) === 0 || (n.flags |= 1024, rf())), Mt(n), null;
      case 26:
        var f = n.type, h = n.memoizedState;
        return t === null ? (Ja(n), h !== null ? (Mt(n), Yg(n, h)) : (Mt(n), Qf(
          n,
          f,
          null,
          o,
          i
        ))) : h ? h !== t.memoizedState ? (Ja(n), Mt(n), Yg(n, h)) : (Mt(n), n.flags &= -16777217) : (t = t.memoizedProps, t !== o && Ja(n), Mt(n), Qf(
          n,
          f,
          t,
          o,
      ...
      case 27:
        if (Re(n), i = he.current, f = n.type, t !== null && n.stateNode != null)
          ...
          t = ne.current, Vr(n) ? Sp(n) : (t = P0(f, o, i), n.stateNode = t, Ja(n));
        }
        return Mt(n), null;
      case 5:
      ...
      case 6:
        if (t && n.stateNode != null)
          ...
          if (t = he.current, Vr(n)) {
            ...
            t[ve] = n, t = !!(t.nodeValue === i || o !== null && o.suppressHydrationWarning === !0 || U0(t.nodeValue, i)), t || Si(n, !0);
          } else
      ...
      case 31:
        if (i = n.memoizedState, t === null || t.memoizedState !== null) {
          if (o = Vr(n), i !== null) {
            ...
            i = rf(), t !== null && t.memoizedState !== null && (t.memoizedState.hydrationErrors = i), t = !0;
          if (!t)
      ...
      case 13:
        if (o = n.memoizedState, t === null || t.memoizedState !== null && t.memoizedState.dehydrated !== null) {
          if (f = Vr(n), o !== null && o.dehydrated !== null) {
            ...
            f = rf(), t !== null && t.memoizedState !== null && (t.memoizedState.hydrationErrors = f), f = !0;
          if (!f)
            return n.flags & 256 ? (Un(n), n) : (Un(n), null);
        }
      ...
      case 4:
        return ge(), t === null && yd(n.stateNode.containerInfo), Mt(n), null;
      case 10:
  ...
  function WS(t, n) {
    switch (nf(n), n.tag) {
      ...
      case 22:
      case 23:
        return Un(n), vf(), t !== null && H(ir), t = n.flags, t & 65536 ? (n.flags = t & -65537 | 128, n) : null;
      case 24:
        return Za(Gt), null;
      case 25:
        return null;
  ...
  function Kf(t) {
    e: for (; ; ) {
      for (; t.sibling === null; ) {
        if (t.return === null || Zg(t.return)) return null;
        t = t.return;
      }
  ...
  function Jf(t, n, i) {
    ...
    if (o === 5 || o === 6)
      ...
      for (Jf(t, n, i), t = t.sibling; t !== null; )
        Jf(t, n, i), t = t.sibling;
  }
  function Ys(t, n, i) {
    var o = t.tag;
    if (o === 5 || o === 6)
  ...
  var Wa = !1, Zt = !1, Wf = !1, Pg = typeof WeakSet == "function" ? WeakSet : Set, en = null;
  function eE(t, n) {
    if (t = t.containerInfo, xd = cu, t = sp(t), Gc(t)) {
    ...
    for (wd = { focusedElem: t, selectionRange: i }, cu = !1, en = n; en !== null; )
  ...
  function Kg(t, n, i) {
    ...
    switch (i.tag) {
      ...
      case 26:
      case 5:
        ti(t, i), n === null && o & 4 && Fg(i), o & 512 && ro(i, i.return);
        break;
      case 12:
        ti(t, i);
        break;
      case 31:
        ...
        break;
      case 13:
        ti(t, i), o & 4 && t0(t, i), o & 64 && (t = i.memoizedState, t !== null && (t = t.dehydrated, t !== null && (i = uE.bind(
          null,
          i
        ), ME(t, i))));
        break;
  ...
  function Jg(t) {
    var n = t.alternate;
    n !== null && (t.alternate = null, Jg(n)), t.child = null, t.deletions = null, t.sibling = null, t.tag === 5 && (n = t.stateNode, n !== null && rt(n)), t.stateNode = null, t.return = null, t.dependencies = null, t.memoizedProps = null, t.memoizedState = null, t.pendingProps = null, t.stateNode = null, t.updateQueue = null;
  }
  var Dt = null, Nn = !1;
  function ei(t, n, i) {
    for (i = i.child; i !== null; )
      Wg(t, n, i), i = i.sibling;
  }
  function Wg(t, n, i) {
    ...
    switch (i.tag) {
      ...
      case 15:
        ...
        break;
      case 1:
        Zt || (Ta(i, n), o = i.stateNode, typeof o.componentWillUnmount == "function" && Xg(
          i,
          n,
          o
        )), ei(
  ...
  function tE(t) {
    switch (t.tag) {
      ...
      case 19:
        var n = t.stateNode;
        return n === null && (n = t.stateNode = new Pg()), n;
      case 22:
        return t = t.stateNode, n = t._retryCache, n === null && (n = t._retryCache = new Pg()), n;
      default:
  ...
  function Cn(t, n) {
    ...
    if (i !== null)
      for (var o = 0; o < i.length; o++) {
        ...
        Wg(h, w, f), Dt = null, Nn = !1, h = f.alternate, h !== null && (h.return = null), f.return = null;
      }
  ...
  function n0(t, n) {
    ...
    switch (t.tag) {
      ...
      case 26:
        ...
        if (Cn(n, t), Rn(t), o & 512 && (Zt || i === null || Ta(i, i.return)), o & 4) {
          ...
          if (o = t.memoizedState, i === null)
            ...
            h !== o ? (h === null ? i.stateNode !== null && (i = i.stateNode, i.parentNode.removeChild(i)) : h.count--, o === null ? ay(
              f,
              t.type,
              t.stateNode
            ) : ty(
        ...
        break;
      case 27:
        Cn(n, t), Rn(t), o & 512 && (Zt || i === null || Ta(i, i.return)), i !== null && o & 4 && Pf(
          t,
          t.memoizedProps,
          i.memoizedProps
        );
      ...
      case 5:
        ...
        o & 4 && t.stateNode != null && (f = t.memoizedProps, Pf(
          t,
          f,
      ...
      case 12:
        ...
        break;
      case 31:
        Cn(n, t), Rn(t), o & 4 && (o = t.updateQueue, o !== null && (t.updateQueue = null, Is(t, o)));
        break;
      case 13:
        Cn(n, t), Rn(t), t.child.flags & 8192 && t.memoizedState !== null != (i !== null && i.memoizedState !== null) && (Xs = Qe()), o & 4 && (o = t.updateQueue, o !== null && (t.updateQueue = null, Is(t, o)));
        break;
      case 22:
        ...
        o & 4 && (o = t.updateQueue, o !== null && (i = o.retryQueue, i !== null && (o.retryQueue = null, Is(t, i))));
        break;
      case 19:
        Cn(n, t), Rn(t), o & 4 && (o = t.updateQueue, o !== null && (t.updateQueue = null, Is(t, o)));
        break;
    ...
    if (n & 2) {
      try {
        ...
        switch (i.tag) {
          ...
          case 3:
          case 4:
            var q = i.stateNode.containerInfo, ie = Kf(t);
            Jf(
              t,
              ie,
              q
  ...
  function a0(t) {
    if (t.subtreeFlags & 1024)
      for (t = t.child; t !== null; ) {
        var n = t;
        a0(n), n.tag === 5 && n.flags & 1024 && n.stateNode.reset(), t = t.sibling;
      }
  }
  function ti(t, n) {
    if (n.subtreeFlags & 8772)
      for (n = n.child; n !== null; )
        Kg(t, n.alternate, n), n = n.sibling;
  }
  function cr(t) {
    for (t = t.child; t !== null; ) {
      var n = t;
      ...
      switch (h.tag) {
        ...
        case 5:
          ni(
            ...
            h,
            i
          ), i && o === null && w & 4 && Fg(h), ro(h, h.return);
          break;
        case 12:
          ni(
            f,
      ...
      for (n = n.child; n !== null; ) {
        ...
        switch (o.tag) {
          case 22:
            ...
            break;
          case 24:
            lo(i, o), f & 2048 && td(o.alternate, o);
            break;
          default:
            lo(i, o);
        }
    ...
    switch (t.tag) {
      case 26:
        Kr(
          ...
          n,
          i
        ), t.flags & oo && t.memoizedState !== null && qE(
          i,
          ma,
          t.memoizedState,
          t.memoizedProps
  ...
  }, aE = typeof WeakMap == "function" ? WeakMap : Map, ht = 0, Rt = null, Pe = null, et = 0, xt = 0, Vn = null, Di = !1, Jr = !1, nd = !1, ai = 0, Bt = 0, Ai = 0, fr = 0, ad = 0, qn = 0, Wr = 0, uo = null, Tn = null, id = !1, Xs = 0, u0 = 0, Fs = 1 / 0, Zs = null, zi = null, Jt = 0, Oi = null, el = null, ii = 0, rd = 0, ld = null, c0 = null, co = 0, od = null;
  function $n() {
    return (ht & 2) !== 0 && et !== 0 ? et & -et : T.T !== null ? hd() : de();
  }
  function f0() {
    if (qn === 0)
  ...
  function d0(t, n, i) {
    ...
    var o = !i && (n & 127) === 0 && (n & t.expiredLanes) === 0 || vt(t, n), f = o ? lE(t, n) : ud(t, n, !0), h = o;
    do {
      if (f === 0) {
        Jr && !o && ji(t, n, 0, !1);
        break;
  ...
  function h0(t, n, i, o, f, h, w, M, q, ie, ue, fe, re, oe) {
    if (t.timeoutHandle = -1, fe = n.subtreeFlags, fe & 8192 || (fe & 16785408) === 16785408) {
      ...
      var _e = (h & 62914560) === h ? Xs - Qe() : (h & 4194048) === h ? u0 - Qe() : 0;
      if (_e = $E(
        fe,
        _e
      ), _e !== null) {
  ...
  function ji(t, n, i, o) {
    n &= ~ad, n &= ~fr, t.suspendedLanes |= n, t.pingedLanes &= ~n, o && (t.warmLanes |= n), o = t.expirationTimes;
    for (var f = n; 0 < f; ) {
      var h = 31 - Ut(f), w = 1 << h;
      o[h] = -1, f &= ~w;
    }
  ...
  function sd() {
    if (Pe !== null) {
      if (xt === 0)
        ...
        t = Pe, Fa = nr = null, _f(t), Gr = null, Fl = 0, t = Pe;
      for (; t !== null; )
        Ig(t.alternate, t), t = t.return;
      Pe = null;
    }
  }
  function tl(t, n) {
    var i = t.timeoutHandle;
    i !== -1 && (t.timeoutHandle = -1, _E(i)), i = t.cancelPendingCommit, i !== null && (t.cancelPendingCommit = null, i()), ii = 0, sd(), Rt = t, Pe = i = Ga(t.current, null), et = n, xt = 0, Vn = null, Di = !1, Jr = vt(t, n), nd = !1, Wr = qn = ad = fr = Ai = Bt = 0, Tn = uo = null, id = !1, (n & 8) !== 0 && (n |= n & 32);
  ...
  function m0(t, n) {
    qe = null, T.H = to, n === Ir || n === _s ? (n = Dp(), xt = 3) : n === df ? (n = Dp(), xt = 4) : xt = n === Vf ? 8 : n !== null && typeof n == "object" && typeof n.then == "function" ? 6 : 1, Vn = n, Pe === null && (Bt = 1, Bs(
      t,
      Pn(n, t.current)
    ));
  }
        ...
        if (xt !== 0 && Pe !== null) {
          ...
          t: switch (xt) {
            ...
            case 4:
              ...
              break e;
            case 7:
              Tp(h) ? (xt = 0, Vn = null, b0(n)) : (xt = 0, Vn = null, nl(t, n, h, 7));
              break;
            case 5:
              var w = null;
              switch (Pe.tag) {
                ...
                case 27:
                  var M = Pe;
                  if (w ? iy(w) : M.stateNode.complete) {
                    xt = 0, Vn = null;
                    var q = M.sibling;
                    if (q !== null) Pe = q;
                    else {
                      var ie = M.return;
                      ie !== null ? (Pe = ie, Ks(ie)) : Pe = null;
                    }
                    break t;
                  }
              }
  ...
  function b0(t) {
    ...
    switch (n.tag) {
      ...
      case 5:
        _f(n);
      default:
        Ig(i, n), n = Pe = yp(n, ai), n = $g(i, n, ai);
    }
    t.memoizedProps = t.pendingProps, n === null ? Ks(t) : Pe = n;
  }
  function nl(t, n, i, o) {
    Fa = nr = null, _f(n), Gr = null, Fl = 0;
    var f = n.return;
    try {
      if (QS(
        t,
    ...
    n.flags & 32768 ? (it || o === 1 ? t = !0 : Jr || (et & 536870912) !== 0 ? t = !1 : (Di = t = !0, (o === 2 || o === 9 || o === 3 || o === 6) && (o = Bn.current, o !== null && o.tag === 13 && (o.flags |= 16384))), x0(n, t)) : Ks(n);
  }
  function Ks(t) {
    var n = t;
    do {
  ...
  function w0(t, n, i, o, f, h, w, M, q) {
    ...
    if (n !== null) {
      ...
      if (h = n.lanes | n.childLanes, h |= Pc, Kt(
        t,
        i,
        h,
        w,
        M,
        q
      ), t === Rt && (Pe = Rt = null, et = 0), el = n, Oi = t, ii = i, rd = h, ld = f, c0 = o, (n.subtreeFlags & 10256) !== 0 || (n.flags & 10256) !== 0 ? (t.callbackNode = null, t.callbackPriority = 0, fE(Lt, function() {
        return C0(), null;
  ...
  function S0() {
    if (Jt === 1) {
      ...
      if ((n.subtreeFlags & 13878) !== 0 || i) {
        ...
        try {
          n0(n, t);
          var h = wd, w = sp(t.containerInfo), M = h.focusedElem, q = h.selectionRange;
          if (w !== M && M && M.ownerDocument && op(
  ...
  function _0() {
    if (Jt === 4 || Jt === 3) {
      Jt = 0, Ze();
      var t = Oi, n = el, i = ii, o = c0;
      (n.subtreeFlags & 10256) !== 0 || (n.flags & 10256) !== 0 ? Jt = 5 : (Jt = 0, el = Oi = null, N0(t, t.pendingLanes));
      ...
      (ii & 3) !== 0 && Js(), Ma(t), f = t.pendingLanes, (i & 261930) !== 0 && (f & 42) !== 0 ? t === od ? co++ : (co = 0, od = t) : co = 0, fo(0);
    }
  }
  function N0(t, n) {
  ...
  function C0() {
    ...
    try {
      L.p = 32 > i ? 32 : i, T.T = null, i = ld, ld = null;
      var h = Oi, w = ii;
      if (Jt = 0, el = Oi = null, ii = 0, (ht & 6) !== 0) throw Error(l(331));
      var M = ht;
      if (ht |= 4, o0(h.current), i0(
        h,
        h.current,
        w,
        i
  ...
  function R0(t, n, i) {
    n = Pn(i, n), n = Uf(t.stateNode, n, 2), t = Ci(t, n, 2), t !== null && (pt(t, 2), Ma(t));
  }
  function wt(t, n, i) {
    if (t.tag === 3)
      R0(t, t, i);
      ...
      for (; n !== null; ) {
        if (n.tag === 3) {
          ...
          if (typeof n.type.getDerivedStateFromError == "function" || typeof o.componentDidCatch == "function" && (zi === null || !zi.has(o))) {
            t = Pn(i, t), i = Tg(2), o = Ci(n, i, 2), o !== null && (Mg(
              i,
              o,
              n,
              t
  ...
  function cd(t, n, i) {
    ...
    f.has(i) || (nd = !0, f.add(i), t = sE.bind(null, t, n, i), n.then(t, t));
  }
  function sE(t, n, i) {
    var o = t.pingCache;
    o !== null && o.delete(n), t.pingedLanes |= t.suspendedLanes & i, t.warmLanes &= ~i, Rt === t && (et & i) === i && (Bt === 4 || Bt === 3 && (et & 62914560) === et && 300 > Qe() - Xs ? (ht & 2) === 0 && tl(t, 0) : ad |= i, Wr === et && (Wr = 0)), Ma(t);
  }
  function T0(t, n) {
  ...
  var Ws = null, al = null, fd = !1, eu = !1, dd = !1, Li = 0;
  function Ma(t) {
    t !== al && t.next === null && (al === null ? Ws = al = t : al = al.next = t), eu = !0, fd || (fd = !0, hE());
  }
  function fo(t, n) {
    if (!dd && eu) {
      dd = !0;
  ...
  function D0(t, n) {
    ...
    if ((i & 3) === 0 || vt(t, i)) {
      ...
      return o = A0.bind(null, t), i = Ye(i, o), t.callbackPriority = n, t.callbackNode = i, n;
    }
  ...
  function A0(t, n) {
    ...
    return o = He(
      ...
      t === Rt ? o : 0,
      t.cancelPendingCommit !== null || t.timeoutHandle !== -1
    ), o === 0 ? null : (d0(t, o, n), D0(t, Qe()), t.callbackNode != null && t.callbackNode === i ? A0.bind(null, t) : null);
  }
  function z0(t, n) {
    if (Js()) return null;
    d0(t, n, !0);
  ...
  function mE(t, n, i, o, f) {
    if (n === "submit" && i && i.stateNode === f) {
      ...
      w && (n = (n = w[we] || null) ? O0(n.formAction) : w.getAttribute("formAction"), n !== null && (h = n, w = null));
      var M = new ds(
        "action",
        "action",
        null,
        ...
        listeners: [
          {
            ...
            listener: function() {
              if (o.defaultPrevented) {
                ...
                typeof h == "function" && (M.preventDefault(), q = w ? j0(f, w) : new FormData(f), Of(
                  i,
                  {
                    pending: !0,
                    data: q,
  ...
  for (var md = 0; md < Qc.length; md++) {
    var pd = Qc[md], pE = pd.toLowerCase(), gE = pd[0].toUpperCase() + pd.slice(1);
    ha(
      pE,
      "on" + gE
    );
  }
  ha(fp, "onAnimationEnd"), ha(dp, "onAnimationIteration"), ha(hp, "onAnimationStart"), ha("dblclick", "onDoubleClick"), ha("focusin", "onFocus"), ha("focusout", "onBlur"), ha(zS, "onTransitionRun"), ha(OS, "onTransitionStart"), ha(jS, "onTransitionCancel"), ha(mp, "onTransitionEnd"), nn("onMouseEnter", ["mouseout", "mouseover"]), nn("onMouseLeave", ["mouseout", "mouseover"]), nn("onPointerEnter", ["pointerout", "pointerover"]), nn("onPointerLeave", ["pointerout", "pointerover"]), cn(
    "onChange",
  ...
  function yd(t) {
    if (!t[tu]) {
      t[tu] = !0, Na.forEach(function(i) {
        i !== "selectionchange" && (yE.has(i) || gd(i, !1, t), gd(i, !0, t));
      });
      var n = t.nodeType === 9 ? t : t.ownerDocument;
      n === null || n[tu] || (n[tu] = !0, gd("selectionchange", !1, n));
    }
  }
  function H0(t, n, i, o) {
    switch (fy(n)) {
    ...
    i = f.bind(
      ...
      i,
      t
    ), f = void 0, !Hc || n !== "touchstart" && n !== "touchmove" && n !== "wheel" || (f = !0), o ? f !== void 0 ? t.addEventListener(n, i, {
      capture: !0,
      passive: f
  ...
  function vd(t, n, i, o, f) {
    ...
    qm(function() {
      ...
      e: {
        ...
        if (re !== void 0) {
          ...
          for (var X = ie, ae; X !== null; ) {
            var ce = X;
            if (ae = ce.stateNode, ce = ce.tag, ce !== 5 && ce !== 26 && ce !== 27 || ae === null || J === null || (ce = jl(X, J), ce != null && Le.push(
              mo(X, ce, ae)
            )), Nt) break;
            X = X.return;
          }
      ...
      if ((n & 7) === 0) {
        e: {
          if (re = t === "mouseover" || t === "pointerover", oe = t === "mouseout" || t === "pointerout", re && i !== Oc && (_e = i.relatedTarget || i.fromElement) && (Ct(_e) || _e[be]))
            break e;
          if ((oe || re) && (re = ue.window === ue ? ue : (re = ue.ownerDocument) ? re.defaultView || re.parentWindow : window, oe ? (_e = i.relatedTarget || i.toElement, oe = ie, _e = _e ? Ct(_e) : null, _e !== null && (Nt = u(_e), Le = _e.tag, _e !== Nt || Le !== 5 && Le !== 27 && Le !== 6) && (_e = null)) : (oe = null, _e = ie), oe !== _e)) {
            if (Le = Im, ce = "onMouseLeave", J = "onMouseEnter", X = "mouse", (t === "pointerout" || t === "pointerover") && (Le = Xm, ce = "onPointerLeave", J = "onPointerEnter", X = "pointer"), Nt = oe == null ? re : We(oe), ae = _e == null ? re : We(_e), re = new Le(
              ce,
              X + "leave",
              oe,
              i,
              ...
              t: {
                for (Le = vE, J = oe, X = _e, ae = 0, ce = J; ce; ce = Le(ce))
                  ae++;
                ce = 0;
        ...
        e: {
          if (re = ie ? We(ie) : window, oe = re.nodeName && re.nodeName.toLowerCase(), oe === "select" || oe === "input" && re.type === "file")
            ...
            oe = re.nodeName, !oe || oe.toLowerCase() !== "input" || re.type !== "checkbox" && re.type !== "radio" ? ie && zc(ie.elementType) && (ut = ep) : ut = TS;
          if (ut && (ut = ut(t, ie))) {
            Wm(
              fe,
              ut,
          ...
          Ne && Ne(t, re, ie), t === "focusout" && ie && re.type === "number" && ie.memoizedProps.value != null && zl(re, "number", re.value);
        }
        switch (Ne = ie ? We(ie) : window, t) {
          case "focusin":
            (Jm(Ne) || Ne.contentEditable === "true") && (jr = Ne, Xc = ie, $l = null);
            break;
          case "focusout":
            $l = Xc = jr = null;
            break;
        ...
        if ($c)
          ...
          Or ? Pm(t, i) && (tt = "onCompositionEnd") : t === "keydown" && i.keyCode === 229 && (tt = "onCompositionStart");
        tt && (Fm && i.locale !== "ko" && (Or || tt !== "onCompositionStart" ? tt === "onCompositionEnd" && Or && (Ie = $m()) : (bi = ue, kc = "value" in bi ? bi.value : bi.textContent, Or = !0)), Ne = nu(ie, tt), 0 < Ne.length && (tt = new Gm(
          tt,
          t,
          null,
          i,
          ue
        ), fe.push({ event: tt, listeners: Ne }), Ie ? tt.data = Ie : (Ie = Km(i), Ie !== null && (tt.data = Ie)))), (Ie = wS ? SS(t, i) : ES(t, i)) && (tt = nu(ie, "onBeforeInput"), 0 < tt.length && (Ne = new Gm(
          "onBeforeInput",
          "beforeinput",
          null,
          i,
  ...
  function k0(t, n, i, o, f) {
    for (var h = n._reactName, w = []; i !== null && i !== o; ) {
      var M = i, q = M.alternate, ie = M.stateNode;
      if (M = M.tag, q !== null && q === o) break;
      M !== 5 && M !== 26 && M !== 27 || ie === null || (q = ie, f ? (ie = jl(i, h), ie != null && w.unshift(
        mo(i, ie, q)
      )) : f || (ie = jl(i, h), ie != null && w.push(
        mo(i, ie, q)
      ))), i = i.return;
    }
...
`).replace(xE, "");
  ...
  function _t(t, n, i, o, f, h) {
    switch (i) {
      ...
      case "textContent":
        break;
      default:
        (!(2 < i.length) || i[0] !== "o" && i[0] !== "O" || i[1] !== "n" && i[1] !== "N") && (i = Zw.get(i) || i, fa(t, i, o));
    }
  }
      ...
      for (var t = 0, n = 0, i = performance.getEntriesByType("resource"), o = 0; o < i.length; o++) {
        ...
        if (h && M && V0(w)) {
          for (w = 0, M = f.responseEnd, o += 1; o < i.length; o++) {
            ...
            ue && V0(fe) && (q = q.responseEnd, w += ue * (q < M ? 1 : (M - ie) / (q - ie)));
          }
  ...
  function EE() {
    var t = window.event;
    return t && t.type === "popstate" ? t === Ed ? !1 : (Ed = t, !0) : (Ed = null, !1);
  }
  var Y0 = typeof setTimeout == "function" ? setTimeout : void 0, _E = typeof clearTimeout == "function" ? clearTimeout : void 0, I0 = typeof Promise == "function" ? Promise : void 0, NE = typeof queueMicrotask == "function" ? queueMicrotask : typeof I0 < "u" ? function(t) {
    return I0.resolve(null).then(t).catch(CE);
  } : Y0;
  function CE(t) {
    setTimeout(function() {
      throw t;
  ...
  var na = /* @__PURE__ */ new Map(), K0 = /* @__PURE__ */ new Set();
  function iu(t) {
  ...
  function AE(t) {
    var n = st(t);
    n !== null && n.tag === 5 && n.type === "form" ? mg(n) : ri.r(t);
  }
  ...
  function J0(t, n, i) {
    ...
    if (o && typeof n == "string" && n) {
      var f = an(n);
      f = 'link[rel="' + t + '"][href="' + f + '"]', typeof i == "string" && (f += '[crossorigin="' + i + '"]'), K0.has(f) || (K0.add(f), t = { rel: t, crossOrigin: i, href: n }, o.querySelector(f) === null && (n = o.createElement("link"), sn(n, "link", t), at(n), o.head.appendChild(n)));
    }
  }
  function zE(t) {
    ri.D(t), J0("dns-prefetch", t, null);
  }
  function OE(t, n) {
    ri.C(t, n), J0("preconnect", t, n);
  }
  function jE(t, n, i) {
    ri.L(t, n, i);
    var o = il;
  ...
  function kE(t, n) {
    ...
    if (i && t) {
      ...
      h || (h = i.querySelector(yo(f)), h || (t = g({ src: t, async: !0 }, n), (n = na.get(f)) && Md(t, n), h = i.createElement("script"), at(h), sn(h, "link", t), i.head.appendChild(h)), h = {
        type: "script",
        instance: h,
        count: 1,
        state: null
  ...
  function BE(t, n) {
    ...
    if (i && t) {
      var o = jt(i).hoistableScripts, f = ll(t), h = o.get(f);
      h || (h = i.querySelector(yo(f)), h || (t = g({ src: t, async: !0, type: "module" }, n), (n = na.get(f)) && Md(t, n), h = i.createElement("script"), at(h), sn(h, "link", t), i.head.appendChild(h)), h = {
        type: "script",
        instance: h,
        count: 1,
        state: null
    ...
    if (n.count++, n.instance === null)
      switch (n.type) {
        ...
        case "stylesheet":
          ...
          o = ey(i), (f = na.get(f)) && Td(o, f), h = (t.ownerDocument || t).createElement("link"), at(h);
          var w = h;
        ...
        case "script":
          return h = ll(i.src), (f = t.querySelector(
            yo(h)
          )) ? (n.instance = f, at(f), f) : (o = i, (f = na.get(h)) && (o = g({}, i), Md(o, f)), t = t.ownerDocument || t, f = t.createElement("script"), at(f), sn(f, "link", o), t.head.appendChild(f), n.instance = f);
        case "void":
          return null;
        default:
  ...
  function qE(t, n, i, o) {
    if (i.type === "stylesheet" && (typeof o.media != "string" || matchMedia(o.media).matches !== !1) && (i.state.loading & 4) === 0) {
      if (i.instance === null) {
        ...
        h = n.ownerDocument || n, o = ey(o), (f = na.get(f)) && Td(o, f), h = h.createElement("link"), at(h);
        var w = h;
  ...
  var su = null;
  function uu(t, n) {
    t.stylesheets = null, t.unsuspend !== null && (t.count++, su = /* @__PURE__ */ new Map(), n.forEach(YE, t), su = null, ou.call(t));
  }
  function YE(t, n) {
  ...
  function ry(t, n, i, o, f, h, w, M, q, ie, ue, fe) {
    return t = new IE(
      t,
      n,
      i,
      ...
      fe,
      M
    ), n = 1, h === !0 && (n |= 24), h = kn(3, null, null, n), t.current = h, h.stateNode = t, n = uf(), n.refCount++, t.pooledCache = n, n.refCount++, h.memoizedState = {
      element: o,
      isDehydrated: i,
      cache: n
    }, hf(h), t;
  ...
  function oy(t, n, i, o, f, h) {
    f = ly(f), o.context === null ? o.context = f : o.pendingContext = f, o = Ni(n), o.payload = { element: i }, h = h === void 0 ? null : h, h !== null && (o.callback = h), i = Ci(t, o, n), i !== null && (Mn(i, t, n), Ql(i, t, n));
  }
  function sy(t, n) {
  ...
  function Ad(t, n) {
    sy(t, n), (t = t.alternate) && sy(t, n);
  }
  function uy(t) {
    if (t.tag === 13 || t.tag === 31) {
      var n = Wi(t, 67108864);
      n !== null && Mn(n, t, 67108864), Ad(t, 67108864);
    }
  }
  function cy(t) {
    if (t.tag === 13 || t.tag === 31) {
  ...
  function zd(t, n, i, o) {
    if (cu) {
      ...
      if (f === null)
        ...
        o.stopPropagation();
      else if (dy(t, o), n & 4 && -1 < FE.indexOf(t)) {
        for (; f !== null; ) {
          var h = st(f);
          if (h !== null)
            switch (h.tag) {
              ...
              case 31:
              case 13:
                M = Wi(h, 2), M !== null && Mn(M, h, 2), Qs(), Ad(h, 2);
            }
          if (h = Od(o), h === null && vd(
            t,
            n,
  ...
  var Ld = !1, ki = null, Bi = null, Ui = null, bo = /* @__PURE__ */ new Map(), xo = /* @__PURE__ */ new Map(), Vi = [], FE = "mousedown mouseup touchcancel touchend touchstart auxclick dblclick pointercancel pointerdown pointerup dragend dragstart drop compositionend compositionstart keydown keypress keyup input textInput copy cut paste click change contextmenu reset".split(
    " "
  );
  function dy(t, n) {
    switch (t) {
  ...
  function wo(t, n, i, o, f, h) {
    return t === null || t.nativeEvent !== h ? (t = {
      ...
      nativeEvent: h,
      targetContainers: [f]
    }, n !== null && (n = st(n), n !== null && uy(n)), t) : (t.eventSystemFlags |= o, n = t.targetContainers, f !== null && n.indexOf(f) === -1 && n.push(f), t);
  }
  function ZE(t, n, i, o, f) {
    switch (n) {
      case "focusin":
        return ki = wo(
          ki,
  ...
  function du(t) {
    ...
    for (var n = t.targetContainers; 0 < n.length; ) {
      ...
      if (i === null) {
        ...
        Oc = o, i.target.dispatchEvent(o), Oc = null;
      } else
        return n = st(i), n !== null && uy(n), t.blockedOn = i, !1;
      n.shift();
    }
    return !0;
  }
  ...
  function QE() {
    Ld = !1, ki !== null && du(ki) && (ki = null), Bi !== null && du(Bi) && (Bi = null), Ui !== null && du(Ui) && (Ui = null), bo.forEach(my), xo.forEach(my);
  }
  function hu(t, n) {
    t.blockedOn === n && (t.blockedOn = null, Ld || (Ld = !0, e.unstable_scheduleCallback(
  ...
  function ol(t) {
    ...
    for (; 0 < Vi.length && (i = Vi[0], i.blockedOn === null); )
      hy(i), i.blockedOn === null && Vi.shift();
    if (i = (t.ownerDocument || t).$$reactFormReplay, i != null)
      for (o = 0; o < i.length; o += 3) {
        ...
        if (typeof h == "function")
          ...
          typeof M == "function" ? i[o + 1] = M : (i.splice(o, 3), o -= 3), py(i);
        }
      }
  }
  function gy() {
  ...
  pu.prototype.render = Hd.prototype.render = function(t) {
    var n = this._internalRoot;
    if (n === null) throw Error(l(409));
    var i = n.current, o = $n();
    oy(i, o, t, n, null, null);
  }, pu.prototype.unmount = Hd.prototype.unmount = function() {
    var t = this._internalRoot;
    if (t !== null) {
      this._internalRoot = null;
      var n = t.containerInfo;
      oy(t.current, 2, null, t, null, null), Qs(), n[be] = null;
    }
  };
  function pu(t) {
    this._internalRoot = t;
  ...
  return Eo.createRoot = function(t, n) {
    ...
    var i = !1, o = "", f = _g, h = Ng, w = Cg;
    return n != null && (n.unstable_strictMode === !0 && (i = !0), n.identifierPrefix !== void 0 && (o = n.identifierPrefix), n.onUncaughtError !== void 0 && (f = n.onUncaughtError), n.onCaughtError !== void 0 && (h = n.onCaughtError), n.onRecoverableError !== void 0 && (w = n.onRecoverableError)), n = ry(
      t,
      1,
      !1,
      null,
      ...
      w,
      gy
    ), t[be] = n.current, yd(t), new Hd(n);
  }, Eo.hydrateRoot = function(t, n, i) {
    if (!s(t)) throw Error(l(299));
    var o = !1, f = "", h = _g, w = Ng, M = Cg, q = null;
    return i != null && (i.unstable_strictMode === !0 && (o = !0), i.identifierPrefix !== void 0 && (f = i.identifierPrefix), i.onUncaughtError !== void 0 && (h = i.onUncaughtError), i.onCaughtError !== void 0 && (w = i.onCaughtError), i.onRecoverableError !== void 0 && (M = i.onRecoverableError), i.formState !== void 0 && (q = i.formState)), n = ry(
      t,
      1,
      !0,
      n,
      ...
      M,
      gy
    ), n.context = ly(null), i = n.current, o = $n(), o = Q(o), f = Ni(o), f.callback = null, Ci(i, f, o), i = o, n.current.lanes = i, pt(n, i), Ma(n), t[be] = n.current, yd(t), new pu(n);
  }, Eo.version = "19.2.7", Eo;
}
var Ry;
function o_() {
  if (Ry) return Ud.exports;
  Ry = 1;
  function e() {
    if (!(typeof __REACT_DEVTOOLS_GLOBAL_HOOK__ > "u" || typeof __REACT_DEVTOOLS_GLOBAL_HOOK__.checkDCE != "function"))
      try {
  ...
  return e(), Ud.exports = l_(), Ud.exports;
}
var s_ = o_();
/**
...
var Pb = (e) => {
  throw TypeError(e);
}, Kb = (e, a, r) => a.has(e) || Pb("Cannot " + r), ia = (e, a, r) => (Kb(e, a, "read from private field"), r ? r.call(e) : a.get(e)), Ao = (e, a, r) => a.has(e) ? Pb("Cannot add the same private member more than once") : a instanceof WeakSet ? a.add(e) : a.set(e, r), Da = (e, a, r, l) => (Kb(e, a, "write to private field"), a.set(e, r), r);
function Ty(e) {
...
function v_(e) {
  e.sort(
    (a, r) => a.score !== r.score ? r.score - a.score : C_(
      a.routesMeta.map((l) => l.childrenIndex),
      r.routesMeta.map((l) => l.childrenIndex)
    )
  );
}
var b_ = /^:[\w-]+$/, x_ = 3, w_ = 2, S_ = 1, E_ = 10, __ = -2, Ay = (e) => e === "*";
function N_(e, a) {
  let r = e.split("/"), l = r.length;
  return r.some(Ay) && (l += __), a && (l += w_), r.filter((s) => !Ay(s)).reduce(
    (s, u) => s + (b_.test(u) ? x_ : u === "" ? S_ : E_),
    l
  );
}
function C_(e, a) {
...
function R_(e, a, r = !1) {
  ...
  for (let d = 0; d < l.length; ++d) {
    let p = l[d], m = d === l.length - 1, y = u === "/" ? a : a.slice(u.length) || "/", g = Zu(
      { path: p.relativePath, caseSensitive: p.caseSensitive, end: m },
      y
    ), v = p.route;
    if (!g && m && r && !l[l.length - 1].route.index && (g = Zu(
      {
        path: p.relativePath,
...
var t1 = /^(?:[a-z][a-z0-9+.-]*:|\/\/)/i, Ph = (e) => t1.test(e);
function A_(e, a = "/") {
  let {
    pathname: r,
    search: l = "",
  ...
  return r ? (r = Jh(r), r.startsWith("/") ? u = zy(r.substring(1), "/") : u = zy(r, a)) : u = a, {
    pathname: u,
    search: O_(l),
    hash: j_(s)
  };
...
function uc(e, a, r, l = !1) {
  let s;
  typeof e == "string" ? s = Sa(e) : (s = { ...e }, Fe(
    !s.pathname || !s.pathname.includes("?"),
    Yd("?", "pathname", "search", s)
  ), Fe(
    !s.pathname || !s.pathname.includes("#"),
    Yd("#", "pathname", "hash", s)
  ), Fe(
  ...
  let p = A_(s, d), m = c && c !== "/" && c.endsWith("/"), y = (u || c === ".") && r.endsWith("/");
  return !p.pathname.endsWith("/") && (m || y) && (p.pathname += "/"), p;
}
var Jh = (e) => e.replace(/\/\/+/g, "/"), la = (e) => Jh(e.join("/")), Qu = (e) => e.replace(/\/+$/, ""), z_ = (e) => Qu(e).replace(/^\/*/, "/"), O_ = (e) => !e || e === "?" ? "" : e.startsWith("?") ? e : "?" + e, j_ = (e) => !e || e === "#" ? "" : e.startsWith("#") ? e : "#" + e, Oy = (e, a = 302) => {
  let r = a;
...
async function r1(e, a, r, l) {
  let s = e[l], u;
  if (s) {
    let c, d = async () => (c ? console.error("You cannot call instrumented handlers more than once") : c = r1(e, a, r, l - 1), u = await c, Fe(u, "Expected a result"), u.type === "error" && u.value instanceof Error ? { status: "error", error: u.value } : { status: "success", error: void 0 });
    try {
      await s(d, a);
    } catch (p) {
...
var U_ = Object.getOwnPropertyNames(Object.prototype).sort().join("\0");
function V_(e) {
  if (e === null || typeof e != "object")
    return !1;
  const a = Object.getPrototypeOf(e);
  return a === Object.prototype || a === null || Object.getOwnPropertyNames(a).sort().join("\0") === U_;
}
var l1 = [
  "POST",
  "PUT",
  ...
  "GET",
  ...l1
], Y_ = new Set($_), o1 = /* @__PURE__ */ new Set([301, 302, 303, 307, 308]), I_ = /* @__PURE__ */ new Set([307, 308]), Id = {
  state: "idle",
  location: void 0,
  matches: void 0,
...
}), s1 = "remix-router-transitions", u1 = Symbol("ResetLoaderData"), pr, cl, Ii, fl, F_ = class {
  constructor(e) {
    Ao(this, pr), Ao(this, cl), Ao(this, Ii), Ao(this, fl), Da(this, pr, e), Da(this, cl, Bu(e));
  }
...
function Z_(e) {
  ...
  let l = e.hydrationRouteProperties || [], s = e.mapRouteProperties || X_, u = s;
  ...
  function Ce(U, Q, { flushSync: W } = {}) {
    ...
    ve.size > 0 && (ve = new Map(ve), ve.forEach((De, Ue) => ve.set(Ue, _o)));
  ...
  async function $e(U, Q) {
    ...
    let W = vh(
      ...
      Q?.fromRouteId,
      Q?.relative
    ), { path: de, submission: pe, error: Ee } = Hy(
      !1,
      W,
      Q
    ), ve;
  ...
  function ft() {
    ge || (ge = Py()), Lt(), xe({ revalidation: "loading" });
    let U = ge.promise;
  ...
  async function Te(U, Q, W) {
    ...
    if (pe && A.initialized && !L && o2(A.location, Q) && !(W && W.submission && dn(W.submission.formMethod))) {
    ...
    let be = dl(
      ...
      K.signal,
      W && W.submission
    ), Me = e.getContext ? await e.getContext() : new My(), De;
    if (W && W.pendingError)
      De = [
        Gi(pe).route.id,
      ...
      if (st.pendingActionResult) {
        ...
        if (Yn(jt) && Vo(jt.error) && jt.error.status === 404) {
          K = null, Ce(Q, {
            matches: st.matches,
            loaderData: {},
            errors: {
      ...
      pe = st.matches || pe, De = st.pendingActionResult, we = Gd(
        Q,
        pe,
        U,
        W.submission
  ...
  async function ke(U, Q, W, de, pe, Ee, ve, we, be, Me, De, Ue, je, Ge) {
    let rt = ve || Gd(Q, W, de, we), Ct = we || be || Qy(rt), st = !T && !De;
    if (Ee) {
      if (st) {
        let bt = Ye(je);
        xe(
    ...
    let We = d.activeRoutes, { dsMatches: jt, revalidatingFetchers: at } = ky(
      U,
      pe,
      u,
      c,
    ...
    let Sn = new Map(A.fetchers), { loaderData: pi, errors: En } = Gy(
      A,
      W,
      jn,
      je,
  ...
  async function Je(U, Q, W, de) {
    Ot(U);
    let pe = (de && de.flushSync) === !0, Ee = d.activeRoutes, ve = vh(
      A.location,
      A.matches,
      p,
      W,
    ...
    let { path: Me, submission: De, error: Ue } = Hy(
      !0,
      ve,
      de
    );
    ...
    let je = e.getContext ? await e.getContext() : new My(), Ge = (de && de.preventScrollReset) === !0;
  ...
  async function Ze(U, Q, W, de, pe, Ee, ve, we, be, Me) {
    ...
    if (he.has(U)) {
      ...
      if (yr(We))
        if (G.delete(U), D > rt) {
          ...
          return P.add(U), mt(U, No(be)), gt(je, We, !1, {
    ...
    let cn = ++Z;
    H.set(U, cn);
    let { dsMatches: nn, revalidatingFetchers: Sn } = ky(
      at,
      pe,
      u,
      c,
      ...
      [Ge.route.id, We],
      Me
    ), pi = No(be, We.data), En = new Map(A.fetchers);
  ...
  async function gt(U, Q, W, {
    ...
    Fe(we, "Expected a Location header on the redirect Response"), we = Yy(
      we,
      new URL(U.url),
      p,
      e.history
    );
    let be = yh(A.location, we, {
      _isRedirect: !0
    });
    if (r) {
      let rt = !1;
    ...
    !de && !pe && De && Ue && je && (de = Qy(A.navigation));
    let Ge = de || pe;
  ...
  function Xn(U) {
    return se.set(U, (se.get(U) || 0) + 1), he.has(U) && he.delete(U), A.fetchers.get(U) || G_;
  }
  function xn(U, Q) {
  ...
  function un(U) {
    let Q = ra(404, { pathname: U }), W = d.activeRoutes, { matches: de, route: pe } = yu(W);
    return { notFoundMatches: de, route: pe, error: Q };
  }
  function He(U, Q, W) {
    if (S = U, C = Q, N = W || null, !R && A.navigation === Id) {
      R = !0;
...
function vh(e, a, r, l, s, u) {
  ...
  return r !== "/" && (p.pathname = D_({ basename: r, pathname: p.pathname })), Ua(p);
}
function Hy(e, a, r) {
  if (!r || !Q_(r))
    return { path: a };
  ...
  }), u = (r.formMethod || "get").toUpperCase(), c = y1(a);
  if (r.body !== void 0) {
...
`,
  ...
  let d, p;
  if (r.formData)
    d = xh(r.formData), p = r.formData;
  else if (r.body instanceof FormData)
    d = xh(r.body), p = r.body;
    ...
    try {
      d = new URLSearchParams(r.body), p = Iy(d);
    } catch {
      return l();
    }
  let m = {
  ...
  let y = Sa(a);
  return e && y.search && tm(y.search) && d.append("index", ""), y.search = `?${d}`, { path: Ua(y), submission: m };
}
function ky(e, a, r, l, s, u, c, d, p, m, y, g, v, x, S, N, C, R, z, E, O, k) {
  ...
  let te = O ? O[1].statusCode : void 0, $ = te && te >= 400, K = {
    ...
    if (Y != null && L > Y)
      ...
      G = P;
    } else P_(u.loaderData, u.matches[L], T) && (G = !0);
    if (G !== null)
      return bh(
        r,
        l,
    ...
    let Z = !1;
    typeof k == "boolean" ? Z = k : $ ? Z = !1 : (g || V.pathname + V.search === A.pathname + A.search || V.search !== A.search || K_(u.matches[L], T)) && (Z = !0);
    let D = {
      ...K,
  ...
  return S.forEach((T, L) => {
    ...
    if (N.has(L))
      return;
    let D = Uu(Z, T.path), H = new AbortController(), P = dl(
      s,
      T.path,
      H.signal
    ), ne = null;
...
function f1(e, a) {
  return "id" in e && "id" in a && e.id === a.id ? !0 : e.index === a.index && e.path === a.path && e.caseSensitive === a.caseSensitive ? (!e.children || e.children.length === 0) && (!a.children || a.children.length === 0) ? !0 : e.children?.every(
    (r, l) => a.children?.some((s) => f1(r, s))
  ) ?? !1 : !1;
}
var Uy = /* @__PURE__ */ new WeakMap(), d1 = ({
  key: e,
  route: a,
  manifest: r,
  ...
  if (d)
    return d;
  let p = (async () => {
    let m = h_(e), g = s[e] !== void 0 && e !== "hasErrorBoundary";
    if (m)
      Yt(
        !m,
  ...
  return c[e] = p, p;
}, Vy = /* @__PURE__ */ new WeakMap();
function J_(e, a, r, l, s) {
  let u = r[e.id];
  ...
  if (typeof e.lazy == "function") {
    ...
    let g = (async () => {
      ...
      for (let S in v) {
        ...
        if (N === void 0)
          continue;
        let C = p_(S), z = u[S] !== void 0 && // This property isn't static since it should always be updated based
...
async function W_(e) {
  return e.matches.some((a) => a.route.middleware) ? h1(e, () => qy(e)) : qy(e);
}
function h1(e, a) {
  return e2(
    e,
...
async function m1(e, a, r, l, s, u, c = 0) {
  let { request: d } = e;
  if (d.signal.aborted)
...
function bh(e, a, r, l, s, u, c, d, p, m = null, y) {
  let g = !1, v = p1(
    e,
    a,
    r,
...
async function i2(e) {
  ...
  if (em(a)) {
    ...
    return r === "error" ? {
      type: "error",
      error: new cc(a.status, a.statusText, l),
      statusCode: a.status,
      headers: a.headers
    } : {
      type: "data",
  ...
  return r === "error" ? Zy(a) ? a.data instanceof Error ? {
    type: "error",
    error: a.data,
...
function Yy(e, a, r, l) {
  if (Ph(e)) {
    ...
    if ($y.includes(u.protocol))
      throw new Error("Invalid redirect location");
    let c = oa(u.pathname, r) != null;
    if (u.origin === a.origin && c)
      return Jh(u.pathname) + u.search + u.hash;
  }
  try {
    let s = l.createURL(e);
    if ($y.includes(s.protocol))
      throw new Error("Invalid redirect location");
  } catch {
  }
  return e;
...
function dl(e, a, r, l) {
  let s = e.createURL(y1(a)).toString(), u = { signal: r };
  if (l && dn(l.formMethod)) {
    let { formMethod: c, formEncType: d } = l;
    u.method = c.toUpperCase(), d === "application/json" ? (u.headers = new Headers({ "Content-Type": d }), u.body = JSON.stringify(l.json)) : d === "text/plain" ? u.body = l.text : d === "application/x-www-form-urlencoded" && l.formData ? u.body = xh(l.formData) : u.body = l.formData;
  }
...
function l2(e, a, r, l = !1, s = !1) {
  ...
  return e.forEach((g) => {
    ...
    if (Fe(
      ...
      l || (u[v] = u1), p || (p = !0, d = Vo(x.error) ? x.error.status : 500), x.headers && (m[v] = x.headers);
    } else
...
function Gy(e, a, r, l, s, u, c) {
  let { loaderData: d, errors: p } = l2(
    a,
    r,
    l
  );
...
function Xy(e, a, r, l) {
  let s = Object.entries(a).filter(([, u]) => u !== u1).reduce((u, [c, d]) => (u[c] = d, u), {});
  for (let u of r) {
    let c = u.route.id;
...
function f2(e) {
  return em(e.result) && o1.has(e.result.status);
}
function Yn(e) {
  return e.type === "error";
}
...
function h2(e) {
  return em(e) && d2(e.status) && e.headers.has("Location");
}
function m2(e) {
  return Y_.has(e.toUpperCase());
}
function dn(e) {
...
function Uu(e, a) {
  ...
  if (e[e.length - 1].route.index && tm(r || ""))
    return e[e.length - 1];
  let l = n1(e);
  return l[l.length - 1];
}
...
var Wo = _.createContext(null);
Wo.displayName = "DataRouterState";
var v1 = _.createContext(!1);
function b1() {
  return _.useContext(v1);
}
var nm = _.createContext({
  isTransitioning: !1
});
nm.displayName = "ViewTransition";
var x1 = _.createContext(
  /* @__PURE__ */ new Map()
);
x1.displayName = "Fetchers";
var b2 = _.createContext(null);
b2.displayName = "Await";
var sa = _.createContext(
  null
);
sa.displayName = "Navigation";
var fc = _.createContext(
  null
);
...
var am = _.createContext(null);
am.displayName = "RouteError";
var w1 = "REACT_ROUTER_ERROR", x2 = "REDIRECT", w2 = "ROUTE_ERROR_RESPONSE";
function S2(e) {
  if (e.startsWith(`${w1}:${x2}:{`))
    try {
...
function _2(e, { relative: a } = {}) {
  ...
  let { basename: r, navigator: l } = _.useContext(sa), { hash: s, pathname: u, search: c } = ts(e, { relative: a }), d = u;
  return r !== "/" && (d = u === "/" ? r : la([r, u])), l.createHref({ pathname: d, search: c, hash: s });
}
function es() {
  return _.useContext(fc) != null;
}
function di() {
  return Fe(
    es(),
...
function C2() {
  ...
  let e = _.useContext(Rr), { basename: a, navigator: r } = _.useContext(sa), { matches: l } = _.useContext(Va), { pathname: s } = di(), u = JSON.stringify(Kh(l)), c = _.useRef(!1);
  return E1(() => {
    c.current = !0;
  }), _.useCallback(
    (p, m = {}) => {
      if (Yt(c.current, S1), !c.current) return;
      if (typeof p == "number") {
        r.go(p);
        return;
      }
...
var R2 = _.createContext(null);
function T2(e) {
  let a = _.useContext(Va).outlet;
  return _.useMemo(
    () => a && /* @__PURE__ */ _.createElement(R2.Provider, { value: e }, a),
    [a, e]
  );
}
function ts(e, { relative: a } = {}) {
  let { matches: r } = _.useContext(Va), { pathname: l } = di(), s = JSON.stringify(Kh(r));
  return _.useMemo(
    () => uc(
      e,
      JSON.parse(s),
...
function D2() {
  let e = U2(), a = Vo(e) ? `${e.status} ${e.statusText}` : e instanceof Error ? e.message : JSON.stringify(e), r = e instanceof Error ? e.stack : null, l = "rgba(200,200,200, 0.5)", s = { padding: "0.5rem", backgroundColor: l }, u = { padding: "2px 4px", backgroundColor: l }, c = null;
...
var A2 = /* @__PURE__ */ _.createElement(D2, null), _1 = class extends _.Component {
  constructor(e) {
    super(e), this.state = {
      location: e.location,
  ...
  render() {
    ...
    return this.context ? /* @__PURE__ */ _.createElement(z2, { error: e }, a) : a;
  }
};
_1.contextType = v1;
...
function j2(e, a = [], r) {
  ...
  return s.reduceRight(
    (y, g, v) => {
      ...
      l && (x = u && g.route.id ? u[g.route.id] : void 0, N = g.route.errorElement || A2, c && (d < 0 && v === 0 ? (C1(
        "route-fallback",
        !1,
...
function dc(e) {
  let a = H2(e), r = a.matches[a.matches.length - 1];
  return Fe(
    r.route.id,
...
function V2() {
  ...
  return E1(() => {
    ...
    async (s, u = {}) => {
      Yt(r.current, S1), r.current && (typeof s == "number" ? await e.navigate(s) : await e.navigate(s, { fromRouteId: a, ...u }));
    },
    [e, a]
  );
}
var Ky = {};
function C1(e, a, r) {
  !a && !Ky[e] && (Ky[e] = !0, Yt(!1, r));
}
var Jy = {};
function Wy(e, a) {
  !e && !Jy[a] && (Jy[a] = !0, console.warn(a));
}
var q2 = "useOptimistic", ev = n_[q2], $2 = () => {
};
function Y2(e) {
  return ev ? ev(e) : [e, $2];
}
...
function X2(e, a) {
  return Z_({
    ...
    routes: e,
    hydrationRouteProperties: G2,
    mapRouteProperties: I2,
...
function Z2({
  ...
  l = b1() || l;
  let [u, c] = _.useState(e.state), [d, p] = Y2(u), [m, y] = _.useState(), [g, v] = _.useState({
    isTransitioning: !1
  ...
  _.useLayoutEffect(() => e.subscribe(O), [e, O]), _.useEffect(() => {
    g.isTransitioning && !g.flushSync && S(new F2());
  }, [g]), _.useEffect(() => {
    if (x && m && e.window) {
  ...
  return /* @__PURE__ */ _.createElement(_.Fragment, null, /* @__PURE__ */ _.createElement(Rr.Provider, { value: V }, /* @__PURE__ */ _.createElement(Wo.Provider, { value: d }, /* @__PURE__ */ _.createElement(x1.Provider, { value: E.current }, /* @__PURE__ */ _.createElement(nm.Provider, { value: g }, /* @__PURE__ */ _.createElement(
    J2,
    {
      basename: B,
      location: d.location,
...
function J2({
  ...
  ), N == null ? null : /* @__PURE__ */ _.createElement(sa.Provider, { value: p }, /* @__PURE__ */ _.createElement(fc.Provider, { children: a, value: N }));
}
var Vu = "get", qu = "application/x-www-form-urlencoded";
function hc(e) {
  return typeof HTMLElement < "u" && e instanceof HTMLElement;
}
function W2(e) {
  return hc(e) && e.tagName.toLowerCase() === "button";
}
function eN(e) {
  return hc(e) && e.tagName.toLowerCase() === "form";
}
function tN(e) {
  return hc(e) && e.tagName.toLowerCase() === "input";
}
function nN(e) {
...
function lN(e, a) {
  ...
  if (eN(e)) {
    ...
    l = d ? oa(d, a) : null, r = e.getAttribute("method") || Vu, s = Fd(e.getAttribute("enctype")) || qu, u = new FormData(e);
  } else if (W2(e) || tN(e) && (e.type === "submit" || e.type === "image")) {
    let d = e.form;
    if (d == null)
      throw new Error(
    ...
    if (l = p ? oa(p, a) : null, r = e.getAttribute("formmethod") || d.getAttribute("method") || Vu, s = Fd(e.getAttribute("formenctype")) || Fd(d.getAttribute("enctype")) || qu, u = new FormData(d, e), !iN()) {
...
function R1(e, a, r, l) {
  ...
  return r ? s.pathname.endsWith("/") ? s.pathname = `${s.pathname}_.${l}` : s.pathname = `${s.pathname}.${l}` : s.pathname === "/" ? s.pathname = `_root.${l}` : a && oa(s.pathname, a) === "/" ? s.pathname = `${Qu(a)}/_root.${l}` : s.pathname = `${Qu(s.pathname)}.${l}`, s;
}
...
async function uN(e, a, r) {
  ...
  return hN(
    l.flat(1).filter(sN).filter((s) => s.rel === "stylesheet" || s.rel === "preload").map(
      (s) => s.rel === "stylesheet" ? { ...s, rel: "prefetch", as: "style" } : { ...s, rel: "prefetch" }
    )
  );
}
function nv(e, a, r, l, s, u) {
...
function cN(e, a, { includeHydrateFallback: r } = {}) {
  return fN(
    e.map((l) => {
...
function mN() {
  let e = _.useContext(Wo);
  return rm(
    e,
    "You must render this element inside a <DataRouterStateContext.Provider> element"
  ), e;
}
var om = _.createContext(void 0);
om.displayName = "FrameworkContext";
function sm() {
  let e = _.useContext(om);
  return rm(
    e,
...
function pN(e, a) {
  let r = _.useContext(om), [l, s] = _.useState(!1), [u, c] = _.useState(!1), { onFocus: d, onBlur: p, onMouseEnter: m, onMouseLeave: y, onTouchStart: g } = a, v = _.useRef(null);
  _.useEffect(() => {
...
function gN({ page: e, ...a }) {
  let r = b1(), { router: l } = lm(), s = _.useMemo(
    () => Jb(l.routes, e, l.basename),
    [l.routes, e, l.basename]
  );
  return s ? r ? /* @__PURE__ */ _.createElement(vN, { page: e, matches: s, ...a }) : /* @__PURE__ */ _.createElement(bN, { page: e, matches: s, ...a }) : null;
}
function yN(e) {
  let { manifest: a, routeModules: r } = sm(), [l, s] = _.useState([]);
  return _.useEffect(() => {
    let u = !1;
    return uN(e, a, r).then(
      (c) => {
        u || s(c);
      }
    ), () => {
...
function vN({
  ...
  let l = di(), { future: s } = sm(), { basename: u } = lm(), c = _.useMemo(() => {
...
function bN({
  ...
  let l = di(), { future: s, manifest: u, routeModules: c } = sm(), { basename: d } = lm(), { loaderData: p, matches: m } = mN(), y = _.useMemo(
    () => nv(
      e,
      a,
      m,
...
try {
  wN && (window.__reactRouterVersion = // @ts-expect-error
  "7.17.0");
} catch {
}
var T1 = /^(?:[a-z][a-z0-9+.-]*:|\/\/)/i, M1 = _.forwardRef(
  function({
    onClick: a,
    discover: r = "render",
    prefetch: l = "none",
    ...
    let { basename: C, navigator: R, useTransitions: z } = _.useContext(sa), E = typeof y == "string" && T1.test(y), O = i1(y, C);
    y = O.to;
    let k = _2(y, { relative: s }), B = di(), V = null;
    if (d) {
      let I = uc(
        d,
        [],
    ...
    return A && !E ? /* @__PURE__ */ _.createElement(_.Fragment, null, j, /* @__PURE__ */ _.createElement(gN, { page: k })) : j;
  }
);
M1.displayName = "Link";
var SN = _.forwardRef(
  function({
    ...
    let g = ts(c, { relative: m.relative }), v = di(), x = _.useContext(Wo), { navigator: S, basename: N } = _.useContext(sa), C = x != null && // Conditional usage is OK here because the usage of a data router is static
    // eslint-disable-next-line react-hooks/rules-of-hooks
    DN(g) && d === !0, R = S.encodeLocation ? S.encodeLocation(g).pathname : g.pathname, z = v.pathname, E = x && x.navigation && x.navigation.location ? x.navigation.location.pathname : null;
...
var EN = _.forwardRef(
  ({
    ...
    let { useTransitions: N } = _.useContext(sa), C = TN(), R = MN(d, { relative: m }), z = c.toLowerCase() === "get" ? "get" : "post", E = typeof d == "string" && T1.test(d), O = (k) => {
...
function NN(e, {
  ...
  let y = N2(), g = di(), v = ts(e, { relative: c });
...
var CN = 0, RN = () => `__${String(++CN)}__`;
function TN() {
  let { router: e } = D1(
    "useSubmit"
    /* UseSubmit */
  ), { basename: a } = _.useContext(sa), r = k2(), l = e.fetch, s = e.navigate;
  return _.useCallback(
    async (u, c = {}) => {
      let { action: d, method: p, encType: m, formData: y, body: g } = lN(
        u,
        a
      );
      if (c.navigate === !1) {
        let v = c.fetcherKey || RN();
...
function DN(e, { relative: a } = {}) {
  let r = _.useContext(nm);
  Fe(
    r != null,
  ...
  return Zu(s.pathname, c) != null || Zu(s.pathname, u) != null;
}
const AN = [
  ...
  ditHighPath: "",
  ditLowPath: ""
}, ON = "Wan2.2-I2V-A14B fp8 (Kijai, bundled)";
class mc extends Error {
  constructor(a, r, l, s) {
    super(l), this.status = a, this.category = r, this.requestId = s, this.name = "ExtensionApiError";
  }
}
const pc = "/api/v1/extensions/nexus.video.svi2-pro";
async function Tr(e, a) {
  const r = e.startsWith("http") ? e : `${pc}${e}`, l = await fetch(r, {
    ...a,
    headers: {
...
function jN(e, a, r) {
  const l = e.startsWith("http") ? e : `${pc}${e}`, s = new EventSource(l);
...
function An({ tone: e = "neutral", children: a, className: r }) {
  const l = [HN[e], r].filter(Boolean).join(" ");
  return /* @__PURE__ */ b.jsx("span", { className: l, children: a });
}
var kN = { primary: "_1h48t1v1 _1h48t1v0", secondary: "_1h48t1v2 _1h48t1v0", ghost: "_1h48t1v3 _1h48t1v0", danger: "_1h48t1v4 _1h48t1v0" }, BN = { sm: "_1h48t1v5", md: "_1h48t1v6", lg: "_1h48t1v7" }, UN = "_1h48t1v9";
function Ha({
  variant: e = "primary",
  size: a = "md",
  type: r = "button",
  ...
  const p = [kN[e], BN[a], c].filter(Boolean).join(" ");
  return /* @__PURE__ */ b.jsxs(
    "button",
    {
      ...
      ...d,
      children: [
        l ? /* @__PURE__ */ b.jsx("span", { className: UN, "aria-hidden": "true" }) : null,
        u
      ]
    }
  );
...
$u.prototype = gc.prototype = {
  constructor: $u,
  on: function(e, a) {
    var r = this._, l = qN(e + "", r), s, u = -1, c = l.length;
    if (arguments.length < 2) {
      for (; ++u < c; ) if ((s = (e = l[u]).type) && (s = $N(r[s], e.name))) return s;
      return;
    }
    if (a != null && typeof a != "function") throw new Error("invalid callback: " + a);
    for (; ++u < c; )
      if (s = (e = l[u]).type) r[s] = av(r[s], e.name, a);
      else if (a == null) for (s in r) r[s] = av(r[s], e.name, null);
    return this;
  },
  copy: function() {
    var e = {}, a = this._;
...
function av(e, a, r) {
  for (var l = 0, s = e.length; l < s; ++l)
    if (e[l].name === a) {
      e[l] = VN, e = e.slice(0, l).concat(e.slice(l + 1));
      break;
    }
  return r != null && e.push({ name: a, value: r }), e;
}
var wh = "http://www.w3.org/1999/xhtml";
const iv = {
...
function yc(e) {
  var a = e += "", r = a.indexOf(":");
  return r >= 0 && (a = e.slice(0, r)) !== "xmlns" && (e = e.slice(r + 1)), iv.hasOwnProperty(a) ? { space: iv[a], local: e } : e;
}
function YN(e) {
  return function() {
    var a = this.ownerDocument, r = this.namespaceURI;
    return r === wh && a.documentElement.namespaceURI === wh ? a.createElement(e) : a.createElementNS(r, e);
  };
}
function IN(e) {
  return function() {
...
function j1(e) {
  var a = yc(e);
  return (a.local ? IN : YN)(a);
}
function GN() {
}
function um(e) {
  return e == null ? GN : function() {
    return this.querySelector(e);
  };
}
function XN(e) {
  typeof e != "function" && (e = um(e));
...
function PN(e) {
  typeof e == "function" ? e = QN(e) : e = L1(e);
...
function eC(e) {
  return this.select(e == null ? WN : JN(typeof e == "function" ? e : k1(e)));
}
...
function iC(e) {
  return this.selectAll(e == null ? nC : aC(typeof e == "function" ? e : k1(e)));
}
function rC(e) {
...
function lC() {
  return new Gn(this._enter || this._groups.map(B1), this._parents);
}
function Pu(e, a) {
...
function sC(e, a, r, l, s, u) {
  for (var c = 0, d, p = a.length, m = u.length; c < m; ++c)
    (d = a[c]) ? (d.__data__ = u[c], l[c] = d) : r[c] = new Pu(e, u[c]);
  for (; c < p; ++c)
    (d = a[c]) && (s[c] = d);
}
function uC(e, a, r, l, s, u, c) {
  ...
  for (d = 0; d < g; ++d)
    x = c.call(e, u[d], d, u) + "", (p = m.get(x)) ? (l[d] = p, p.__data__ = u[d], m.delete(x)) : r[d] = new Pu(e, u[d]);
  for (d = 0; d < y; ++d)
...
function fC(e, a) {
  ...
  var r = a ? uC : sC, l = this._parents, s = this._groups;
  typeof e != "function" && (e = oC(e));
  for (var u = s.length, c = new Array(u), d = new Array(u), p = new Array(u), m = 0; m < u; ++m) {
    var y = l[m], g = s[m], v = g.length, x = dC(e.call(y, y && y.__data__, m, l)), S = x.length, N = d[m] = new Array(S), C = c[m] = new Array(S), R = p[m] = new Array(v);
    r(y, g, N, C, R, x, a);
...
function hC() {
  return new Gn(this._exit || this._groups.map(B1), this._parents);
}
function mC(e, a, r) {
...
function AC(e, a) {
  ...
  return this.each((a == null ? r.local ? CC : NC : typeof a == "function" ? r.local ? DC : MC : r.local ? TC : RC)(r, a));
}
function U1(e) {
...
function LC(e, a, r) {
  return arguments.length > 1 ? this.each((a == null ? zC : typeof a == "function" ? jC : OC)(e, a, r ?? "")) : xl(this.node(), e);
}
function xl(e, a) {
  return e.style.getPropertyValue(a) || U1(e).getComputedStyle(e, null).getPropertyValue(a);
}
function HC(e) {
  return function() {
    delete this[e];
...
function UC(e, a) {
  return arguments.length > 1 ? this.each((a == null ? HC : typeof a == "function" ? BC : kC)(e, a)) : this.node()[e];
}
function V1(e) {
...
function q1(e) {
  this._node = e, this._names = V1(e.getAttribute("class") || "");
}
q1.prototype = {
  add: function(e) {
...
function $C(e, a) {
  return function() {
    (a.apply(this, arguments) ? $1 : Y1)(this, e);
  };
}
function YC(e, a) {
  var r = V1(e + "");
  ...
  return this.each((typeof a == "function" ? $C : a ? VC : qC)(r, a));
}
function IC() {
  this.textContent = "";
}
...
function FC(e) {
  return arguments.length ? this.each(e == null ? IC : (typeof e == "function" ? XC : GC)(e)) : this.node().textContent;
}
function ZC() {
  this.innerHTML = "";
}
...
function KC(e) {
  return arguments.length ? this.each(e == null ? ZC : (typeof e == "function" ? PC : QC)(e)) : this.node().innerHTML;
}
function JC() {
...
function nR(e) {
  var a = typeof e == "function" ? e : j1(e);
...
function iR(e, a) {
  var r = typeof e == "function" ? e : j1(e), l = a == null ? aR : typeof a == "function" ? a : um(a);
  return this.select(function() {
...
function pR(e, a, r) {
  ...
  for (d = a ? mR : hR, s = 0; s < u; ++s) this.each(d(l[s], a, r));
  return this;
}
function I1(e, a, r) {
  var l = U1(e), s = l.CustomEvent;
...
function yR(e, a) {
  return function() {
    return I1(this, e, a.apply(this, arguments));
  };
}
function vR(e, a) {
  return this.each((typeof a == "function" ? yR : gR)(e, a));
}
function* bR() {
  for (var e = this._groups, a = 0, r = e.length; a < r; ++a)
...
function ns() {
  return new Gn([[document.documentElement]], G1);
}
function xR() {
  return this;
}
...
function In(e) {
  return typeof e == "string" ? new Gn([[document.querySelector(e)]], [document.documentElement]) : new Gn([[e]], G1);
}
function wR(e) {
  let a;
...
function ya(e, a) {
  if (e = wR(e), a === void 0 && (a = e.currentTarget), a) {
...
const SR = { passive: !1 }, qo = { capture: !0, passive: !1 };
function Zd(e) {
...
function X1(e) {
  var a = e.document.documentElement, r = In(e).on("dragstart.drag", yl, qo);
...
function Z1() {
  var e = ER, a = _R, r = NR, l = CR, s = {}, u = gc("start", "drag", "end"), c = 0, d, p, m, y, g = 0;
  function v(O) {
    O.on("mousedown.drag", x).filter(l).on("touchstart.drag", C).on("touchmove.drag", R, SR).on("touchend.drag touchcancel.drag", z).style("touch-action", "none").style("-webkit-tap-highlight-color", "rgba(0,0,0,0)");
  }
  function x(O, k) {
    if (!(y || !e.call(this, O, k))) {
      var B = E(this, a.call(this, O, k), O, k, "mouse");
      B && (In(O.view).on("mousemove.drag", S, qo).on("mouseup.drag", N, qo), X1(O.view), Zd(O), m = !1, d = O.clientX, p = O.clientY, B("start", O));
    }
  }
  function S(O) {
    if (yl(O), !m) {
  ...
  function N(O) {
    In(O.view).on("mousemove.drag mouseup.drag", null), F1(O.view, m), yl(O), s.mouse("end", O);
  }
  function C(O, k) {
    if (e.call(this, O, k)) {
      var B = O.changedTouches, V = a.call(this, O, k), A = B.length, Y, te;
      for (Y = 0; Y < A; ++Y)
        (te = E(this, V, O, k, B[Y].identifier, B[Y])) && (Zd(O), te("start", O, B[Y]));
    }
  }
  function R(O) {
  ...
  function z(O) {
    ...
    for (y && clearTimeout(y), y = setTimeout(function() {
      ...
      (A = s[k[V].identifier]) && (Zd(O), A("end", O, k[V]));
  }
  function E(O, k, B, V, A, Y) {
    var te = u.copy(), $ = ya(Y || B, k), K, le, j;
    if ((j = r.call(O, new Sh("beforestart", {
      sourceEvent: B,
      target: v,
      identifier: A,
      active: c,
...
var $o = 0.7, Ku = 1 / $o, vl = "\\s*([+-]?\\d+)\\s*", Yo = "\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)\\s*", ka = "\\s*([+-]?(?:\\d*\\.)?\\d+(?:[eE][+-]?\\d+)?)%\\s*", RR = /^#([0-9a-f]{3,8})$/, TR = new RegExp(`^rgb\\(${vl},${vl},${vl}\\)$`), MR = new RegExp(`^rgb\\(${ka},${ka},${ka}\\)$`), DR = new RegExp(`^rgba\\(${vl},${vl},${vl},${Yo}\\)$`), AR = new RegExp(`^rgba\\(${ka},${ka},${ka},${Yo}\\)$`), zR = new RegExp(`^hsl\\(${Yo},${ka},${ka}\\)$`), OR = new RegExp(`^hsla\\(${Yo},${ka},${ka},${Yo}\\)$`), rv = {
  aliceblue: 15792383,
...
function Sr(e) {
  var a, r;
  return e = (e + "").trim().toLowerCase(), (a = RR.exec(e)) ? (r = a[1].length, a = parseInt(a[1], 16), r === 6 ? sv(a) : r === 3 ? new zn(a >> 8 & 15 | a >> 4 & 240, a >> 4 & 15 | a & 240, (a & 15) << 4 | a & 15, 1) : r === 8 ? wu(a >> 24 & 255, a >> 16 & 255, a >> 8 & 255, (a & 255) / 255) : r === 4 ? wu(a >> 12 & 15 | a >> 8 & 240, a >> 8 & 15 | a >> 4 & 240, a >> 4 & 15 | a & 240, ((a & 15) << 4 | a & 15) / 255) : null) : (a = TR.exec(e)) ? new zn(a[1], a[2], a[3], 1) : (a = MR.exec(e)) ? new zn(a[1] * 255 / 100, a[2] * 255 / 100, a[3] * 255 / 100, 1) : (a = DR.exec(e)) ? wu(a[1], a[2], a[3], a[4]) : (a = AR.exec(e)) ? wu(a[1] * 255 / 100, a[2] * 255 / 100, a[3] * 255 / 100, a[4]) : (a = zR.exec(e)) ? fv(a[1], a[2] / 100, a[3] / 100, 1) : (a = OR.exec(e)) ? fv(a[1], a[2] / 100, a[3] / 100, a[4]) : rv.hasOwnProperty(e) ? sv(rv[e]) : e === "transparent" ? new zn(NaN, NaN, NaN, 0) : null;
}
function sv(e) {
...
function Eh(e, a, r, l) {
  return arguments.length === 1 ? HR(e) : new zn(e, a, r, l ?? 1);
}
function zn(e, a, r, l) {
...
fm(zn, Eh, Q1(as, {
  brighter(e) {
    return e = e == null ? Ku : Math.pow(Ku, e), new zn(this.r * e, this.g * e, this.b * e, this.opacity);
  },
  darker(e) {
  ...
  clamp() {
    return new zn(xr(this.r), xr(this.g), xr(this.b), Ju(this.opacity));
  },
  displayable() {
...
function BR(e, a, r, l) {
  return arguments.length === 1 ? P1(e) : new va(e, a, r, l ?? 1);
}
function va(e, a, r, l) {
...
fm(va, BR, Q1(as, {
  brighter(e) {
    return e = e == null ? Ku : Math.pow(Ku, e), new va(this.h, this.s, this.l * e, this.opacity);
  },
  darker(e) {
  ...
  rgb() {
    ...
    return new zn(
      Qd(e >= 240 ? e - 240 : e + 120, s, l),
      Qd(e, s, l),
      Qd(e < 120 ? e + 240 : e - 120, s, l),
      this.opacity
    );
  },
  clamp() {
    return new va(dv(this.h), Su(this.s), Su(this.l), Ju(this.opacity));
  },
  displayable() {
  ...
  formatHsl() {
    const e = Ju(this.opacity);
    return `${e === 1 ? "hsl(" : "hsla("}${dv(this.h)}, ${Su(this.s) * 100}%, ${Su(this.l) * 100}%${e === 1 ? ")" : `, ${e})`}`;
  }
}));
function dv(e) {
...
function qR(e) {
  return (e = +e) == 1 ? K1 : function(a, r) {
    return r - a ? VR(a, r, e) : dm(isNaN(a) ? r : a);
  };
}
function K1(e, a) {
  var r = a - e;
  return r ? UR(e, r) : dm(isNaN(e) ? a : e);
}
const Wu = (function e(a) {
  var r = qR(a);
  function l(s, u) {
    var c = r((s = Eh(s)).r, (u = Eh(u)).r), d = r(s.g, u.g), p = r(s.b, u.b), m = K1(s.opacity, u.opacity);
    return function(y) {
...
var _h = /[-+]?(?:\d+\.?\d*|\.?\d+)(?:[eE][-+]?\d+)?/g, Pd = new RegExp(_h.source, "g");
function FR(e) {
  return function() {
    return e;
  };
...
function J1(e, a) {
  var r = _h.lastIndex = Pd.lastIndex = 0, l, s, u, c = -1, d = [], p = [];
  for (e = e + "", a = a + ""; (l = _h.exec(e)) && (s = Pd.exec(a)); )
    (u = s.index) > r && (u = a.slice(r, u), d[c] ? d[c] += u : d[++c] = u), (l = l[0]) === (s = s[0]) ? d[c] ? d[c] += s : d[++c] = s : (d[++c] = null, p.push({ i: c, x: ja(l, s) })), r = Pd.lastIndex;
  return r < a.length && (u = a.slice(r), d[c] ? d[c] += u : d[++c] = u), d.length < 2 ? p[0] ? ZR(p[0].x) : FR(a) : (a = p.length, function(m) {
...
function Ho(e, a) {
  var r = typeof a, l;
  return a == null || r === "boolean" ? dm(a) : (r === "number" ? ja : r === "string" ? (l = Sr(a)) ? (a = l, Wu) : J1 : a instanceof Sr ? Wu : a instanceof Date ? GR : YR(a) ? $R : Array.isArray(a) ? IR : typeof a.valueOf != "function" && typeof a.toString != "function" || isNaN(a) ? XR : ja)(e, a);
}
var hv = 180 / Math.PI, Nh = {
  translateX: 0,
  translateY: 0,
  rotate: 0,
  skewX: 0,
...
function QR(e) {
  ...
  return a.isIdentity ? Nh : W1(a.a, a.b, a.c, a.d, a.e, a.f);
}
function PR(e) {
  return e == null || (Eu || (Eu = document.createElementNS("http://www.w3.org/2000/svg", "g")), Eu.setAttribute("transform", e), !(e = Eu.transform.baseVal.consolidate())) ? Nh : (e = e.matrix, W1(e.a, e.b, e.c, e.d, e.e, e.f));
}
function ex(e, a, r, l) {
  function s(m) {
...
var KR = ex(QR, "px, ", "px)", "deg)"), JR = ex(PR, ", ", ")", ")"), WR = 1e-12;
function mv(e) {
  ...
  function s(u, c) {
    ...
    if (N < WR)
      ...
      R = (B - k) / a, C = function(V) {
        var A = V * R, Y = mv(k), te = m / (r * z) * (Y * tT(a * A + k) - eT(k));
        return [
          d + te * x,
          p + te * S,
          m * Y / mv(a * A + k)
...
var wl = 0, Oo = 0, Ro = 0, tx = 1e3, ec, jo, tc = 0, Er = 0, vc = 0, Io = typeof performance == "object" && performance.now ? performance : Date, nx = typeof window == "object" && window.requestAnimationFrame ? window.requestAnimationFrame.bind(window) : function(e) {
  setTimeout(e, 17);
};
function hm() {
  return Er || (nx(nT), Er = Io.now() + vc);
}
function nT() {
  Er = 0;
}
...
nc.prototype = ax.prototype = {
  constructor: nc,
  restart: function(e, a, r) {
    if (typeof e != "function") throw new TypeError("callback is not a function");
    r = (r == null ? hm() : +r) + (a == null ? 0 : +a), !this._next && jo !== this && (jo ? jo._next = this : ec = this, jo = this), this._call = e, this._time = r, Ch();
  },
  stop: function() {
...
function rT() {
  for (var e, a = ec, r, l = 1 / 0; a; )
    a._call ? (l > a._time && (l = a._time), e = a, a = a._next) : (r = a._next, a._next = null, a = e ? e._next = r : ec = r);
  jo = e, Ch(l);
}
function Ch(e) {
  if (!wl) {
    ...
    var a = e - Er;
    a > 24 ? (e < 1 / 0 && (Oo = setTimeout(pv, e - Io.now() - vc)), Ro && (Ro = clearInterval(Ro))) : (Ro || (tc = Io.now(), Ro = setInterval(iT, tx)), wl = 1, nx(pv));
  }
}
function gv(e, a, r) {
  var l = new nc();
...
var lT = gc("start", "end", "cancel", "interrupt"), oT = [], ix = 0, yv = 1, Rh = 2, Iu = 3, vv = 4, Th = 5, Gu = 6;
function bc(e, a, r, l, s, u) {
...
function mm(e, a) {
  var r = Ea(e, a);
  if (r.state > ix) throw new Error("too late; already scheduled");
  return r;
}
function qa(e, a) {
  var r = Ea(e, a);
  if (r.state > Iu) throw new Error("too late; already running");
  return r;
}
function Ea(e, a) {
...
function sT(e, a, r) {
  ...
  l[a] = r, r.timer = ax(u, 0, r.time);
  function u(m) {
    r.state = yv, r.timer.restart(c, r.delay, r.time), r.delay <= m && c(m - r.delay);
  }
  function c(m) {
    var y, g, v, x;
    if (r.state !== yv) return p();
    for (y in l)
      if (x = l[y], x.name === r.name) {
        if (x.state === Iu) return gv(c);
        x.state === vv ? (x.state = Gu, x.timer.stop(), x.on.call("interrupt", e, e.__data__, x.index, x.group), delete l[y]) : +y < a && (x.state = Gu, x.timer.stop(), x.on.call("cancel", e, e.__data__, x.index, x.group), delete l[y]);
      }
    if (gv(function() {
      r.state === Iu && (r.state = vv, r.timer.restart(d, r.delay, r.time), d(m));
    }), r.state = Rh, r.on.call("start", e, e.__data__, r.index, r.group), r.state === Rh) {
      for (r.state = Iu, s = new Array(v = r.tween.length), y = 0, g = -1; y < v; ++y)
        (x = r.tween[y].value.call(e, e.__data__, r.index, r.group)) && (s[++g] = x);
      s.length = g + 1;
    }
  }
  function d(m) {
    for (var y = m < r.duration ? r.ease.call(null, m / r.duration) : (r.timer.restart(p), r.state = Th, 1), g = -1, v = s.length; ++g < v; )
      s[g].call(e, y);
    r.state === Th && (r.on.call("end", e, e.__data__, r.index, r.group), p());
  }
  function p() {
    r.state = Gu, r.timer.stop(), delete l[a];
...
function Xu(e, a) {
  ...
  if (r) {
    ...
    for (c in r) {
      ...
      s = l.state > Rh && l.state < Th, l.state = Gu, l.timer.stop(), l.on.call(s ? "interrupt" : "cancel", e, e.__data__, l.index, l.group), delete r[c];
    }
...
function dT(e, a) {
  ...
  return this.each((a == null ? cT : fT)(r, e, a));
}
function pm(e, a, r) {
  var l = e._id;
...
function rx(e, a) {
  var r;
  return (typeof a == "number" ? ja : a instanceof Sr ? Wu : (r = Sr(a)) ? (a = r, Wu) : J1)(e, a);
}
function hT(e) {
  return function() {
    this.removeAttribute(e);
...
function bT(e, a) {
  var r = yc(e), l = r === "transform" ? JR : rx;
  return this.attrTween(e, typeof a == "function" ? (r.local ? vT : yT)(r, l, pm(this, "attr." + e, a)) : a == null ? (r.local ? mT : hT)(r) : (r.local ? gT : pT)(r, l, a));
}
function xT(e, a) {
  return function(r) {
...
function _T(e, a) {
  ...
  var l = yc(e);
  return this.tween(r, (l.local ? ST : ET)(l, a));
}
function NT(e, a) {
  return function() {
...
function RT(e) {
  var a = this._id;
  return arguments.length ? this.each((typeof e == "function" ? NT : CT)(a, e)) : Ea(this.node(), a).delay;
}
function TT(e, a) {
  return function() {
...
function DT(e) {
  var a = this._id;
  return arguments.length ? this.each((typeof e == "function" ? TT : MT)(a, e)) : Ea(this.node(), a).duration;
}
function AT(e, a) {
  if (typeof a != "function") throw new Error();
  return function() {
...
function zT(e) {
  var a = this._id;
  return arguments.length ? this.each(AT(a, e)) : Ea(this.node(), a).ease;
}
function OT(e, a) {
  return function() {
    var r = a.apply(this, arguments);
...
function jT(e) {
  ...
  return this.each(OT(this._id, e));
}
function LT(e) {
  typeof e != "function" && (e = H1(e));
  for (var a = this._groups, r = a.length, l = new Array(r), s = 0; s < r; ++s)
...
function UT(e, a) {
  var r = this._id;
  return arguments.length < 2 ? Ea(this.node(), r).on.on(e) : this.each(BT(r, e, a));
}
function VT(e) {
  return function() {
...
function $T(e) {
  ...
  for (var l = this._groups, s = l.length, u = new Array(s), c = 0; c < s; ++c)
    for (var d = l[c], p = d.length, m = u[c] = new Array(p), y, g, v = 0; v < p; ++v)
      (y = d[v]) && (g = e.call(y, y.__data__, v, d)) && ("__data__" in y && (g.__data__ = y.__data__), m[v] = g, bc(m[v], a, r, v, m, Ea(y, r)));
    ...
    for (var p = l[d], m = p.length, y, g = 0; g < m; ++g)
      if (y = p[g]) {
        for (var v = e.call(y, y.__data__, g, p), x, S = Ea(y, r), N = 0, C = v.length; N < C; ++N)
          (x = v[N]) && bc(x, a, r, N, v, S);
        u.push(v), c.push(y);
      }
  return new fi(u, c, a, r);
}
var IT = ns.prototype.constructor;
function GT() {
...
function QT(e, a) {
  ...
  return function() {
    var p = qa(this, e), m = p.on, y = p.value[u] == null ? d || (d = lx(a)) : void 0;
    (m !== r || s !== y) && (l = (r = m).copy()).on(c, s = y), p.on = l;
  };
}
function PT(e, a, r) {
  var l = (e += "") == "transform" ? KR : rx;
  return a == null ? this.styleTween(e, XT(e, l)).on("end.style." + e, lx(e)) : typeof a == "function" ? this.styleTween(e, ZT(e, l, pm(this, "style." + e, a))).each(QT(this._id, e)) : this.styleTween(e, FT(e, l, a), r).on("end.style." + e, null);
}
function KT(e, a, r) {
  return function(l) {
...
function nM(e) {
  return this.tween("text", typeof e == "function" ? tM(pm(this, "text", e)) : eM(e == null ? "" : e + ""));
}
function aM(e) {
  return function(a) {
...
function rM(e) {
  ...
  if (typeof e != "function") throw new Error();
  return this.tween(a, iM(e));
}
function lM() {
  for (var e = this._name, a = this._id, r = ox(), l = this._groups, s = l.length, u = 0; u < s; ++u)
...
function dM(e) {
  var a, r;
  e instanceof fi ? (a = e._id, e = e._name) : (a = ox(), (r = cM).time = hm(), e = e == null ? null : e + "");
  for (var l = this._groups, s = l.length, u = 0; u < s; ++u)
    for (var c = l[u], d = c.length, p, m = 0; m < d; ++m)
      (p = c[m]) && bc(p, e, a, m, c, r || fM(p, a));
  return new fi(l, this._parents, e, a);
}
ns.prototype.interrupt = uT;
ns.prototype.transition = dM;
const _u = (e) => () => e;
function hM(e, {
  sourceEvent: a,
  target: r,
...
var xc = new ui(1, 0, 0);
sx.prototype = ui.prototype;
function sx(e) {
  for (; !e.__zoom; ) if (!(e = e.parentNode)) return xc;
  return e.__zoom;
}
function Kd(e) {
  e.stopImmediatePropagation();
...
function ux() {
  var e = mM, a = pM, r = vM, l = gM, s = yM, u = [0, 1 / 0], c = [[-1 / 0, -1 / 0], [1 / 0, 1 / 0]], d = 250, p = Yu, m = gc("start", "zoom", "end"), y, g, v, x = 500, S = 150, N = 0, C = 10;
  function R(j) {
    j.property("__zoom", bv).on("wheel.zoom", A, { passive: !1 }).on("mousedown.zoom", Y).on("dblclick.zoom", te).filter(s).on("touchstart.zoom", $).on("touchmove.zoom", K).on("touchend.zoom touchcancel.zoom", le).style("-webkit-tap-highlight-color", "rgba(0,0,0,0)");
  }
  R.transform = function(j, I, T, L) {
    var F = j.selection ? j.selection() : j;
    F.property("__zoom", bv), j !== F ? k(j, I, T, L) : F.interrupt().each(function() {
    ...
    R.transform(j, function() {
      ...
      return r(xc.translate(D[0], D[1]).scale(Z.k).translate(
        typeof I == "function" ? -I.apply(this, arguments) : -I,
        typeof T == "function" ? -T.apply(this, arguments) : -T
      ), G, c);
    }, L, F);
  ...
  function A(j, ...I) {
    ...
    if (T.wheel)
      ...
      if (L.k === F) return;
      T.mouse = [G, L.invert(G)], Xu(this), T.start();
    }
    To(j), T.wheel = setTimeout(Z, S), T.zoom("mouse", r(E(z(L, F), T.mouse[0], T.mouse[1]), T.extent, c));
    function Z() {
      T.wheel = null, T.end();
    }
  }
  function Y(j, ...I) {
    ...
    X1(j.view), Kd(j), L.mouse = [G, this.__zoom.invert(G)], Xu(this), L.start();
    function H(ne) {
      if (To(ne), !L.moved) {
    ...
    function P(ne) {
      F.on("mousemove.zoom mouseup.zoom", null), F1(ne.view, L.moved), To(ne), L.event(ne).end();
    }
  }
  function te(j, ...I) {
    if (e.apply(this, arguments)) {
      ...
      To(j), d > 0 ? In(this).transition().duration(d).call(k, Z, L, j) : In(this).call(R.transform, Z, L, j);
    }
  }
  function $(j, ...I) {
    if (e.apply(this, arguments)) {
  ...
  function le(j, ...I) {
    if (this.__zooming) {
      ...
      for (Kd(j), v && clearTimeout(v), v = setTimeout(function() {
        v = null;
      }, x), G = 0; G < F; ++G)
  ...
  return R.wheelDelta = function(j) {
    return arguments.length ? (l = typeof j == "function" ? j : _u(+j), R) : l;
  }, R.filter = function(j) {
    return arguments.length ? (e = typeof j == "function" ? j : _u(!!j), R) : e;
  }, R.touchable = function(j) {
    return arguments.length ? (s = typeof j == "function" ? j : _u(!!j), R) : s;
  }, R.extent = function(j) {
    return arguments.length ? (a = typeof j == "function" ? j : _u([[+j[0][0], +j[0][1]], [+j[1][0], +j[1][1]]]), R) : a;
...
const mx = (e) => "id" in e && "source" in e && "target" in e, bM = (e) => "id" in e && "position" in e && !("source" in e) && !("target" in e), gm = (e) => "id" in e && "internals" in e && !("source" in e) && !("target" in e), is = (e, a = [0, 0]) => {
  const { width: r, height: l } = hi(e), s = e.origin ?? a, u = r * s[0], c = l * s[1];
  return {
    x: e.position.x - u,
    y: e.position.y - c
  };
}, xM = (e, a = { nodeOrigin: [0, 0] }) => {
  if (e.length === 0)
    return { x: 0, y: 0, width: 0, height: 0 };
  const r = e.reduce((l, s) => {
    const u = typeof s == "string";
    let c = !a.nodeLookup && !u ? s : void 0;
    a.nodeLookup && (c = u ? a.nodeLookup.get(s) : gm(s) ? s : a.nodeLookup.get(s.id));
    const d = c ? ic(c, a.nodeOrigin) : { x: 0, y: 0, x2: 0, y2: 0 };
    return wc(l, d);
  ...
  return e.forEach((s) => {
    (a.filter === void 0 || a.filter(s)) && (r = wc(r, ic(s)), l = !0);
  }), l ? Sc(r) : { x: 0, y: 0, width: 0, height: 0 };
  ...
  for (const m of e.values()) {
    ...
    if (c && !g || v)
      continue;
    const x = y.width ?? m.width ?? m.initialWidth ?? null, S = y.height ?? m.height ?? m.initialHeight ?? null, N = Fo(d, _l(m)), C = (x ?? 0) * (S ?? 0), R = u && N > 0;
...
async function EM({ nodes: e, width: a, height: r, panZoom: l, minZoom: s, maxZoom: u }, c) {
  if (e.size === 0)
    return !0;
  const d = SM(e, c), p = rs(d), m = bm(p, a, r, c?.minZoom ?? s, c?.maxZoom ?? u, c?.padding ?? 0.1);
...
function px({ nodeId: e, nextPosition: a, nodeLookup: r, nodeOrigin: l = [0, 0], nodeExtent: s, onError: u }) {
...
async function _M({ nodesToRemove: e = [], edgesToRemove: a = [], nodes: r, edges: l, onBeforeDelete: s }) {
  ...
  const d = new Set(a.map((v) => v.id)), p = l.filter((v) => v.deletable !== !1), y = wM(c, p);
  for (const v of p)
...
const wv = (e, a, r) => e < a ? El(Math.abs(e - a), 1, a) / a : e > r ? -El(Math.abs(e - r), 1, a) / a : 0, vm = (e, a, r = 15, l = 40) => {
  const s = wv(e.x, l, a.width - l) * r, u = wv(e.y, l, a.height - l) * r;
  return [s, u];
}, wc = (e, a) => ({
  x: Math.min(e.x, a.x),
  y: Math.min(e.y, a.y),
...
}), Mh = ({ x: e, y: a, width: r, height: l }) => ({
  x: e,
  y: a,
  x2: e + r,
  y2: a + l
}), Sc = ({ x: e, y: a, x2: r, y2: l }) => ({
  x: e,
  y: a,
  width: r - e,
  height: l - a
}), _l = (e, a = [0, 0]) => {
  const { x: r, y: l } = gm(e) ? e.internals.positionAbsolute : is(e, a);
  return {
    x: r,
    y: l,
...
}, Sv = (e) => ba(e.width) && ba(e.height) && ba(e.x) && ba(e.y), ba = (e) => !isNaN(e) && isFinite(e), vx = (e, a) => (r, l) => {
}, ls = (e, a = [1, 1]) => ({
...
const bm = (e, a, r, l, s, u) => {
  const c = NM(u, a, r), d = (a - c.x) / e.width, p = (r - c.y) / e.height, m = Math.min(d, p), y = El(m, l, s), g = e.x + e.width / 2, v = e.y + e.height / 2, x = a / 2 - g * y, S = r / 2 - v * y, N = CM(e, x, S, y, a, r), C = {
...
function xx(e, a = { width: 0, height: 0 }, r, l, s) {
  const u = { ...e }, c = l.get(r);
  if (c) {
    const d = c.origin || s;
...
}), wx = (e) => e?.getRootNode?.() || window?.document, MM = ["INPUT", "SELECT", "TEXTAREA"];
function Sx(e) {
  const a = e.composedPath?.()?.[0] || e.target;
  return a?.nodeType !== 1 ? !1 : MM.includes(a.nodeName) || a.hasAttribute("contenteditable") || !!a.closest(".nokey");
}
const Ex = (e) => "clientX" in e, xa = (e, a) => {
  const r = Ex(e), l = r ? e.clientX : e.touches?.[0].clientX, s = r ? e.clientY : e.touches?.[0].clientY;
  return {
    x: l - (a?.left ?? 0),
    y: s - (a?.top ?? 0)
  };
...
function _x({ sourceX: e, sourceY: a, targetX: r, targetY: l, sourceControlX: s, sourceControlY: u, targetControlX: c, targetControlY: d }) {
...
function Nv({ pos: e, x1: a, y1: r, x2: l, y2: s, c: u }) {
  switch (e) {
    case Ae.Left:
      return [a - Nu(a - l, u), r];
    case Ae.Right:
...
function Nx({ sourceX: e, sourceY: a, sourcePosition: r = Ae.Bottom, targetX: l, targetY: s, targetPosition: u = Ae.Top, curvature: c = 0.25 }) {
  const [d, p] = Nv({
    pos: r,
    x1: e,
    y1: a,
...
function DM({ sourceNode: e, targetNode: a, selected: r = !1, zIndex: l = 0, elevateOnSelect: s = !1, zIndexMode: u = "basic" }) {
  if (u === "manual")
    return l;
  const c = s && r ? l + 1e3 : l, d = Math.max(e.parentId || s && e.selected ? e.internals.z : 0, a.parentId || s && a.selected ? a.internals.z : 0);
  return c + d;
}
function AM({ sourceNode: e, targetNode: a, width: r, height: l, transform: s }) {
  const u = wc(ic(e), ic(a));
...
const zM = ({ source: e, sourceHandle: a, target: r, targetHandle: l }) => `xy-edge__${e}${a || ""}-${r}${l || ""}`, OM = (e, a) => a.some((r) => r.source === e.source && r.target === e.target && (r.sourceHandle === e.sourceHandle || !r.sourceHandle && !e.sourceHandle) && (r.targetHandle === e.targetHandle || !r.targetHandle && !e.targetHandle)), jM = (e, a, r = {}) => {
  if (!e.source || !e.target)
    return r.onError?.("006", wa.error006()), a;
  const l = r.getEdgeId || zM;
  let s;
  return mx(e) ? s = { ...e } : s = {
    ...e,
    id: l(e)
  }, OM(s, a) ? a : (s.sourceHandle === null && delete s.sourceHandle, s.targetHandle === null && delete s.targetHandle, a.concat(s));
};
function Rx({ sourceX: e, sourceY: a, targetX: r, targetY: l }) {
  const [s, u, c, d] = Cx({
    sourceX: e,
    sourceY: a,
    targetX: r,
...
const Cv = {
  ...
  [Ae.Top]: { x: 0, y: -1 },
  [Ae.Bottom]: { x: 0, y: 1 }
}, LM = ({ source: e, sourcePosition: a = Ae.Bottom, target: r }) => a === Ae.Left || a === Ae.Right ? e.x < r.x ? { x: 1, y: 0 } : { x: -1, y: 0 } : e.y < r.y ? { x: 0, y: 1 } : { x: 0, y: -1 }, Rv = (e, a) => Math.sqrt(Math.pow(a.x - e.x, 2) + Math.pow(a.y - e.y, 2));
function HM({ source: e, sourcePosition: a = Ae.Bottom, target: r, targetPosition: l = Ae.Top, center: s, offset: u, stepPosition: c }) {
  const d = Cv[a], p = Cv[l], m = { x: e.x + d.x * u, y: e.y + d.y * u }, y = { x: r.x + p.x * u, y: r.y + p.y * u }, g = LM({
    source: m,
    sourcePosition: a,
    target: y
  }), v = g.x !== 0 ? "x" : "y", x = g[v];
  let S = [], N, C;
  const R = { x: 0, y: 0 }, z = { x: 0, y: 0 }, [, , E, O] = Cx({
    sourceX: e.x,
    sourceY: e.y,
    targetX: r.x,
    targetY: r.y
...
function kM(e, a, r, l) {
  const s = Math.min(Rv(e, a) / 2, Rv(a, r) / 2, l), { x: u, y: c } = a;
...
function Dh({ sourceX: e, sourceY: a, sourcePosition: r = Ae.Bottom, targetX: l, targetY: s, targetPosition: u = Ae.Top, borderRadius: c = 5, centerX: d, centerY: p, offset: m = 20, stepPosition: y = 0.5 }) {
  const [g, v, x, S, N] = HM({
    source: { x: e, y: a },
    sourcePosition: r,
    target: { x: l, y: s },
...
function BM(e) {
  ...
  if (!Tv(a) || !Tv(r))
    return null;
  const l = a.internals.handleBounds || Mv(a.handles), s = r.internals.handleBounds || Mv(r.handles), u = Dv(l?.source ?? [], e.sourceHandle), c = Dv(
...
function UM(e, { id: a, defaultColor: r, defaultMarkerStart: l, defaultMarkerEnd: s }) {
...
function zh(e, a, r, l = {}) {
  const s = Sm(qM, l), u = { i: 0 }, c = new Map(a), d = s?.elevateNodesOnSelect && !Em(s.zIndexMode) ? Tx : 0;
    ...
    if (s.checkEquality && y === g?.internals.userNode)
      ...
      g = {
        ...
        internals: {
          ...
          handleBounds: YM(y, g),
          z: Mx(y, d, s.zIndexMode),
          userNode: y
        }
      }, a.set(y.id, g);
    }
    (g.measured === void 0 || g.measured.width === void 0 || g.measured.height === void 0) && !g.hidden && (p = !1), y.parentId && _m(g, a, r, l, u), m ||= y.selected ?? !1;
  }
...
function _m(e, a, r, l, s) {
  const { elevateNodesOnSelect: u, nodeOrigin: c, nodeExtent: d, zIndexMode: p } = Sm(wm, l), m = e.parentId, y = a.get(m);
  if (!y) {
  ...
  IM(e, r), s && !y.parentId && y.internals.rootParentIndex === void 0 && p === "auto" && (y.internals.rootParentIndex = ++s.i, y.internals.z = y.internals.z + s.i * VM), s && y.internals.rootParentIndex !== void 0 && (s.i = y.internals.rootParentIndex);
  const g = u && !Em(p) ? Tx : 0, { x: v, y: x, z: S } = GM(e, y, c, d, g, p), { positionAbsolute: N } = e.internals, C = v !== N.x || x !== N.y;
...
function Nm(e, a, r, l = [0, 0]) {
  const s = [], u = /* @__PURE__ */ new Map();
  for (const c of e) {
    const d = a.get(c.parentId);
    if (!d)
      continue;
    const p = u.get(c.parentId)?.expandedRect ?? _l(d), m = yx(p, c.rect);
...
function XM(e, a, r, l, s, u, c) {
  ...
  for (const x of e.values()) {
    ...
    const N = xm(x.nodeElement), C = S.measured.width !== N.width || S.measured.height !== N.height;
    if (!!(N.width && N.height && (C || !S.internals.handleBounds || x.force))) {
      ...
      S.parentId && S.extent === "parent" ? O = gx(O, N, a.get(S.parentId)) : E && (O = _r(O, E, N));
      const k = {
        ...S,
        measured: N,
        internals: {
          ...
          positionAbsolute: O,
          handleBounds: {
            source: _v("source", x.nodeElement, z, g, S.id),
            target: _v("target", x.nodeElement, z, g, S.id)
          }
        }
      };
      a.set(S.id, k), S.parentId && _m(k, a, r, { nodeOrigin: s, zIndexMode: c }), p = !0, C && (m.push({
        id: S.id,
        type: "dimensions",
        dimensions: N
...
async function FM({ delta: e, panZoom: a, transform: r, translateExtent: l, width: s, height: u }) {
  if (!a || !e.x && !e.y)
    return !1;
...
function Dx(e, a, r) {
  ...
  for (const l of r) {
    ...
    Av("source", p, y, e, s, c), Av("target", p, m, e, u, d), a.set(l.id, l);
  }
}
function Ax(e, a) {
  if (!e.parentId)
...
function ZM(e, a, r, l) {
  ...
  for (const [u, c] of e)
    if ((c.selected || c.id === l) && (!c.parentId || !Ax(c, e)) && (c.draggable || a && typeof c.draggable > "u")) {
      const d = e.get(u);
      d && s.set(u, {
        id: u,
...
function Jd({ nodeId: e, dragItems: a, nodeLookup: r, dragging: l = !0 }) {
  const s = [];
  for (const [c, d] of a) {
...
function QM({ dragItems: e, snapGrid: a, x: r, y: l }) {
...
function PM({ onNodeMouseDown: e, getStoreItems: a, onDragStart: r, onDrag: l, onDragStop: s }) {
  ...
  function C({ noDragClassName: z, handleSelector: E, domNode: O, isSelectable: k, nodeId: B, nodeClickDistance: V = 0 }) {
    ...
    function A({ x: K, y: le }) {
      ...
      u = { x: K, y: le };
      let P = !1;
      const ne = d.size > 1, se = ne && I ? Mh(rs(d)) : null, he = ne && L ? QM({
        dragItems: d,
        snapGrid: T,
        x: K,
        y: le
      ...
      for (const [me, ee] of d) {
        ...
        const { position: Re, positionAbsolute: Se } = px({
          nodeId: me,
          nextPosition: ge,
          nodeLookup: j,
          nodeExtent: ze || I,
    ...
    function te(K) {
      ...
      const P = ko(K.sourceEvent, { transform: T, snapGrid: L, snapToGrid: F, containerBounds: y });
      if (u = P, d = ZM(le, I, P, B), d.size > 0 && (r || Z || !B && D)) {
        const [ne, se] = Jd({
          nodeId: B,
          dragItems: d,
          nodeLookup: le
    ...
    const $ = Z1().clickDistance(V).on("start", (K) => {
      const { domNode: le, nodeDragThreshold: j, transform: I, snapGrid: T, snapToGrid: L } = a();
      y = le?.getBoundingClientRect() || null, x = !1, S = !1, N = K.sourceEvent, j === 0 && te(K), u = ko(K.sourceEvent, { transform: I, snapGrid: T, snapToGrid: L, containerBounds: y }), m = xa(K.sourceEvent, y);
    }).on("drag", (K) => {
      const { autoPanOnNodeDrag: le, transform: j, snapGrid: I, snapToGrid: T, nodeDragThreshold: L, nodeLookup: F } = a(), G = ko(K.sourceEvent, { transform: j, snapGrid: I, snapToGrid: T, containerBounds: y });
      ...
      const le = K.target;
      return !K.button && (!z || !zv(le, `.${z}`, O)) && (!E || zv(le, E, O));
    });
    v.call($);
  }
  function R() {
...
const jx = () => !0;
function tD(e, { connectionMode: a, connectionRadius: r, handleId: l, nodeId: s, edgeUpdaterType: u, isTarget: c, domNode: d, nodeLookup: p, lib: m, autoPanOnConnect: y, flowId: g, panBy: v, cancelConnection: x, onConnectStart: S, onConnect: N, onConnectEnd: C, isValidConnection: R = jx, onReconnectEnd: z, updateConnection: E, getTransform: O, getFromHandle: k, autoPanSpeed: B, dragThreshold: V = 1, handleDomNode: A }) {
  const Y = wx(e.target);
  let te = 0, $;
  const { x: K, y: le } = xa(e), j = Ox(u, A), I = d?.getBoundingClientRect();
  let T = !1;
  if (!I || !j)
    return;
  const L = zx(s, j, l, p, a);
  if (!L)
    return;
  ...
  function ge(Re) {
    ...
    const Se = O();
    F = xa(Re, I), $ = WM(Tl(F, Se, !1, [1, 1]), r, p, ne), G || (P(), G = !0);
    const xe = Lx(Re, {
      handle: $,
      connectionMode: a,
      fromNodeId: s,
    ...
    H = xe.handleDomNode, Z = xe.connection, D = eD(!!$, xe.isValid);
    const Ce = p.get(s), $e = Ce ? Cr(Ce, ne, Ae.Left, !0) : me.from, ft = {
      ...
      toPosition: D && xe.toHandle ? xe.toHandle.position : xv[ne.position],
...
function Lx(e, { handle: a, connectionMode: r, fromNodeId: l, fromHandleId: s, fromType: u, doc: c, lib: d, flowId: p, isValidConnection: m = jx, nodeLookup: y }) {
  ...
  if (C) {
    const z = Ox(void 0, C), E = C.getAttribute("data-nodeid"), O = C.getAttribute("data-handleid"), k = C.classList.contains("connectable"), B = C.classList.contains("connectableend");
    if (!E || !z)
      return R;
    const V = {
      source: g ? E : l,
    ...
    R.isValid = Y && m(V), R.toHandle = zx(E, z, O, y, r, !0);
  }
  return R;
}
const Oh = {
  ...
  function u({ translateExtent: d, width: p, height: m, zoomStep: y = 1, pannable: g = !0, zoomable: v = !0, inversePan: x = !1 }) {
    const S = (E) => {
      if (E.sourceEvent.type !== "wheel" || !a)
        return;
      const O = r(), k = E.sourceEvent.ctrlKey && Zo() ? 10 : 1, B = -E.sourceEvent.deltaY * (E.sourceEvent.deltaMode === 1 ? 0.05 : E.sourceEvent.deltaMode ? 1 : 2e-3) * y, V = O[2] * Math.pow(2, B * k);
      a.scaleTo(V);
    };
    let N = [0, 0];
    const C = (E) => {
    ...
    }, z = ux().on("start", C).on("zoom", g ? R : null).on("zoom.wheel", v ? S : null);
    s.call(z, {});
  }
  function c() {
    s.on("zoom", null);
...
const Ec = (e) => ({
  ...
  y: e.y,
  zoom: e.k
}), Wd = ({ x: e, y: a, zoom: r }) => xc.translate(e, a).scale(r), ml = (e, a) => e.target.closest(`.${a}`), Hx = (e, a) => a === 2 && Array.isArray(e) && e.includes(2), aD = (e) => ((e *= 2) <= 1 ? e * e * e : (e -= 2) * e * e + 2) / 2, eh = (e, a = 0, r = aD, l = () => {
}) => {
...
function iD({ zoomPanValues: e, noWheelClassName: a, d3Selection: r, d3Zoom: l, panOnScrollMode: s, panOnScrollSpeed: u, zoomOnPinch: c, onPanZoomStart: d, onPanZoom: p, onPanZoomEnd: m }) {
  return (y) => {
    ...
    if (y.ctrlKey && c) {
      const C = ya(y), R = kx(y), z = g * Math.pow(2, R);
      l.scaleTo(r, z, C, y);
      return;
    }
...
function oD({ zoomPanValues: e, panOnDrag: a, onPaneContextMenu: r, onTransformChange: l, onPanZoom: s }) {
  return (u) => {
    e.usedRightMouseButton = !!(r && Hx(a, e.mouseButton ?? 0)), u.sourceEvent?.sync || l([u.transform.x, u.transform.y, u.transform.k]), s && !u.sourceEvent?.internal && s?.(u.sourceEvent, Ec(u.transform));
  };
}
function sD({ zoomPanValues: e, panOnDrag: a, panOnScroll: r, onDraggingChange: l, onPanZoomEnd: s, onPaneContextMenu: u }) {
  return (c) => {
    if (!c.sourceEvent?.internal && (e.isZoomingOrPanning = !1, u && Hx(a, e.mouseButton ?? 0) && !e.usedRightMouseButton && c.sourceEvent && u(c.sourceEvent), e.usedRightMouseButton = !1, l(!1), s)) {
      const d = Ec(c.transform);
...
function uD({ zoomActivationKeyPressed: e, zoomOnScroll: a, zoomOnPinch: r, panOnDrag: l, panOnScroll: s, zoomOnDoubleClick: u, userSelectionActive: c, noWheelClassName: d, noPanClassName: p, lib: m, connectionInProgress: y }) {
  return (g) => {
...
function cD({ domNode: e, minZoom: a, maxZoom: r, translateExtent: l, viewport: s, onPanZoom: u, onPanZoomStart: c, onPanZoomEnd: d, onDraggingChange: p }) {
  const m = {
    ...
    isPanScrolling: !1
  }, y = e.getBoundingClientRect(), g = ux().scaleExtent([a, r]).translateExtent(l), v = In(e).call(g);
  z({
    x: s.x,
    y: s.y,
    zoom: El(s.zoom, a, r)
  ...
  async function N($, K) {
    return v ? new Promise((le) => {
      g?.interpolate(K?.interpolate === "linear" ? Ho : Yu).transform(eh(v, K?.duration, K?.ease, () => le(!0)), $);
    }) : !1;
  }
  ...
  async function z($, K, le) {
    const j = Wd($), I = g?.constrain()(j, K, le);
  ...
  function O($) {
    if (v) {
      const K = Wd($), le = v.property("__zoom");
      (le.k !== $.zoom || le.x !== $.x || le.y !== $.y) && g?.transform(v, K, null, { sync: !0 });
    }
  }
  function k() {
    const $ = v ? sx(v.node()) : { x: 0, y: 0, k: 1 };
    return { x: $.x, y: $.y, zoom: $.k };
  }
  async function B($, K) {
    return v ? new Promise((le) => {
      g?.interpolate(K?.interpolate === "linear" ? Ho : Yu).scaleTo(eh(v, K?.duration, K?.ease, () => le(!0)), $);
    }) : !1;
  }
  async function V($, K) {
    return v ? new Promise((le) => {
      g?.interpolate(K?.interpolate === "linear" ? Ho : Yu).scaleBy(eh(v, K?.duration, K?.ease, () => le(!0)), $);
    }) : !1;
  }
  function A($) {
    g?.scaleExtent($);
...
function dD(e, a, r, l, s, u, c, d) {
  ...
  Y = Y + (Y < 0 ? I : -I), A = A + (A < 0 ? j : -j), s && (v ? te > $ * V ? Y = (jv(p, m) ? -A : A) / V : A = (jv(p, m) ? -Y : Y) * V : y ? (Y = A / V, m = p) : (A = Y * V, p = m));
...
const Bx = { width: 0, height: 0, x: 0, y: 0 }, hD = {
  ...Bx,
  pointerX: 0,
  pointerY: 0,
  aspectRatio: 1
...
function pD({ domNode: e, nodeId: a, getStoreItems: r, onChange: l, onEnd: s }) {
  ...
  function d({ controlPosition: m, boundaries: y, keepAspectRatio: g, resizeDirection: v, onResizeStart: x, onResize: S, onResizeEnd: N, shouldResize: C }) {
    ...
    const te = Z1().on("start", ($) => {
      ...
      const { transform: K, snapGrid: le, snapToGrid: j, nodeOrigin: I } = r(), T = ko($.sourceEvent, {
        transform: K,
        snapGrid: le,
        snapToGrid: j,
        containerBounds: O
      ...
      if (!E)
        return;
      const { x: F, y: G, width: Z, height: D } = R, H = {}, P = E.origin ?? I, { width: ne, height: se, x: he, y: me } = dD(z, c.controlDirection, T, c.boundaries, c.keepAspectRatio, P, V, A), ee = ne !== Z, ge = se !== D, ze = he !== F && ee, Re = me !== G && ge;
      if (!ze && !Re && !ee && !ge)
        return;
...
var th = { exports: {} }, nh = {}, ah = { exports: {} }, ih = {};
/**
 * @license React
...
function gD() {
  ...
  return ih.useSyncExternalStore = e.useSyncExternalStore !== void 0 ? e.useSyncExternalStore : y, ih;
}
var Hv;
function Ux() {
  return Hv || (Hv = 1, ah.exports = gD()), ah.exports;
}
/**
 * @license React
...
function yD() {
  ...
  return nh.useSyncExternalStoreWithSelector = function(m, y, g, v, x) {
    var S = u(null);
    if (S.current === null) {
...
var Bv;
function vD() {
  return Bv || (Bv = 1, th.exports = yD()), th.exports;
}
var bD = vD();
const xD = /* @__PURE__ */ Qh(bD), wD = {}, Uv = (e) => {
  let a;
  ...
  return p;
}, SD = (e) => e ? Uv(e) : Uv, { useDebugValue: ED } = ye, { useSyncExternalStoreWithSelector: _D } = xD, ND = (e) => e;
function Vx(e, a = ND, r) {
  const l = _D(
    e.subscribe,
    e.getState,
...
var RD = Qb();
const TD = /* @__PURE__ */ Qh(RD), _c = _.createContext(null), MD = _c.Provider, qx = wa.error001("react");
function lt(e, a) {
  const r = _.useContext(_c);
  if (r === null)
    throw new Error(qx);
  return Vx(r, e, a);
}
function zt() {
  const e = _.useContext(_c);
  if (e === null)
    throw new Error(qx);
  return _.useMemo(() => ({
    getState: e.getState,
...
const qv = { display: "none" }, DD = {
  ...
  clipPath: "inset(100%)"
}, $x = "react-flow__node-desc", Yx = "react-flow__edge-desc", AD = "react-flow__aria-live", zD = (e) => e.ariaLiveMessage, OD = (e) => e.ariaLabelConfig;
function jD({ rfId: e }) {
  const a = lt(zD);
  return b.jsx("div", { id: `${AD}-${e}`, "aria-live": "assertive", "aria-atomic": "true", style: DD, children: a });
}
function LD({ rfId: e, disableKeyboardA11y: a }) {
  const r = lt(OD);
  return b.jsxs(b.Fragment, { children: [b.jsx("div", { id: `${$x}-${e}`, style: qv, children: a ? r["node.a11yDescription.default"] : r["node.a11yDescription.keyboardDisabled"] }), b.jsx("div", { id: `${Yx}-${e}`, style: qv, children: r["edge.a11yDescription.default"] }), !a && b.jsx(jD, { rfId: e })] });
}
const Nc = _.forwardRef(({ position: e = "top-left", children: a, className: r, style: l, ...s }, u) => {
  const c = `${e}`.split("-");
...
function HD({ proOptions: e, position: a = "bottom-right" }) {
  return e?.hideAttribution ? null : b.jsx(Nc, { position: a, className: "react-flow__attribution", "data-message": "Please only hide this attribution when you are subscribed to React Flow Pro: https://pro.reactflow.dev", children: b.jsx("a", { href: "https://reactflow.dev", target: "_blank", rel: "noopener noreferrer", "aria-label": "React Flow attribution", children: "React Flow" }) });
}
const kD = (e) => {
  const a = [], r = [];
...
function UD({ onSelectionChange: e }) {
  const a = zt(), { selectedNodes: r, selectedEdges: l } = lt(kD, BD);
  return _.useEffect(() => {
...
function qD({ onSelectionChange: e }) {
  const a = lt(VD);
  return e || a ? b.jsx(UD, { onSelectionChange: e }) : null;
}
const Ix = [0, 0], $D = { x: 0, y: 0, zoom: 1 }, YD = [
  "nodes",
  "edges",
  "defaultNodes",
  "defaultEdges",
...
function GD(e) {
  const { setNodes: a, setEdges: r, setMinZoom: l, setMaxZoom: s, setTranslateExtent: u, setNodeExtent: c, reset: d, setDefaultNodesAndEdges: p } = lt(ID, At), m = zt();
  ...
  return _.useEffect(
    () => {
      for (const g of $v) {
        ...
        v !== x && (typeof e[g] > "u" || (g === "nodes" ? a(v) : g === "edges" ? r(v) : g === "minZoom" ? l(v) : g === "maxZoom" ? s(v) : g === "translateExtent" ? u(v) : g === "nodeExtent" ? c(v) : g === "ariaLabelConfig" ? m.setState({ ariaLabelConfig: TM(v) }) : g === "fitView" ? m.setState({ fitViewQueued: v }) : g === "fitViewOptions" ? m.setState({ fitViewOptions: v }) : m.setState({ [g]: v })));
      }
      y.current = e;
    },
...
function XD(e) {
  ...
  return _.useEffect(() => {
    ...
    const l = Iv(), s = () => r(l?.matches ? "dark" : "light");
    return s(), l?.addEventListener("change", s), () => {
      l?.removeEventListener("change", s);
    };
  }, [e]), a !== null ? a : Iv()?.matches ? "dark" : "light";
}
const Gv = typeof document < "u" ? document : null;
function Qo(e = null, a = { target: Gv, actInsideInputWithModifier: !0 }) {
...
`)), y = m.reduce((g, v) => g.concat(...v), []);
  ...
  return _.useEffect(() => {
    const p = a?.target ?? Gv, m = a?.actInsideInputWithModifier ?? !0;
    if (e !== null) {
      const y = (x) => {
        if (s.current = x.ctrlKey || x.metaKey || x.shiftKey || x.altKey, (!s.current || s.current && !m) && Sx(x))
          return !1;
        const N = Fv(x.code, d);
        if (u.current.add(x[N]), Xv(c, u.current, !1)) {
          const C = x.composedPath?.()?.[0] || x.target, R = C?.nodeName === "BUTTON" || C?.nodeName === "A";
          a.preventDefault !== !1 && (s.current || !R) && x.preventDefault(), l(!0);
        }
      }, g = (x) => {
        const S = Fv(x.code, d);
        Xv(c, u.current, !0) ? (l(!1), u.current.clear()) : u.current.delete(x[S]), x.key === "Meta" && u.current.clear(), s.current = !1;
      }, v = () => {
        u.current.clear(), l(!1);
      };
...
const FD = () => {
  ...
  return _.useMemo(() => ({
    ...
    fitBounds: async (a, r) => {
      const { width: l, height: s, minZoom: u, maxZoom: c, panZoom: d } = e.getState(), p = bm(a, l, s, u, c, r?.padding ?? 0.1);
...
const Pv = (e) => bM(e), WD = (e) => mx(e);
function Xx(e) {
  return _.forwardRef(e);
}
const eA = typeof window < "u" ? _.useLayoutEffect : _.useEffect;
function Kv(e) {
  const [a, r] = _.useState(BigInt(0)), [l] = _.useState(() => tA(() => r((s) => s + BigInt(1))));
  return eA(() => {
    const s = l.get();
...
function nA({ children: e }) {
  ...
  }, []), u = Kv(s), c = _.useMemo(() => ({ nodeQueue: l, edgeQueue: u }), []);
  return b.jsx(Fx.Provider, { value: c, children: e });
}
function aA() {
  const e = _.useContext(Fx);
  if (!e)
    throw new Error("useBatchContext must be used within a BatchProvider");
  return e;
}
const iA = (e) => !!e.panZoom;
function Cm() {
  const e = FD(), a = zt(), r = aA(), l = lt(iA), s = _.useMemo(() => {
    const u = (g) => a.getState().nodeLookup.get(g), c = (g) => {
      r.nodeQueue.push(g);
    }, d = (g) => {
      r.edgeQueue.push(g);
    }, p = (g) => {
      const { nodeLookup: v, nodeOrigin: x } = a.getState(), S = Pv(g) ? g : v.get(g.id), N = S.parentId ? xx(S.position, S.measured, S.parentId, v, x) : S.position, C = {
        ...S,
        position: N,
    ...
    return {
      ...
      deleteElements: async ({ nodes: g = [], edges: v = [] }) => {
        const { nodes: x, edges: S, onNodesDelete: N, onEdgesDelete: C, triggerNodeChanges: R, triggerEdgeChanges: z, onDelete: E, onBeforeDelete: O } = a.getState(), { nodes: k, edges: B } = await _M({
          nodesToRemove: g,
          edgesToRemove: v,
          nodes: x,
          edges: S,
      ...
      getNodesBounds: (g) => {
        ...
        return xM(g, { nodeLookup: v, nodeOrigin: x });
      },
      ...
      fitView: async (g) => {
        const v = a.getState().fitViewResolver ?? RM();
...
const Jv = (e) => e.selected, rA = typeof window < "u" ? window : void 0;
function lA({ deleteKeyCode: e, multiSelectionKeyCode: a }) {
  const r = zt(), { deleteElements: l } = Cm(), s = Qo(e, { actInsideInputWithModifier: !1 }), u = Qo(a, { target: rA });
  _.useEffect(() => {
    if (s) {
      const { edges: c, nodes: d } = r.getState();
      l({ nodes: d.filter(Jv), edges: c.filter(Jv) }), r.setState({ nodesSelectionActive: !1 });
    }
  }, [s]), _.useEffect(() => {
...
function uA({ onPaneContextMenu: e, zoomOnScroll: a = !0, zoomOnPinch: r = !0, panOnScroll: l = !1, panOnScrollSpeed: s = 0.5, panOnScrollMode: u = wr.Free, zoomOnDoubleClick: c = !0, panOnDrag: d = !0, defaultViewport: p, translateExtent: m, minZoom: y, maxZoom: g, zoomActivationKeyCode: v, preventScrolling: x = !0, children: S, noWheelClassName: N, noPanClassName: C, onViewportChange: R, isControlledViewport: z, paneClickDistance: E, selectionOnDrag: O }) {
  ...
  return _.useEffect(() => {
    ...
    O,
    E
  ]), b.jsx("div", { className: "react-flow__renderer", ref: B, style: Cc, children: S });
}
const cA = (e) => ({
  userSelectionActive: e.userSelectionActive,
...
function fA() {
  const { userSelectionActive: e, userSelectionRect: a } = lt(cA, At);
...
function hA({ isSelecting: e, selectionKeyPressed: a, selectionMode: r = Xo.Full, panOnDrag: l, autoPanOnSelection: s, paneClickDistance: u, selectionOnDrag: c, onSelectionStart: d, onSelectionEnd: p, onPaneClick: m, onPaneContextMenu: y, onPaneScroll: g, onPaneMouseEnter: v, onPaneMouseMove: x, onPaneMouseLeave: S, children: N }) {
  const C = _.useRef(0), R = zt(), { userSelectionActive: z, elementsSelectable: E, dragging: O, connectionInProgress: k, panBy: B, autoPanSpeed: V } = lt(dA, At), A = E && (e || z), Y = _.useRef(null), te = _.useRef(), $ = _.useRef(/* @__PURE__ */ new Set()), K = _.useRef(/* @__PURE__ */ new Set()), le = _.useRef(!1), j = _.useRef({ x: 0, y: 0 }), I = _.useRef(!1), T = (ee) => {
    if (le.current || k) {
      le.current = !1;
      return;
    }
  ...
  function D(ee, ge) {
    ...
    $.current = new Set(ym(Se, St, Re, r === Xo.Partial, !0).map((gt) => gt.id)), K.current = /* @__PURE__ */ new Set();
  ...
  function H() {
    if (!s || !te.current)
      return;
    const [ee, ge] = vm(j.current, te.current, V);
    B({ x: ee, y: ge }).then((ze) => {
      if (!le.current || !ze) {
  ...
  return b.jsxs("div", { className: Qt(["react-flow__pane", { draggable: me, dragging: O, selection: e }]), onClick: A ? void 0 : rh(T, Y), onContextMenu: rh(L, Y), onWheel: rh(F, Y), onPointerEnter: A ? void 0 : v, onPointerMove: A ? ne : x, onPointerUp: A ? se : void 0, onPointerCancel: A ? he : void 0, onPointerDownCapture: A ? Z : void 0, onClickCapture: A ? G : void 0, onPointerLeave: S, ref: Y, style: Cc, children: [N, b.jsx(fA, {})] });
}
function jh({ id: e, store: a, unselect: r = !1, nodeRef: l }) {
...
function Zx({ nodeRef: e, disabled: a = !1, noDragClassName: r, handleSelector: l, nodeId: s, isSelectable: u, nodeClickDistance: c }) {
...
const mA = (e) => (a) => a.selected && (a.draggable || e && typeof a.draggable > "u");
function Qx() {
  const e = zt();
  return _.useCallback((r) => {
    const { nodeExtent: l, snapToGrid: s, snapGrid: u, nodesDraggable: c, onError: d, updateNodePositions: p, nodeLookup: m, nodeOrigin: y } = e.getState(), g = /* @__PURE__ */ new Map(), v = mA(c), x = s ? u[0] : 5, S = s ? u[1] : 5, N = r.direction.x * x * r.factor, C = r.direction.y * S * r.factor;
    for (const [, R] of m) {
      if (!v(R))
        continue;
      let z = {
      ...
      s && (z = ls(z, u));
      const { position: E, positionAbsolute: O } = px({
        nodeId: R.id,
        nextPosition: z,
        nodeLookup: m,
        nodeExtent: l,
...
const Rm = _.createContext(null), pA = Rm.Provider;
Rm.Consumer;
const Px = () => _.useContext(Rm), gA = (e) => ({
...
function vA({ type: e = "source", position: a = Ae.Top, isValidConnection: r, isConnectable: l = !0, isConnectableStart: s = !0, isConnectableEnd: u = !0, id: c, onConnect: d, children: p, className: m, onMouseDown: y, onTouchStart: g, ...v }, x) {
  const S = c || null, N = e === "target", C = zt(), R = Px(), { connectOnClick: z, noPanClassName: E, rfId: O } = lt(gA, At), { connectingFrom: k, connectingTo: B, clickConnecting: V, isPossibleEndHandle: A, connectionInProcess: Y, clickConnectionInProcess: te, valid: $ } = lt(yA(R, S, e), At);
  ...
  const K = (I) => {
    ...
    if (!R)
      return;
    const T = Ex(I.nativeEvent);
    if (s && (T && I.button === 0 || !T)) {
      const L = C.getState();
      Oh.onPointerDown(I.nativeEvent, {
    ...
    const se = wx(I.target), he = r || Z, { connection: me, isValid: ee } = Oh.isValid(I.nativeEvent, {
      handle: {
        nodeId: R,
        id: S,
        type: e
...
const Rl = _.memo(Xx(vA));
function bA({ data: e, isConnectable: a, sourcePosition: r = Ae.Bottom }) {
  return b.jsxs(b.Fragment, { children: [e?.label, b.jsx(Rl, { type: "source", position: r, isConnectable: a })] });
}
function xA({ data: e, isConnectable: a, targetPosition: r = Ae.Top, sourcePosition: l = Ae.Bottom }) {
...
function SA({ data: e, isConnectable: a, targetPosition: r = Ae.Top }) {
...
function NA({ onSelectionContextMenu: e, noPanClassName: a, disableKeyboardA11y: r }) {
  const l = zt(), { width: s, height: u, transformString: c, userSelectionActive: d } = lt(_A, At), p = Qx(), m = _.useRef(null);
  _.useEffect(() => {
    r || m.current?.focus({
      preventScroll: !0
    });
  ...
  const g = e ? (x) => {
    ...
    Object.prototype.hasOwnProperty.call(rc, x.key) && (x.preventDefault(), p({
      direction: rc[x.key],
...
const eb = typeof window < "u" ? window : void 0, CA = (e) => ({ nodesSelectionActive: e.nodesSelectionActive, userSelectionActive: e.userSelectionActive });
function Kx({ children: e, onPaneClick: a, onPaneMouseEnter: r, onPaneMouseMove: l, onPaneMouseLeave: s, onPaneContextMenu: u, onPaneScroll: c, paneClickDistance: d, deleteKeyCode: p, selectionKeyCode: m, selectionOnDrag: y, selectionMode: g, onSelectionStart: v, onSelectionEnd: x, multiSelectionKeyCode: S, panActivationKeyCode: N, zoomActivationKeyCode: C, elementsSelectable: R, zoomOnScroll: z, zoomOnPinch: E, panOnScroll: O, panOnScrollSpeed: k, panOnScrollMode: B, zoomOnDoubleClick: V, panOnDrag: A, autoPanOnSelection: Y, defaultViewport: te, translateExtent: $, minZoom: K, maxZoom: le, preventScrolling: j, onSelectionContextMenu: I, noWheelClassName: T, noPanClassName: L, disableKeyboardA11y: F, onViewportChange: G, isControlledViewport: Z }) {
  const { nodesSelectionActive: D, userSelectionActive: H } = lt(CA, At), P = Qo(m, { target: eb }), ne = Qo(N, { target: eb }), se = ne || A, he = ne || O, me = y && se !== !0, ee = P || H || me;
  return lA({ deleteKeyCode: p, multiSelectionKeyCode: S }), b.jsx(uA, { onPaneContextMenu: u, elementsSelectable: R, zoomOnScroll: z, zoomOnPinch: E, panOnScroll: he, panOnScrollSpeed: k, panOnScrollMode: B, zoomOnDoubleClick: V, panOnDrag: !P && se, defaultViewport: te, translateExtent: $, minZoom: K, maxZoom: le, zoomActivationKeyCode: C, preventScrolling: j, noWheelClassName: T, noPanClassName: L, onViewportChange: G, isControlledViewport: Z, paneClickDistance: d, selectionOnDrag: me, children: b.jsxs(hA, { onSelectionStart: v, onSelectionEnd: x, onPaneClick: a, onPaneMouseEnter: r, onPaneMouseMove: l, onPaneMouseLeave: s, onPaneContextMenu: u, onPaneScroll: c, panOnDrag: se, autoPanOnSelection: Y, isSelecting: !!ee, selectionMode: g, selectionKeyPressed: P, paneClickDistance: d, selectionOnDrag: me, children: [e, D && b.jsx(NA, { onSelectionContextMenu: I, noPanClassName: L, disableKeyboardA11y: F })] }) });
}
Kx.displayName = "FlowRenderer";
const RA = _.memo(Kx), TA = (e) => (a) => e ? ym(a.nodeLookup, { x: 0, y: 0, width: a.width, height: a.height }, a.transform, !0).map((r) => r.id) : Array.from(a.nodeLookup.keys());
function MA(e) {
  return lt(_.useCallback(TA(e), [e]), At);
}
const DA = (e) => e.updateNodeInternals;
function AA() {
  const e = lt(DA), [a] = _.useState(() => typeof ResizeObserver > "u" ? null : new ResizeObserver((r) => {
...
function zA({ node: e, nodeType: a, hasDimensions: r, resizeObserver: l }) {
...
function OA({ id: e, onClick: a, onMouseEnter: r, onMouseMove: l, onMouseLeave: s, onContextMenu: u, onDoubleClick: c, nodesDraggable: d, elementsSelectable: p, nodesConnectable: m, nodesFocusable: y, resizeObserver: g, noDragClassName: v, noPanClassName: x, disableKeyboardA11y: S, rfId: N, nodeTypes: C, nodeClickDistance: R, onError: z }) {
  ...
  let B = E.type || "default", V = C?.[B] || Wv[B];
  V === void 0 && (z?.("003", wa.error003(B)), B = "default", V = C?.default || Wv.default);
  const A = !!(E.draggable || d && typeof E.draggable > "u"), Y = !!(E.selectable || p && typeof E.selectable > "u"), te = !!(E.connectable || m && typeof E.connectable > "u"), $ = !!(E.focusable || y && typeof E.focusable > "u"), K = zt(), le = bx(E), j = zA({ node: E, nodeType: B, hasDimensions: le, resizeObserver: g }), I = Zx({
    nodeRef: j,
    disabled: E.hidden || !A,
    noDragClassName: v,
  ...
  if (E.hidden)
    return null;
  const L = hi(E), F = EA(E), G = Y || A || a || r || l || s, Z = r ? (ee) => r(ee, { ...O.userNode }) : void 0, D = l ? (ee) => l(ee, { ...O.userNode }) : void 0, H = s ? (ee) => s(ee, { ...O.userNode }) : void 0, P = u ? (ee) => u(ee, { ...O.userNode }) : void 0, ne = c ? (ee) => c(ee, { ...O.userNode }) : void 0, se = (ee) => {
    ...
    if (!(Sx(ee.nativeEvent) || S)) {
      if (cx.includes(ee.key) && Y) {
      ...
      } else if (A && E.selected && Object.prototype.hasOwnProperty.call(rc, ee.key)) {
        ee.preventDefault();
    ...
    if (!Re)
      return;
    ym(/* @__PURE__ */ new Map([[e, E]]), { x: 0, y: 0, width: ge, height: ze }, ee, !0).length > 0 || Se(E.position.x + L.width / 2, E.position.y + L.height / 2, {
      zoom: ee[2]
    });
  };
...
function Jx(e) {
  const { nodesDraggable: a, nodesConnectable: r, nodesFocusable: l, elementsSelectable: s, onError: u } = lt(LA, At), c = MA(e.onlyRenderVisibleElements), d = AA();
  return b.jsx("div", { className: "react-flow__nodes", style: Cc, children: c.map((p) => (
    /*
...
function VA(e) {
  const a = zt();
  return _.useMemo(() => Object.prototype.hasOwnProperty.call(tb, e) ? tb[e] : (a.getState().onError?.("009", wa.error009(e)), null), [e]);
}
const qA = ({ id: e, type: a, color: r, width: l = 12.5, height: s = 12.5, markerUnits: u = "strokeWidth", strokeWidth: c, orient: d = "auto-start-reverse" }) => {
  const p = VA(a);
...
}, Wx = ({ defaultColor: e, rfId: a }) => {
  const r = lt((u) => u.edges), l = lt((u) => u.defaultEdgeOptions), s = _.useMemo(() => UM(r, {
    id: a,
    defaultColor: e,
    defaultMarkerStart: l?.markerStart,
    defaultMarkerEnd: l?.markerEnd
  }), [r, l, a, e]);
  return s.length ? b.jsx("svg", { className: "react-flow__marker", "aria-hidden": "true", children: b.jsx("defs", { children: s.map((u) => b.jsx(qA, { id: u.id, type: u.type, color: u.color, width: u.width, height: u.height, markerUnits: u.markerUnits, strokeWidth: u.strokeWidth, orient: u.orient }, u.id)) }) }) : null;
};
Wx.displayName = "MarkerDefinitions";
var $A = _.memo(Wx);
function ew({ x: e, y: a, label: r, labelStyle: l, labelShowBg: s = !0, labelBgStyle: u, labelBgPadding: c = [2, 4], labelBgBorderRadius: d = 2, children: p, className: m, ...y }) {
...
ew.displayName = "EdgeText";
const YA = _.memo(ew);
function Rc({ path: e, labelX: a, labelY: r, label: l, labelStyle: s, labelShowBg: u, labelBgStyle: c, labelBgPadding: d, labelBgBorderRadius: p, interactionWidth: m = 20, ...y }) {
  return b.jsxs(b.Fragment, { children: [b.jsx("path", { ...y, d: e, fill: "none", className: Qt(["react-flow__edge-path", y.className]) }), m ? b.jsx("path", { d: e, fill: "none", strokeOpacity: 0, strokeWidth: m, className: "react-flow__edge-interaction" }) : null, l && ba(a) && ba(r) ? b.jsx(YA, { x: a, y: r, label: l, labelStyle: s, labelShowBg: u, labelBgStyle: c, labelBgPadding: d, labelBgBorderRadius: p }) : null] });
}
function nb({ pos: e, x1: a, y1: r, x2: l, y2: s }) {
  return e === Ae.Left || e === Ae.Right ? [0.5 * (a + l), r] : [a, 0.5 * (r + s)];
}
function tw({ sourceX: e, sourceY: a, sourcePosition: r = Ae.Bottom, targetX: l, targetY: s, targetPosition: u = Ae.Top }) {
  const [c, d] = nb({
    pos: r,
    x1: e,
    y1: a,
...
function nw(e) {
  return _.memo(({ id: a, sourceX: r, sourceY: l, targetX: s, targetY: u, sourcePosition: c, targetPosition: d, label: p, labelStyle: m, labelShowBg: y, labelBgStyle: g, labelBgPadding: v, labelBgBorderRadius: x, style: S, markerEnd: N, markerStart: C, interactionWidth: R }) => {
    ...
    return b.jsx(Rc, { id: k, path: z, labelX: E, labelY: O, label: p, labelStyle: m, labelShowBg: y, labelBgStyle: g, labelBgPadding: v, labelBgBorderRadius: x, style: S, markerEnd: N, markerStart: C, interactionWidth: R });
  });
}
const IA = nw({ isInternal: !1 }), aw = nw({ isInternal: !0 });
IA.displayName = "SimpleBezierEdge";
aw.displayName = "SimpleBezierEdgeInternal";
function iw(e) {
  return _.memo(({ id: a, sourceX: r, sourceY: l, targetX: s, targetY: u, label: c, labelStyle: d, labelShowBg: p, labelBgStyle: m, labelBgPadding: y, labelBgBorderRadius: g, style: v, sourcePosition: x = Ae.Bottom, targetPosition: S = Ae.Top, markerEnd: N, markerStart: C, pathOptions: R, interactionWidth: z }) => {
    ...
    return b.jsx(Rc, { id: B, path: E, labelX: O, labelY: k, label: c, labelStyle: d, labelShowBg: p, labelBgStyle: m, labelBgPadding: y, labelBgBorderRadius: g, style: v, markerEnd: N, markerStart: C, interactionWidth: z });
  });
}
const rw = iw({ isInternal: !1 }), lw = iw({ isInternal: !0 });
rw.displayName = "SmoothStepEdge";
lw.displayName = "SmoothStepEdgeInternal";
function ow(e) {
  return _.memo(({ id: a, ...r }) => {
    const l = e.isInternal ? void 0 : a;
    return b.jsx(rw, { ...r, id: l, pathOptions: _.useMemo(() => ({ borderRadius: 0, offset: r.pathOptions?.offset }), [r.pathOptions?.offset]) });
  });
}
const GA = ow({ isInternal: !1 }), sw = ow({ isInternal: !0 });
GA.displayName = "StepEdge";
sw.displayName = "StepEdgeInternal";
function uw(e) {
  return _.memo(({ id: a, sourceX: r, sourceY: l, targetX: s, targetY: u, label: c, labelStyle: d, labelShowBg: p, labelBgStyle: m, labelBgPadding: y, labelBgBorderRadius: g, style: v, markerEnd: x, markerStart: S, interactionWidth: N }) => {
    const [C, R, z] = Rx({ sourceX: r, sourceY: l, targetX: s, targetY: u }), E = e.isInternal ? void 0 : a;
    return b.jsx(Rc, { id: E, path: C, labelX: R, labelY: z, label: c, labelStyle: d, labelShowBg: p, labelBgStyle: m, labelBgPadding: y, labelBgBorderRadius: g, style: v, markerEnd: x, markerStart: S, interactionWidth: N });
  });
}
const XA = uw({ isInternal: !1 }), cw = uw({ isInternal: !0 });
XA.displayName = "StraightEdge";
cw.displayName = "StraightEdgeInternal";
function fw(e) {
  return _.memo(({ id: a, sourceX: r, sourceY: l, targetX: s, targetY: u, sourcePosition: c = Ae.Bottom, targetPosition: d = Ae.Top, label: p, labelStyle: m, labelShowBg: y, labelBgStyle: g, labelBgPadding: v, labelBgBorderRadius: x, style: S, markerEnd: N, markerStart: C, pathOptions: R, interactionWidth: z }) => {
    ...
    return b.jsx(Rc, { id: B, path: E, labelX: O, labelY: k, label: p, labelStyle: m, labelShowBg: y, labelBgStyle: g, labelBgPadding: v, labelBgBorderRadius: x, style: S, markerEnd: N, markerStart: C, interactionWidth: z });
  });
}
const FA = fw({ isInternal: !1 }), dw = fw({ isInternal: !0 });
FA.displayName = "BezierEdge";
dw.displayName = "BezierEdgeInternal";
const ab = {
  default: dw,
  straight: cw,
  step: sw,
  ...
  sourcePosition: null,
  targetPosition: null
}, ZA = (e, a, r) => r === Ae.Left ? e - a : r === Ae.Right ? e + a : e, QA = (e, a, r) => r === Ae.Top ? e - a : r === Ae.Bottom ? e + a : e, rb = "react-flow__edgeupdater";
function lb({ position: e, centerX: a, centerY: r, radius: l = 10, onMouseDown: s, onMouseEnter: u, onMouseOut: c, type: d }) {
  return b.jsx("circle", { onMouseDown: s, onMouseEnter: u, onMouseOut: c, className: Qt([rb, `${rb}-${d}`]), cx: ZA(a, l, e), cy: QA(r, l, e), r: l, stroke: "transparent", fill: "transparent" });
}
function PA({ isReconnectable: e, reconnectRadius: a, edge: r, sourceX: l, sourceY: s, targetX: u, targetY: c, sourcePosition: d, targetPosition: p, onReconnect: m, onReconnectStart: y, onReconnectEnd: g, setReconnecting: v, setUpdateHover: x }) {
  const S = zt(), N = (O, k) => {
    if (O.button !== 0)
      return;
    ...
    Oh.onPointerDown(O.nativeEvent, {
      autoPanOnConnect: B,
      connectionMode: A,
      connectionRadius: Y,
      domNode: V,
  ...
  return b.jsxs(b.Fragment, { children: [(e === !0 || e === "source") && b.jsx(lb, { position: d, centerX: l, centerY: s, radius: a, onMouseDown: C, onMouseEnter: z, onMouseOut: E, type: "source" }), (e === !0 || e === "target") && b.jsx(lb, { position: p, centerX: u, centerY: c, radius: a, onMouseDown: R, onMouseEnter: z, onMouseOut: E, type: "target" })] });
}
function KA({ id: e, edgesFocusable: a, edgesReconnectable: r, elementsSelectable: l, onClick: s, onDoubleClick: u, onContextMenu: c, onMouseEnter: d, onMouseMove: p, onMouseLeave: m, reconnectRadius: y, onReconnect: g, onReconnectStart: v, onReconnectEnd: x, rfId: S, edgeTypes: N, noPanClassName: C, onError: R, disableKeyboardA11y: z }) {
  let E = lt((Se) => Se.edgeLookup.get(e));
  const O = lt((Se) => Se.defaultEdgeOptions);
  E = O ? { ...O, ...E } : E;
  let k = E.type || "default", B = N?.[k] || ab[k];
  B === void 0 && (R?.("011", wa.error011(k)), k = "default", B = N?.default || ab.default);
  ...
  }, [E.source, E.target, E.sourceHandle, E.targetHandle, E.selected, E.zIndex]), At), P = _.useMemo(() => E.markerStart ? `url('#${Ah(E.markerStart, S)}')` : void 0, [E.markerStart, S]), ne = _.useMemo(() => E.markerEnd ? `url('#${Ah(E.markerEnd, S)}')` : void 0, [E.markerEnd, S]);
...
function hw({ defaultMarkerColor: e, onlyRenderVisibleElements: a, rfId: r, edgeTypes: l, noPanClassName: s, onReconnect: u, onEdgeContextMenu: c, onEdgeMouseEnter: d, onEdgeMouseMove: p, onEdgeMouseLeave: m, onEdgeClick: y, reconnectRadius: g, onEdgeDoubleClick: v, onReconnectStart: x, onReconnectEnd: S, disableKeyboardA11y: N }) {
  const { edgesFocusable: C, edgesReconnectable: R, elementsSelectable: z, onError: E } = lt(WA, At), O = kA(a);
  return b.jsxs("div", { className: "react-flow__edges", children: [b.jsx($A, { defaultColor: e, rfId: r }), O.map((k) => b.jsx(JA, { id: k, edgesFocusable: C, edgesReconnectable: R, elementsSelectable: z, noPanClassName: s, onReconnect: u, onContextMenu: c, onMouseEnter: d, onMouseMove: p, onMouseLeave: m, onClick: y, reconnectRadius: g, onDoubleClick: v, onReconnectStart: x, onReconnectEnd: S, rfId: r, onError: E, edgeTypes: l, disableKeyboardA11y: N }, k))] });
}
hw.displayName = "EdgeRenderer";
const e4 = _.memo(hw), t4 = (e) => `translate(${e.transform[0]}px,${e.transform[1]}px) scale(${e.transform[2]})`;
...
function c4({ containerStyle: e, style: a, type: r, component: l }) {
  const { nodesConnectable: s, width: u, height: c, isValid: d, inProgress: p } = lt(u4, At);
  return !(u && s && p) ? null : b.jsx("svg", { style: e, width: u, height: c, className: "react-flow__connectionline react-flow__container", children: b.jsx("g", { className: Qt(["react-flow__connection", hx(d)]), children: b.jsx(mw, { style: a, type: r, CustomComponent: l, isValid: d }) }) });
}
const mw = ({ style: e, type: a = Xi.Bezier, CustomComponent: r, isValid: l }) => {
  const { inProgress: s, from: u, fromNode: c, fromHandle: d, fromPosition: p, to: m, toNode: y, toHandle: g, toPosition: v, pointer: x } = s4();
  if (!s)
    return;
  if (r)
    return b.jsx(r, { connectionLineType: a, connectionLineStyle: e, fromNode: c, fromHandle: d, fromX: u.x, fromY: u.y, toX: m.x, toY: m.y, fromPosition: p, toPosition: v, connectionStatus: hx(l), toNode: y, toHandle: g, pointer: x });
  let S = "";
  const N = {
    sourceX: u.x,
    sourceY: u.y,
...
const h4 = _.memo(pw), m4 = vx(), sb = ({ nodes: e, edges: a, defaultNodes: r, defaultEdges: l, width: s, height: u, fitView: c, fitViewOptions: d, minZoom: p = 0.5, maxZoom: m = 2, nodeOrigin: y, nodeExtent: g, zIndexMode: v = "basic" } = {}) => {
  ...
  if (c && s && u) {
    ...
    }), { x: A, y: Y, zoom: te } = bm(V, s, u, p, m, d?.padding ?? 0.1);
    B = [A, Y, te];
  }
  return {
    rfId: "1",
...
}, p4 = ({ nodes: e, edges: a, defaultNodes: r, defaultEdges: l, width: s, height: u, fitView: c, fitViewOptions: d, minZoom: p, maxZoom: m, nodeOrigin: y, nodeExtent: g, zIndexMode: v }) => CD((x, S) => {
  async function N() {
  ...
  return {
    ...
    setNodes: (C) => {
      const { nodeLookup: R, parentLookup: z, nodeOrigin: E, elevateNodesOnSelect: O, fitViewQueued: k, zIndexMode: B, nodesSelectionActive: V } = S(), { nodesInitialized: A, hasSelectedNodes: Y } = zh(C, R, z, {
        nodeOrigin: E,
        nodeExtent: g,
    ...
    updateNodeInternals: (C) => {
      const { triggerNodeChanges: R, nodeLookup: z, parentLookup: E, domNode: O, nodeOrigin: k, nodeExtent: B, debug: V, fitViewQueued: A, zIndexMode: Y } = S(), { changes: te, updatedInternals: $ } = XM(C, z, E, O, k, B, Y);
      $ && ($M(z, E, { nodeOrigin: k, nodeExtent: B, zIndexMode: Y }), A ? (N(), x({ fitViewQueued: !1, fitViewOptions: void 0 })) : x({}), te?.length > 0 && (V && console.log("React Flow: trigger node changes", te), R?.(te)));
    },
    updateNodePositions: (C, R = !1) => {
      ...
      if (z.length > 0) {
        const { parentLookup: Y, nodeOrigin: te } = S(), $ = Nm(z, O, Y, te);
        E.push(...$);
      }
    ...
    setNodeExtent: (C) => {
      ...
      C[0][0] === B[0][0] && C[0][1] === B[0][1] && C[1][0] === B[1][0] && C[1][1] === B[1][1] || (zh(R, z, E, {
        nodeOrigin: O,
        nodeExtent: C,
    ...
    panBy: (C) => {
      ...
      return FM({ delta: C, panZoom: O, transform: R, translateExtent: k, width: z, height: E });
    },
...
function gw({ initialNodes: e, initialEdges: a, defaultNodes: r, defaultEdges: l, initialWidth: s, initialHeight: u, initialMinZoom: c, initialMaxZoom: d, initialFitViewOptions: p, fitView: m, nodeOrigin: y, nodeExtent: g, zIndexMode: v, children: x }) {
  const [S] = _.useState(() => p4({
    nodes: e,
    edges: a,
    defaultNodes: r,
    defaultEdges: l,
  ...
  return b.jsx(MD, { value: S, children: b.jsx(nA, { children: x }) });
}
function g4({ children: e, nodes: a, edges: r, defaultNodes: l, defaultEdges: s, width: u, height: c, fitView: d, fitViewOptions: p, minZoom: m, maxZoom: y, nodeOrigin: g, nodeExtent: v, zIndexMode: x }) {
  return _.useContext(_c) ? b.jsx(b.Fragment, { children: e }) : b.jsx(gw, { initialNodes: a, initialEdges: r, defaultNodes: l, defaultEdges: s, initialWidth: u, initialHeight: c, fitView: d, initialFitViewOptions: p, initialMinZoom: m, initialMaxZoom: y, nodeOrigin: g, nodeExtent: v, zIndexMode: x, children: e });
}
const y4 = {
  width: "100%",
  height: "100%",
...
function yw({
  ...
  const g = _.useRef(null), { transform: v, patternId: x } = lt(E4, At), S = l || S4[a], N = a === Ba.Dots, C = a === Ba.Cross, R = Array.isArray(r) ? r : [r, r], z = [R[0] * v[2] || 1, R[1] * v[2] || 1], E = S * v[2], O = Array.isArray(u) ? u : [u, u], k = C ? [E, E] : z, B = [
    O[0] * v[2] || 1 + k[0] / 2,
    O[1] * v[2] || 1 + k[1] / 2
  ], V = `${x}${e || ""}`;
  ...
  }, ref: g, "data-testid": "rf__background", children: [b.jsx("pattern", { id: V, x: v[0] % z[0], y: v[1] % z[1], width: z[0], height: z[1], patternUnits: "userSpaceOnUse", patternTransform: `translate(-${B[0]},-${B[1]})`, children: N ? b.jsx(w4, { radius: E / 2, className: y }) : b.jsx(x4, { dimensions: k, lineWidth: s, variant: a, className: y }) }), b.jsx("rect", { x: "0", y: "0", width: "100%", height: "100%", fill: `url(#${V})` })] });
}
yw.displayName = "Background";
const ub = _.memo(yw);
function _4() {
...
function vw({ style: e, showZoom: a = !0, showFitView: r = !0, showInteractive: l = !0, fitViewOptions: s, onZoomIn: u, onZoomOut: c, onFitView: d, onInteractiveChange: p, className: m, children: y, position: g = "bottom-left", orientation: v = "vertical", "aria-label": x }) {
  const S = zt(), { isInteractive: N, minZoomReached: C, maxZoomReached: R, ariaLabelConfig: z } = lt(M4, At), { zoomIn: E, zoomOut: O, fitView: k } = Cm(), B = () => {
    E(), u?.();
  }, V = () => {
    O(), c?.();
  }, A = () => {
  ...
  return b.jsxs(Nc, { className: Qt(["react-flow__controls", te, m]), position: g, style: e, "data-testid": "rf__controls", "aria-label": x ?? z["controls.ariaLabel"], children: [a && b.jsxs(b.Fragment, { children: [b.jsx(Tu, { onClick: B, className: "react-flow__controls-zoomin", title: z["controls.zoomIn.ariaLabel"], "aria-label": z["controls.zoomIn.ariaLabel"], disabled: R, children: b.jsx(_4, {}) }), b.jsx(Tu, { onClick: V, className: "react-flow__controls-zoomout", title: z["controls.zoomOut.ariaLabel"], "aria-label": z["controls.zoomOut.ariaLabel"], disabled: C, children: b.jsx(N4, {}) })] }), r && b.jsx(Tu, { className: "react-flow__controls-fitview", onClick: A, title: z["controls.fitView.ariaLabel"], "aria-label": z["controls.fitView.ariaLabel"], children: b.jsx(C4, {}) }), l && b.jsx(Tu, { className: "react-flow__controls-interactive", onClick: Y, title: z["controls.interactive.ariaLabel"], "aria-label": z["controls.interactive.ariaLabel"], children: N ? b.jsx(T4, {}) : b.jsx(R4, {}) }), y] });
}
vw.displayName = "Controls";
const D4 = _.memo(vw);
function A4({ id: e, x: a, y: r, width: l, height: s, style: u, color: c, strokeColor: d, strokeWidth: p, className: m, borderRadius: y, shapeRendering: g, selected: v, onClick: x }) {
...
const z4 = _.memo(A4), O4 = (e) => e.nodes.map((a) => a.id), lh = (e) => e instanceof Function ? e : () => e;
function j4({
  nodeStrokeColor: e,
  nodeColor: a,
  nodeClassName: r = "",
  ...
  const d = lt(O4, At), p = lh(a), m = lh(e), y = lh(r), g = typeof window > "u" || window.chrome ? "crispEdges" : "geometricPrecision";
  return b.jsx(b.Fragment, { children: d.map((v) => (
     ...
     */
    b.jsx(H4, { id: v, nodeColorFunc: p, nodeStrokeColorFunc: m, nodeClassNameFunc: y, nodeBorderRadius: l, nodeStrokeWidth: s, NodeComponent: u, onClick: c, shapeRendering: g }, v)
  )) });
}
function L4({ id: e, nodeColorFunc: a, nodeStrokeColorFunc: r, nodeClassNameFunc: l, nodeBorderRadius: s, nodeStrokeWidth: u, shapeRendering: c, NodeComponent: d, onClick: p }) {
  ...
  return !m || m.hidden || !bx(m) ? null : b.jsx(d, { x: y, y: g, width: v, height: x, style: m.style, selected: !!m.selected, className: l(m), color: a(m), borderRadius: s, strokeColor: r(m), strokeWidth: u, shapeRendering: c, onClick: p, id: m.id });
}
const H4 = _.memo(L4);
var k4 = _.memo(j4);
const B4 = 200, U4 = 150, V4 = (e) => !e.hidden, q4 = (e) => {
  const a = {
  ...
  return {
    viewBB: a,
    boundingRect: e.nodeLookup.size > 0 ? yx(rs(e.nodeLookup, { filter: V4 }), a) : a,
    rfId: e.rfId,
    panZoom: e.panZoom,
...
function bw({
  ...
  const k = zt(), B = _.useRef(null), { boundingRect: V, viewBB: A, rfId: Y, panZoom: te, translateExtent: $, flowWidth: K, flowHeight: le, ariaLabelConfig: j } = lt(q4, At), I = e?.width ?? B4, T = e?.height ?? U4, L = V.width / I, F = V.height / T, G = Math.max(L, F), Z = G * I, D = G * T, H = O * G, P = V.x - (Z - V.width) / 2 - H, ne = V.y - (D - V.height) / 2 - H, se = Z + H * 2, he = D + H * 2, me = `${$4}-${Y}`, ee = _.useRef(0), ge = _.useRef();
  ee.current = G, _.useEffect(() => {
    if (B.current && te)
      return ge.current = nD({
        domNode: B.current,
        panZoom: te,
  ...
  return b.jsx(Nc, { position: v, style: {
    ...e,
  ...
  }, className: Qt(["react-flow__minimap", a]), "data-testid": "rf__minimap", children: b.jsxs("svg", { width: I, height: T, viewBox: `${P} ${ne} ${se} ${he}`, className: "react-flow__minimap-svg", role: "img", "aria-labelledby": me, ref: B, onClick: ze, children: [Se && b.jsx("title", { id: me, children: Se }), b.jsx(k4, { onClick: Re, nodeColor: l, nodeStrokeColor: r, nodeBorderRadius: u, nodeClassName: s, nodeStrokeWidth: c, nodeComponent: d }), b.jsx("path", { className: "react-flow__minimap-mask", d: `M${P - H},${ne - H}h${se + H * 2}v${he + H * 2}h${-se - H * 2}z
        M${A.x},${A.y}h${A.width}v${A.height}h${-A.width}z`, fillRule: "evenodd", pointerEvents: "none" })] }) });
}
bw.displayName = "MiniMap";
const Y4 = _.memo(bw), I4 = (e) => (a) => e ? `${Math.max(1 / a.transform[2], 1)}` : void 0, G4 = {
  [Cl.Line]: "right",
  [Cl.Handle]: "bottom-right"
};
function X4({ nodeId: e, position: a, variant: r = Cl.Handle, className: l, style: s = void 0, children: u, color: c, minWidth: d = 10, minHeight: p = 10, maxWidth: m = Number.MAX_VALUE, maxHeight: y = Number.MAX_VALUE, keepAspectRatio: g = !1, resizeDirection: v, autoScale: x = !0, shouldResize: S, onResizeStart: N, onResize: C, onResizeEnd: R }) {
  const z = Px(), E = typeof e == "string" ? e : z, O = zt(), k = _.useRef(null), B = r === Cl.Handle, V = lt(_.useCallback(I4(B && x), [B, x]), At), A = _.useRef(null), Y = a ?? G4[r];
  _.useEffect(() => {
    if (!(!k.current || !E))
...
_.memo(X4);
var F4 = "_1bllf8b0", Z4 = "_1bllf8b1";
const cb = 16, Q4 = "rgba(186, 158, 255, 0.14)", P4 = "rgba(186, 158, 255, 0.06)", K4 = "rgba(0, 0, 0, 0.6)", J4 = "#1d2023", W4 = "#ba9eff";
function e3({
  nodes: e,
  edges: a,
  nodeTypes: r,
  ...
  const y = [F4, c].filter(Boolean).join(" ");
  return /* @__PURE__ */ b.jsx("div", { className: y, "aria-label": d ?? "node graph", children: /* @__PURE__ */ b.jsxs(
    b4,
    {
      ...
      children: [
        ...
        s && /* @__PURE__ */ b.jsx(D4, { showInteractive: !1 }),
        l && /* @__PURE__ */ b.jsx(
          Y4,
          {
            pannable: !0,
...
function t3(e) {
  return /* @__PURE__ */ b.jsx(gw, { children: /* @__PURE__ */ b.jsx(e3, { ...e }) });
}
...
function Oa({
  ...
  return /* @__PURE__ */ b.jsxs("section", { className: c, children: [
    (e || r) && /* @__PURE__ */ b.jsxs("header", { className: r3, children: [
      /* @__PURE__ */ b.jsxs("div", { className: l3, children: [
        e && /* @__PURE__ */ b.jsx("span", { className: s3, children: e }),
        a && /* @__PURE__ */ b.jsx("span", { className: u3, children: a })
      ] }),
      r && /* @__PURE__ */ b.jsx("div", { className: o3, children: r })
    ] }),
    l
  ] });
}
...
function h3(e) {
  return { ...e, phase: "cancelled", stageStates: Mm() };
}
const m3 = -32108;
function p3(e) {
  return {
...
const Sw = [10, 20, 30, 60, 120], E3 = "custom", oh = { framesPerClip: 85, fps: 16, overlap: 5 };
function Ml(e) {
  return {
    framesPerClip: e.frames_per_clip ?? oh.framesPerClip,
    fps: e.fps ?? oh.fps,
    overlap: e.num_overlap_frame ?? oh.overlap
  };
}
function Ew(e, a) {
...
const _3 = 5, Cw = 129, N3 = [2, 3, 4, 5, 6, 8];
function Rw(e) {
  const a = Math.round((e - 1) / 4) * 4 + 1;
  return Math.min(Cw, Math.max(_3, a));
}
function pb(e, a) {
  return Rw(e * a);
}
function C3(e) {
  return e <= 0 ? 0 : Math.floor(Cw / e);
}
function Tw(e) {
...
function R3(e) {
  const { framesPerClip: a, fps: r } = Ml(e), l = `1 × ${a} frames @ ${r} fps → ${Tw(e).toFixed(1)}s morph`, s = e.interpolate_fps ?? 0;
  return s > 0 ? `${l} (RIFE → ${s} fps)` : l;
}
function T3(e, a) {
  for (const r of Sw)
    if (Nw(r, a) === e) return r;
  return E3;
}
function M3(e) {
  const a = Ml(e), r = e.num_clips ?? 1, l = _w(r, a), s = `${r} × ${a.framesPerClip} frames @ ${a.fps} fps → ${l.toFixed(1)}s native`, u = e.interpolate_fps ?? 0;
  return u > 0 ? `${s} (RIFE → ${u} fps)` : s;
}
const Po = "svi-canonical", D3 = /* @__PURE__ */ new Set([
  "natural-reference-lowvram",
  "natural-rife48-lowvram",
  "forced-motion-24-lowvram",
  "flf2v-morph-lowvram",
  "chained-single-prompt-lowvram"
]), A3 = /* @__PURE__ */ new Set(["svi-canonical-704", "svi-canonical-640"]), z3 = /* @__PURE__ */ new Set(["flf2v-morph-lowvram"]);
function O3(e) {
  const a = e.frames_per_clip, r = e.num_clips, l = e.num_overlap_frame ?? 4;
  return !a || !r ? null : a + (r - 1) * (a - l);
}
function j3(e) {
  const a = e.params, r = a.width ?? 480, l = a.height ?? 832, s = `${r}×${l}`, u = O3(a), c = a.fps;
  let d = "—";
  u !== null && c && c > 0 && (d = `${(u / c).toFixed(1)}s`);
  const p = D3.has(e.id), m = a.blocks_to_swap ?? 0, y = m >= 40 ? "~10–11 GiB (16 GB)" : m > 0 ? "mid-VRAM" : "~26 GiB (high-VRAM)";
  return {
    resolution: s,
    duration: d,
    vram: y,
    isLowVram: p,
    isOffDistribution: A3.has(e.id),
    requiresLastImage: typeof a.requires_last_image == "boolean" ? a.requires_last_image : z3.has(e.id)
  };
}
function L3(e) {
...
function q3(e, a, r) {
  return jN(`/render/jobs/${e}/events`, a, r);
}
const $3 = 9e4, Y3 = 24e4, I3 = 5e3, Mw = _.createContext(null);
function G3({
  ...
  const [l, s] = _.useState(e), [u, c] = _.useState(
    ...
    enabled: !1,
    prompt: ""
  }), [R, z] = _.useState(lc), E = _.useRef(null), O = _.useRef(null), k = _.useCallback(() => {
    ...
    k(), O.current = setInterval(() => {
      z((Z) => {
        ...
        return D >= Y3 ? (E.current?.(), E.current = null, k(), p3(Z)) : D >= $3 ? fb(Z) : Z;
      });
    }, I3);
  }, [k]), V = _.useCallback(
    (Z) => {
    ...
    S(Z), y((H) => D === null || D.length === 0 ? { ...H, last_image_path: D } : {
      ...
      last_image_path: D,
      num_clips: 1,
      frames_per_clip: Rw(H.frames_per_clip ?? 81)
    });
  }, []), le = _.useCallback((Z) => {
    C((D) => ({ ...D, ...Z }));
  }, []), j = _.useCallback((Z) => {
    ...
    E.current?.(), E.current = null, k(), z(lc());
  }, [k]), T = _.useCallback(async () => {
    E.current?.();
    const { jobId: Z } = await U3({ presetId: u, params: m });
    z(f3(Z, N.enabled)), E.current = q3(
      Z,
      (D) => {
        z((H) => d3(H, D));
      },
    ...
    const Z = R.jobId;
    if (!Z) return;
    const { status: D } = await V3(Z);
    D !== "cancelling" && (E.current?.(), E.current = null, k(), z((H) => h3(H)));
  }, [R.jobId, k]), F = _.useCallback(
    async (Z) => {
      E.current?.(), E.current = null, k();
      try {
        const D = await B3(Z.id);
        z(db(D));
      } catch {
        z(db(Z));
      }
  ...
  return /* @__PURE__ */ b.jsx(Mw.Provider, { value: G, children: r });
}
function mn() {
  const e = _.useContext(Mw);
  if (!e)
...
}, Z3 = Array(12).fill(0), Q3 = ({ visible: e, className: a }) => /* @__PURE__ */ ye.createElement("div", {
  className: [
...
}, Z3.map((r, l) => /* @__PURE__ */ ye.createElement("div", {
...
class n5 {
  constructor() {
    this.subscribe = (a) => (this.subscribers.push(a), () => {
      ...
      var r;
      const { message: l, ...s } = a, u = typeof a?.id == "number" || ((r = a.id) == null ? void 0 : r.length) > 0 ? a.id : Lh++, c = this.toasts.find((p) => p.id === u), d = a.dismissible === void 0 ? !0 : a.dismissible;
...
}, i5 = (e) => e && typeof e == "object" && "ok" in e && typeof e.ok == "boolean" && "status" in e && typeof e.status == "number", r5 = a5, l5 = () => Dn.toasts, o5 = () => Dn.getActiveToasts(), br = Object.assign(r5, {
  success: Dn.success,
  info: Dn.info,
  warning: Dn.warning,
  error: Dn.error,
...
const s5 = 3, u5 = "24px", c5 = "16px", gb = 4e3, f5 = 356, d5 = 14, h5 = 45, m5 = 200;
function Aa(...e) {
...
const g5 = (e) => {
  ...
  const { invert: y, toast: g, unstyled: v, interacting: x, setHeights: S, visibleToasts: N, heights: C, index: R, toasts: z, expanded: E, removeToast: O, defaultRichColors: k, closeButton: B, style: V, cancelButtonStyle: A, actionButtonStyle: Y, className: te = "", descriptionClassName: $ = "", duration: K, position: le, gap: j, expandByDefault: I, classNames: T, icons: L, closeButtonAriaLabel: F = "Close toast" } = e, [G, Z] = ye.useState(null), [D, H] = ye.useState(null), [P, ne] = ye.useState(!1), [se, he] = ye.useState(!1), [me, ee] = ye.useState(!1), [ge, ze] = ye.useState(!1), [Re, Se] = ye.useState(!1), [xe, Ce] = ye.useState(0), [$e, ft] = ye.useState(0), Te = ye.useRef(g.duration || K || gb), Xe = ye.useRef(null), ke = ye.useRef(null), Ye = R === 0, St = R + 1 <= N, Je = g.type, Ze = g.dismissible !== !1, Qe = g.className || "", gt = g.descriptionClassName || "", yt = ye.useMemo(() => C.findIndex((He) => He.toastId === g.id) || 0, [
    ...
    C,
    yt
  ]), Ut = t5(), mi = g.invert || y, _a = Je === "loading";
  ...
  return /* @__PURE__ */ ye.createElement("li", {
    ...
    onPointerMove: (He) => {
      ...
      var ca;
      const Wt = (ca = e.swipeDirections) != null ? ca : p5(le);
  ...
  }, (un = L?.close) != null ? un : e5) : null, (Je || g.icon || g.promise) && g.icon !== null && (L?.[Je] !== null || g.icon) ? /* @__PURE__ */ ye.createElement("div", {
    "data-icon": "",
  ...
  }, typeof g.description == "function" ? g.description() : g.description) : null), /* @__PURE__ */ ye.isValidElement(g.cancel) ? g.cancel : g.cancel && Mu(g.cancel) ? /* @__PURE__ */ ye.createElement("button", {
    "data-button": !0,
    "data-cancel": !0,
    style: g.cancelButtonStyle || A,
    onClick: (He) => {
      Mu(g.cancel) && Ze && (g.cancel.onClick == null || g.cancel.onClick.call(g.cancel, He), wn());
    },
    className: Aa(T?.cancelButton, g == null || (p = g.classNames) == null ? void 0 : p.cancelButton)
  }, g.cancel.label) : null, /* @__PURE__ */ ye.isValidElement(g.action) ? g.action : g.action && Mu(g.action) ? /* @__PURE__ */ ye.createElement("button", {
    "data-button": !0,
    "data-action": !0,
    style: g.actionButtonStyle || Y,
    onClick: (He) => {
      Mu(g.action) && (g.action.onClick == null || g.action.onClick.call(g.action, He), !He.defaultPrevented && wn());
    },
...
function y5(e, a) {
  ...
  return [
    ...
    const u = s === 1, c = u ? "--mobile-offset" : "--offset", d = u ? c5 : u5;
    function p(m) {
      [
        "top",
        "right",
...
const v5 = /* @__PURE__ */ ye.forwardRef(function(a, r) {
  const { id: l, invert: s, position: u = "bottom-right", hotkey: c = [
    "altKey",
    "KeyT"
  ], expand: d, closeButton: p, className: m, offset: y, mobileOffset: g, theme: v = "light", richColors: x, duration: S, style: N, visibleToasts: C = s5, toastOptions: R, dir: z = yb(), gap: E = d5, icons: O, containerAriaLabel: k = "Notifications" } = a, [B, V] = ye.useState([]), A = ye.useMemo(() => l ? B.filter((P) => P.toasterId === l) : B.filter((P) => !P.toasterId), [
    B,
    l
  ...
  /* @__PURE__ */ ye.createElement("section", {
    ...
    return A.length ? /* @__PURE__ */ ye.createElement("ol", {
      ...
      var ze, Re;
      return /* @__PURE__ */ ye.createElement(g5, {
        key: ee.id,
        icons: O,
        index: ge,
        toast: ee,
...
}), Hh = "svi2-pro:trigger-render", kh = "svi2-pro:render-state";
function b5() {
  typeof window > "u" || window.dispatchEvent(new CustomEvent(Hh));
}
function x5(e) {
  typeof window > "u" || window.dispatchEvent(new CustomEvent(kh, { detail: e }));
}
function w5(e) {
  return typeof window > "u" ? () => {
  } : (window.addEventListener(Hh, e), () => window.removeEventListener(Hh, e));
}
function S5(e) {
  ...
  return window.addEventListener(kh, a), () => window.removeEventListener(kh, a);
}
const E5 = /* @__PURE__ */ new Set(["flf2v-morph-lowvram"]), _5 = 832 * 480, N5 = 0.85;
function Dm(e, a) {
  return a && typeof a.requires_last_image == "boolean" ? a.requires_last_image : e !== null && E5.has(e);
}
function Mc(e, a) {
  return Dm(e, a) ? !0 : typeof a.last_image_path == "string" && a.last_image_path.length > 0;
}
function vb(e, a) {
...
function C5(e, a) {
  ...
  return g !== void 0 && g < 1 && r.push({
    ...
    severity: "error"
  }), Dm(a.presetId, a.presetParams) && !a.hasLastImage && r.push({
    field: "last_image_path",
    message: "This preset (FLF2V morph) requires a last-image keyframe.",
    severity: "error"
  }), Mc(a.presetId, e) && g !== void 0 && g > 1 && r.push({
    field: "num_clips",
    ...
    severity: "error"
  }), Number.isFinite(d) && Number.isFinite(p) && d * p < _5 * N5 && r.push({
    field: "width",
...
function Dw() {
  const {
    ...
    [e, a, r, l]
  ), p = R5(d), m = s.phase === "running", [y, g] = _.useState(null), v = _.useCallback(async () => {
    if (p) {
    ...
    try {
      ...
      const N = S instanceof mc ? S.message : "Could not start the render.";
      br.error(N);
    }
  ...
  return _.useEffect(() => w5(() => void v()), [v]), _.useEffect(() => {
    x5({ busy: m, blocked: p });
...
var O5 = "dk8hba0", j5 = { idle: "dk8hba1", active: "dk8hba2", done: "dk8hba3", error: "dk8hba4" }, L5 = "dk8hba5", H5 = "dk8hba6", k5 = "dk8hba7", B5 = { idle: "dk8hba8", active: "dk8hba9", done: "dk8hbaa", error: "dk8hbab" }, U5 = "dk8hbac";
function V5({ data: e }) {
  const a = e, r = [O5, j5[a.state]].join(" "), l = [U5, B5[a.state]].join(" ");
  return /* @__PURE__ */ b.jsxs("div", { className: r, children: [
    a.hasInput && /* @__PURE__ */ b.jsx(Rl, { type: "target", position: Ae.Left }),
    /* @__PURE__ */ b.jsxs("div", { className: L5, children: [
      /* @__PURE__ */ b.jsx("span", { className: H5, children: a.title }),
      /* @__PURE__ */ b.jsx("span", { className: l, "aria-hidden": "true" })
    ] }),
    /* @__PURE__ */ b.jsx("span", { className: k5, children: a.subtitle }),
    a.hasOutput && /* @__PURE__ */ b.jsx(Rl, { type: "source", position: Ae.Right })
  ] });
}
const q5 = { pipeline: V5 };
var $5 = "_1g4g8kk0", Y5 = "_1g4g8kk1", I5 = "_1g4g8kk2", G5 = "_1g4g8kk3", X5 = "_1g4g8kk4", F5 = "_1g4g8kk5";
const Z5 = {
  idle: "neutral",
  active: "accent",
  done: "success",
...
function P5() {
  const { render: e, params: a, qwenEdit: r } = mn(), { busy: l, blocked: s, submit: u, cancel: c } = Dw(), d = _.useMemo(
    () => z5({ render: e, params: a, qwenEditEnabled: r.enabled }),
    [e, a, r.enabled]
  ), p = Tm.filter(
    (m) => m !== "qwen_edit" || r.enabled
  );
  return /* @__PURE__ */ b.jsxs("div", { className: $5, children: [
    /* @__PURE__ */ b.jsx("div", { className: Y5, children: /* @__PURE__ */ b.jsx(
      t3,
      {
        nodes: d.nodes,
        edges: d.edges,
    ...
    /* @__PURE__ */ b.jsx("div", { className: I5, children: /* @__PURE__ */ b.jsxs(
      Oa,
      {
        elevation: "raised",
        title: "Pipeline",
        ...
        children: [
          /* @__PURE__ */ b.jsx("div", { className: G5, children: p.map((m) => /* @__PURE__ */ b.jsxs("div", { className: X5, children: [
            /* @__PURE__ */ b.jsx("span", { children: Q5[m] }),
            /* @__PURE__ */ b.jsx(An, { tone: Z5[e.stageStates[m]], children: e.stageStates[m] })
          ] }, m)) }),
          /* @__PURE__ */ b.jsx("div", { className: F5, children: l ? /* @__PURE__ */ b.jsx(Ha, { variant: "danger", onClick: () => void c(), children: "Cancel render" }) : /* @__PURE__ */ b.jsx(Ha, { onClick: () => void u(), disabled: s, children: "Render" }) })
        ]
      }
    ) })
  ] });
...
function Bh(e, a) {
  ...
  if (e && a && (r = e.constructor) === a.constructor) {
    ...
    if (!r || typeof e == "object") {
      l = 0;
      for (r in e)
        if (wb.call(e, r) && ++l && !wb.call(a, r) || !(r in a) || !Bh(e[r], a[r])) return !1;
...
const si = /* @__PURE__ */ new WeakMap(), ci = () => {
  ...
  /*#__NOINLINE__*/
  ci()
), Uh = Object, nt = (e) => e === hn, La = (e) => typeof e == "function", Zi = (e, a) => ({
  ...e,
  ...a
}), jw = (e) => La(e.then), sh = {}, Du = {}, Am = "undefined", os = typeof window != Am, Vh = typeof document != Am, K5 = os && "Deno" in window, J5 = () => os && typeof window.requestAnimationFrame != Am, Lw = (e, a) => {
  const r = si.get(e);
  return [
    // Getter
    () => !nt(a) && e.get(a) || sh,
    ...
    (l) => {
      if (!nt(a)) {
        const s = e.get(a);
        a in Du || (Du[a] = s), r[5](a, Zi(s, l), s || sh);
      }
    },
    // Subscriber
    r[6],
    // Get server cache snapshot
    () => !nt(a) && a in Du ? Du[a] : !nt(a) && e.get(a) || sh
  ];
};
let qh = !0;
const W5 = () => qh, [$h, Yh] = os && window.addEventListener ? [
  ...
  const e = Vh && document.visibilityState;
  return nt(e) || e !== "hidden";
}, tz = (e) => (Vh && document.addEventListener("visibilitychange", e), $h("focus", e), () => {
  Vh && document.removeEventListener("visibilitychange", e), Yh("focus", e);
}), nz = (e) => {
  const a = () => {
    qh = !0, e();
  }, r = () => {
  ...
  return $h("online", a), $h("offline", r), () => {
    Yh("online", a), Yh("offline", r);
  };
}, az = {
  isOnline: W5,
  isVisible: ez
  ...
  initFocus: tz,
  initReconnect: nz
}, Sb = !ye.useId, bl = !os || K5, rz = (e) => J5() ? window.requestAnimationFrame(e) : setTimeout(e, 1), uh = bl ? _.useEffect : _.useLayoutEffect, ch = typeof navigator < "u" && navigator.connection, Eb = !bl && ch && ([
  "slow-2g",
  "2g"
].includes(ch.effectiveType) || ch.saveData), Au = /* @__PURE__ */ new WeakMap(), lz = (e) => Uh.prototype.toString.call(e), fh = (e, a) => e === `[object ${a}]`;
let oz = 0;
const Ih = (e) => {
  const a = typeof e, r = lz(e), l = fh(r, "Date"), s = fh(r, "RegExp"), u = fh(r, "Object");
  let c, d;
  if (Uh(e) === e && !l && !s) {
    if (c = Au.get(e), c) return c;
    if (c = ++oz + "~", Au.set(e, c), Array.isArray(e)) {
  ...
  const a = e;
  return e = typeof e == "string" ? e : (Array.isArray(e) ? e.length : e) ? Ih(e) : "", [
    e,
    a
  ];
};
...
async function Hw(...e) {
  ...
  async function g(v) {
    const [x] = zm(v);
    if (!x) return;
    const [S, N] = Lw(a, x), [C, R, z, E] = si.get(a), O = () => {
      const j = C[x];
      return (La(u.revalidate) ? u.revalidate(S().data, v) : u.revalidate !== !1) && (delete z[x], delete E[x], j && j[0]) ? j[0](Ow).then(() => S().data) : S().data;
    };
    if (e.length < 3)
      return O();
    let k = l, B, V = !1;
    ...
    if (R[x][1] = Gh(), Promise.resolve(O()).then(() => {
      N({
        _c: hn
      });
    }), V) {
...
const _b = (e, a) => {
  ...
  if (!si.has(e)) {
    const r = Zi(iz, a), l = /* @__PURE__ */ Object.create(null), s = Hw.bind(hn, e);
    let u = ci;
    const c = /* @__PURE__ */ Object.create(null), d = (y, g) => {
      ...
      if (!si.has(e) && (si.set(e, [
        ...
        const y = r.initFocus(setTimeout.bind(hn, _b.bind(hn, l, Aw))), g = r.initReconnect(setTimeout.bind(hn, _b.bind(hn, l, zw)));
        u = () => {
          y && y(), g && g(), si.delete(e);
        };
      }
...
}, fz = Bh, [kw, dz] = uz(/* @__PURE__ */ new Map()), hz = Zi(
  {
    // events
    onLoadingSlow: ci,
    onSuccess: ci,
    ...
    // timeouts
    errorRetryInterval: Eb ? 1e4 : 5e3,
    focusThrottleInterval: 5 * 1e3,
    dedupingInterval: 2 * 1e3,
    loadingTimeout: Eb ? 5e3 : 3e3,
    // providers
    compare: fz,
    isPaused: () => !1,
    cache: kw,
  ...
  return r;
}, pz = _.createContext({}), gz = "$inf$", Bw = os && window.__SWR_DEVTOOLS_USE__, yz = Bw ? window.__SWR_DEVTOOLS_USE__ : [], vz = () => {
  Bw && (window.__SWR_DEVTOOLS_REACT__ = ye);
}, bz = (e) => La(e[1]) ? [
  e[0],
  e[1],
  e[2] || {}
  ...
  const e = _.useContext(pz);
  return _.useMemo(() => Zi(hz, e), [
    e
  ]);
}, wz = (e) => (a, r, l) => e(a, r && ((...u) => {
  const [c] = zm(a), [, , , d] = si.get(kw);
  if (c.startsWith(gz))
    return r(...u);
  const p = d[c];
  return nt(p) ? r(...u) : (delete d[c], p);
}), l), Sz = yz.concat(wz), Ez = (e) => function(...r) {
  const l = xz(), [s, u, c] = bz(r), d = mz(l, c);
  let p = e;
  const { use: m } = d, y = (m || []).concat(Sz);
...
vz();
const dh = ye.use || // This extra generic is to avoid TypeScript mixing up the generic and JSX sytax
...
((e) => {
  ...
  dedupe: !0
}, Nb = Promise.resolve(hn), Nz = () => ci, Cz = (e, a, r) => {
  const { cache: l, compare: s, suspense: u, fallbackData: c, revalidateOnMount: d, revalidateIfStale: p, refreshInterval: m, refreshWhenHidden: y, refreshWhenOffline: g, keepPreviousData: v, strictServerPrefetchWarning: x } = r, [S, N, C, R] = si.get(l), [z, E] = zm(e), O = _.useRef(!1), k = _.useRef(!1), B = _.useRef(z), V = _.useRef(a), A = _.useRef(r), Y = () => A.current, te = () => Y().isVisible() && Y().isOnline(), [$, K, le, j] = Lw(l, z), I = _.useRef({}).current, T = nt(c) ? nt(r.fallback) ? hn : r.fallback[z] : c, L = (Te, Xe) => {
    for (const ke in I) {
      const Ye = ke;
      if (Ye === "data") {
    ...
    l,
    z
  ]), Z = bb.useSyncExternalStore(_.useCallback(
    (Te) => le(z, (Xe, ke) => {
      L(ke, Xe) || Te();
    }),
  ...
  ), G[0], G[1]), D = S[z] && S[z].length > 0, H = Z.data, P = nt(H) ? T && jw(T) ? dh(T) : T : H, ne = Z.error, se = _.useRef(P), he = v ? nt(H) ? nt(se.current) ? P : se.current : H : P, me = z && nt(P), ee = _.useRef(null);
  !bl && // getServerSnapshot is only called during hydration
  // eslint-disable-next-line react-hooks/rules-of-hooks
  bb.useSyncExternalStore(Nz, () => (ee.current = !1, ee), () => (ee.current = !0, ee));
  const ge = ee.current;
  ...
  const ze = !z || !a || Y().isPaused() || D && !nt(ne) ? !1 : F && !nt(d) ? d : u ? nt(P) ? !1 : p : nt(P) || p, Re = F && ze, Se = nt(Z.isValidating) ? Re : Z.isValidating, xe = nt(Z.isLoading) ? Re : Z.isLoading, Ce = _.useCallback(
    async (Te) => {
      ...
      if (!z || !Xe || k.current || Y().isPaused())
        return !1;
      let ke, Ye, St = !0;
      const Je = Te || {}, Ze = !C[z] || !Je.dedupe, Qe = () => Sb ? !k.current && z === B.current && O.current : z === B.current, gt = {
        isValidating: !1,
        isLoading: !1
      }, yt = () => {
        K(gt);
  ...
  if (uh(() => {
    ...
    function ke() {
      !$().error && (y || Y().isVisible()) && (g || Y().isOnline()) ? Ce(hh).then(Xe) : Xe();
    }
    return Xe(), () => {
    ...
    const Te = R[z], Xe = !nt(Te) && me ? $e(Te) : Nb;
    if (dh(Xe), !nt(ne) && me)
      throw ne;
    const ke = me ? Ce(hh) : Nb;
    !nt(he) && me && (ke.status = "fulfilled", ke.value = !0), dh(ke);
  }
  return {
    mutate: $e,
    get data() {
...
var Rz = "_1xasopc0", Tz = "_1xasopc1", Mz = "_1xasopc2", Dz = "_1xasopc3", Az = "_1xasopc4", zz = "_1xasopc5", Oz = "_1xasopc6", jz = "_1xasopc7", Lz = "_1xasopc8";
function Hz(e, a) {
...
function Cb({
  ...
  const y = _.useRef(null), g = _.useId(), v = _.useId(), [x, S] = _.useState(!1), [N, C] = _.useState(null), [R, z] = _.useState([]), E = _.useCallback(
    ($) => {
      if (!$ || $.length === 0) return;
      const K = Array.from($), le = r ? K : K.slice(0, 1), j = kz(le, e, a);
      if (j) {
        C(j);
        return;
      }
    ...
    /* @__PURE__ */ b.jsxs(
      "div",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ b.jsx("span", { className: zz, children: s ?? (x ? "Drop to upload" : "Drop a file or click to browse") }),
          u && /* @__PURE__ */ b.jsx("span", { id: v, className: Oz, children: u }),
          p && R.length > 0 && /* @__PURE__ */ b.jsx("div", { className: Lz, children: p(R) })
        ]
      }
    ),
    N && /* @__PURE__ */ b.jsx("div", { id: g, role: "alert", className: jz, children: N })
  ] });
}
function Rb(e) {
...
async function Bz(e) {
  ...
  a.append("file", e);
  const r = await fetch(`${pc}/uploads`, { method: "POST", body: a });
  if (!r.ok) {
    let l = null;
    try {
      l = await r.json();
...
function Tb(e) {
  const [a, r] = _.useState(null), [l, s] = _.useState(!1), [u, c] = _.useState(null), d = _.useCallback(
    async (p) => {
      ...
      s(!0);
      try {
        const { path: m } = await Bz(p);
        e(p.name, m);
      } catch (m) {
        const y = m instanceof mc ? m.message : "Upload failed. Try again.";
...
var Uz = "cyswg40", Mb = "cyswg41", Db = "cyswg42", Ab = "cyswg43", zb = "cyswg44", Ob = "cyswg45", zu = "cyswg46";
const jb = 32 * 1024 * 1024;
function Vz({
  refImageRequired: e,
  lastImageRequired: a,
  refError: r,
  ...
  const { setRefImage: s, setLastImage: u } = mn(), c = _.useCallback(
    ...
    (v, x) => u(v, x),
    [u]
  ), p = Tb(c), m = Tb(d), y = Rb(p.file), g = Rb(m.file);
  return /* @__PURE__ */ b.jsxs("div", { className: Uz, children: [
    /* @__PURE__ */ b.jsxs("div", { className: Mb, children: [
      /* @__PURE__ */ b.jsxs("span", { className: Db, children: [
        "Reference image",
        " ",
      ...
      /* @__PURE__ */ b.jsx(
        Cb,
        {
          ...
          renderPreview: () => y ? /* @__PURE__ */ b.jsx("img", { className: Ab, src: y, alt: "reference preview" }) : null
        }
      ),
      p.uploading && /* @__PURE__ */ b.jsx("span", { className: Ob, children: "Uploading…" }),
      !p.uploading && p.file && /* @__PURE__ */ b.jsx("span", { className: zb, children: p.file.name }),
      p.uploadError && /* @__PURE__ */ b.jsx("span", { role: "alert", className: zu, children: p.uploadError }),
      r && /* @__PURE__ */ b.jsx("span", { role: "alert", className: zu, children: r })
    ] }),
    /* @__PURE__ */ b.jsxs("div", { className: Mb, children: [
      /* @__PURE__ */ b.jsxs("span", { className: Db, children: [
        "Last image",
      ...
      /* @__PURE__ */ b.jsx(
        Cb,
        {
          ...
          renderPreview: () => g ? /* @__PURE__ */ b.jsx("img", { className: Ab, src: g, alt: "last preview" }) : null
        }
      ),
      m.uploading && /* @__PURE__ */ b.jsx("span", { className: Ob, children: "Uploading…" }),
      !m.uploading && m.file && /* @__PURE__ */ b.jsx("span", { className: zb, children: m.file.name }),
      m.uploadError && /* @__PURE__ */ b.jsx("span", { role: "alert", className: zu, children: m.uploadError }),
      l && /* @__PURE__ */ b.jsx("span", { role: "alert", className: zu, children: l })
    ] })
  ] });
}
const qz = /wan[\s._-]?2[._]2/i, $z = /i2v/i, Yz = /high/i, Iz = /low/i, Gz = /* @__PURE__ */ new Set(["safetensors", "gguf"]);
function Xz(e) {
  const a = `${e.family_id} ${e.filename}`;
  return Gz.has(e.format) && e.install_path !== null && qz.test(a) && $z.test(a);
}
function Fz(e) {
  ...
  const r = [];
  for (const [l, s] of a) {
    const u = s.find((d) => Yz.test(d.filename)), c = s.find((d) => Iz.test(d.filename) && d !== u);
...
var Dl = "_1czy96m0", Al = "_1czy96m1", Dc = "_1czy96m2", Om = "_1czy96m3", jm = "_1czy96m4", Uw = "_1czy96m5", Vw = "_1czy96m6", qw = "_1czy96m7", $w = "_1czy96m8", Yw = "_1czy96m9", Pz = "_1czy96ma", Kz = "_1czy96mb", Jz = "_1czy96mc", Wz = "_1czy96md", eO = "_1czy96me", tO = "_1czy96mf", nO = "_1czy96mg", aO = "_1czy96mh", iO = "_1czy96mi", rO = "_1czy96mk _1czy96mj", lO = "_1czy96ml _1czy96mj", oO = "_1czy96mm", sO = "_1czy96mn", uO = "_1czy96mo", oc = "_1czy96mp", cO = "_1czy96mq";
const Lb = "__bundled__";
function fO() {
  const { params: e, settings: a, updateParam: r, setSettings: l } = mn(), s = Xh("svi2/installed-models", Qz), u = _.useMemo(
    () => Fz(s.data?.installed ?? []),
    [s.data]
  ), c = u.find((m) => m.ditHighPath === e.dit_high_path)?.familyId ?? Lb, d = _.useCallback(
    (m) => {
      ...
      r("dit_high_path", y ? y.ditHighPath : void 0), r("dit_low_path", y ? y.ditLowPath : void 0), l(g), O1(g).catch(() => {
      });
    },
    [u, a, r, l]
  ), p = s.error !== void 0;
  return /* @__PURE__ */ b.jsxs("div", { className: Dl, children: [
    ...
    /* @__PURE__ */ b.jsxs("div", { className: oO, children: [
      /* @__PURE__ */ b.jsxs(
        "select",
        {
          id: "svi2-base-model",
          ...
          children: [
            /* @__PURE__ */ b.jsx("option", { value: Lb, children: ON }),
            u.map((m) => /* @__PURE__ */ b.jsx("option", { value: m.familyId, children: m.label }, m.familyId))
          ]
        }
      ),
      /* @__PURE__ */ b.jsx("span", { className: uO, "aria-hidden": "true", children: /* @__PURE__ */ b.jsxs("svg", { viewBox: "0 0 16 16", width: "100%", height: "100%", fill: "none", "aria-hidden": "true", children: [
    ...
    p && /* @__PURE__ */ b.jsx("span", { className: oc, children: "Model Foundry list unavailable — using the bundled base model." }),
    !p && u.length === 0 && /* @__PURE__ */ b.jsx("span", { className: oc, children: "No substitutable Wan2.2-I2V high/low pairs installed via Model Foundry yet." })
  ] });
}
const Ac = "custom", dO = [
  {
...
var hO = "_14qe5430", mO = "_14qe5431", pO = "_14qe5432", gO = "_14qe5433", yO = "_14qe5434", vO = "_14qe5435", bO = "_14qe5436", xO = "_14qe5437", wO = "_14qe5438", SO = "_14qe543a _14qe5439", EO = "_14qe543b _14qe5439", _O = "_14qe543c _14qe5439";
const NO = {
  ok: mO,
  neutral: pO,
  warn: gO
...
function DO({
  ...
  const { params: r } = mn(), l = _.useMemo(() => Lm(e), [e]);
  if (l.length === 0) return null;
  const s = Hm(r, l), u = s === Ac ? null : l.find((d) => d.id === s)?.stepsDown ?? null, c = TO(u, a);
  return /* @__PURE__ */ b.jsxs(
    "output",
    {
      className: [hO, NO[c.tone]].join(" "),
      "aria-live": "polite",
      children: [
        /* @__PURE__ */ b.jsx("span", { className: [yO, CO[c.tone]].join(" "), "aria-hidden": "true", children: /* @__PURE__ */ b.jsx(MO, { tone: c.tone }) }),
        /* @__PURE__ */ b.jsx("span", { className: wO, children: c.text }),
        /* @__PURE__ */ b.jsx("span", { className: RO[c.tone], children: c.tag })
      ]
    }
  );
}
...
], zO = "In Text-to-Video, the prompt sets content and motion — appearance is locked to the synthesized seed and won't restyle mid-take.", OO = /* @__PURE__ */ new Set(["ArrowRight", "ArrowDown"]), jO = /* @__PURE__ */ new Set(["ArrowLeft", "ArrowUp"]);
function LO(e) {
  return [jm, e ? Uw : ""].filter(Boolean).join(" ");
}
function HO({ value: e, onChange: a }) {
  const r = _.useId(), l = (s) => {
    const u = OO.has(s.key), c = jO.has(s.key);
    if (!u && !c) return;
    s.preventDefault();
  ...
  return /* @__PURE__ */ b.jsxs("div", { className: Dl, children: [
    ...
    /* @__PURE__ */ b.jsx("div", { className: Dc, children: /* @__PURE__ */ b.jsx(
      "div",
      {
        className: Om,
        role: "radiogroup",
    ...
    e === "text_to_video" && /* @__PURE__ */ b.jsx("p", { className: AO, "aria-live": "polite", children: zO })
  ] });
}
var kO = "dck790", BO = "dck791", UO = "dck792";
function sc({ title: e, detail: a, action: r, className: l }) {
  const s = [kO, l].filter(Boolean).join(" ");
  return /* @__PURE__ */ b.jsxs("div", { className: s, children: [
    /* @__PURE__ */ b.jsx("span", { className: BO, children: e }),
    a && /* @__PURE__ */ b.jsx("span", { className: UO, children: a }),
    r
  ] });
}
var VO = "_1880igs0", qO = "_1880igs1", $O = "_1880igs2", YO = "_1880igs3", IO = "_1880igs4", GO = "_1880igs5", XO = "_1880igs6";
const FO = {
  queued: "neutral",
  running: "accent",
  succeeded: "success",
...
function ZO({ jobs: e, onOpen: a }) {
  ...
  ) : /* @__PURE__ */ b.jsx("div", { className: VO, children: e.map((r) => /* @__PURE__ */ b.jsxs("button", { type: "button", className: qO, onClick: () => a(r), children: [
    /* @__PURE__ */ b.jsxs("span", { className: $O, children: [
      /* @__PURE__ */ b.jsx("span", { className: YO, children: r.presetId ?? "custom" }),
      /* @__PURE__ */ b.jsx("span", { className: IO, children: QO(r) })
    ] }),
    /* @__PURE__ */ b.jsxs("span", { className: GO, children: [
      /* @__PURE__ */ b.jsx("time", { className: XO, dateTime: r.createdAt, title: PO(r.createdAt), children: KO(r.createdAt) }),
      /* @__PURE__ */ b.jsx(An, { tone: FO[r.status], children: r.status })
    ] })
  ] }, r.id)) });
}
function QO(e) {
...
function JO() {
  ...
  return Mc(e, a) ? /* @__PURE__ */ b.jsx(ej, {}) : /* @__PURE__ */ b.jsx(WO, {});
}
function Iw(e) {
  return [jm, e ? Uw : ""].filter(Boolean).join(" ");
}
function WO() {
  const { params: e, updateParam: a } = mn(), r = Ml(e), l = T3(e.num_clips ?? 1, r), [s, u] = _.useState(
    () => Number(_w(e.num_clips ?? 1, r).toFixed(1))
  ), c = (d) => {
    a("num_clips", Nw(d, r));
  };
  return /* @__PURE__ */ b.jsxs("div", { className: Dl, children: [
    /* @__PURE__ */ b.jsx("span", { className: Al, id: "svi2-length-label", children: "Length" }),
    /* @__PURE__ */ b.jsxs("div", { className: Dc, children: [
      /* @__PURE__ */ b.jsx("div", { className: Om, role: "radiogroup", "aria-labelledby": "svi2-length-label", children: Sw.map((d) => {
        const p = l === d;
        return /* @__PURE__ */ b.jsxs(
          "button",
          {
      ...
      /* @__PURE__ */ b.jsxs("div", { className: Vw, children: [
        /* @__PURE__ */ b.jsx(
          "input",
          {
            type: "number",
        ...
        /* @__PURE__ */ b.jsx("span", { className: $w, children: "sec" })
      ] })
    ] }),
    /* @__PURE__ */ b.jsx("output", { className: Yw, "aria-live": "polite", children: M3(e) })
  ] });
}
function ej() {
  const { params: e, updateParam: a } = mn(), r = Ml(e), l = C3(r.fps), [s, u] = _.useState(() => Number(Tw(e).toFixed(1))), c = N3.filter((p) => p <= l), d = (p) => {
    const m = Math.min(l, Math.max(1, p));
    e.num_clips !== 1 && a("num_clips", 1), a("frames_per_clip", pb(m, r.fps));
  };
  return /* @__PURE__ */ b.jsxs("div", { className: Dl, children: [
    /* @__PURE__ */ b.jsx("span", { className: Al, id: "svi2-length-label", children: "Length" }),
    /* @__PURE__ */ b.jsxs("div", { className: Dc, children: [
      /* @__PURE__ */ b.jsx("div", { className: Om, role: "radiogroup", "aria-labelledby": "svi2-length-label", children: c.length > 0 ? c.map((p) => {
        const m = pb(p, r.fps) === r.framesPerClip;
        return /* @__PURE__ */ b.jsxs(
          "button",
          {
            type: "button",
      ...
      }) : /* @__PURE__ */ b.jsxs("span", { className: jm, "aria-hidden": "true", children: [
        "1–",
        l,
        "s"
      ] }) }),
      ...
      /* @__PURE__ */ b.jsxs("span", { className: oc, children: [
        "1–",
        l,
    ...
    /* @__PURE__ */ b.jsx("output", { className: Yw, "aria-live": "polite", children: R3(e) })
  ] });
}
var tj = "_17owg2e0", nj = "_17owg2e1", aj = "_17owg2e2", Ou = "_17owg2e3", ju = "_17owg2e4", ij = "_17owg2e5", rj = "_17owg2e6", lj = "_17owg2e7", oj = "_17owg2e8";
function mh() {
  return /* @__PURE__ */ b.jsx("span", { className: ij, "aria-hidden": "true" });
}
function sj({ presets: e }) {
  const { presetId: a, params: r } = mn(), l = _.useMemo(() => Lm(e), [e]), s = Ml(r), u = Mc(a, r), c = u ? 1 : r.num_clips ?? 1, d = u ? s.framesPerClip : Ew(c, s), p = s.fps > 0 ? d / s.fps : 0, m = r.interpolate_fps ?? 0, y = m > 0 ? m : s.fps, g = m > 0 && s.fps > 0 ? Math.round(d * (m / s.fps)) : d, v = typeof r.upscale_factor == "number" ? r.upscale_factor : 0, x = v > 0 ? v : 1, S = (r.width ?? 0) * x, N = (r.height ?? 0) * x, C = Hm(r, l), R = C === Ac || (l.find((E) => E.id === C)?.stepsDown ?? 0) >= 2, z = [lj, R ? oj : ""].filter(Boolean).join(" ");
  return /* @__PURE__ */ b.jsxs("div", { className: tj, children: [
    /* @__PURE__ */ b.jsx("span", { className: nj, children: "Output" }),
    /* @__PURE__ */ b.jsxs("div", { className: aj, children: [
      /* @__PURE__ */ b.jsxs("span", { children: [
        /* @__PURE__ */ b.jsx("span", { className: Ou, children: g }),
        " ",
        /* @__PURE__ */ b.jsx("span", { className: ju, children: "frames" })
      ] }),
      /* @__PURE__ */ b.jsx(mh, {}),
      /* @__PURE__ */ b.jsxs("span", { className: Ou, children: [
        S,
        "×",
        N
      ] }),
      /* @__PURE__ */ b.jsx(mh, {}),
      /* @__PURE__ */ b.jsxs("span", { children: [
        /* @__PURE__ */ b.jsx("span", { className: Ou, children: y }),
        " ",
        /* @__PURE__ */ b.jsx("span", { className: ju, children: "fps" })
      ] }),
      /* @__PURE__ */ b.jsx(mh, {}),
      /* @__PURE__ */ b.jsxs("span", { children: [
        /* @__PURE__ */ b.jsx("span", { className: ju, children: "~" }),
        /* @__PURE__ */ b.jsx("span", { className: Ou, children: p.toFixed(1) }),
        " ",
        /* @__PURE__ */ b.jsx("span", { className: ju, children: "s" })
      ] })
    ] }),
...
var uj = "dgx4n20", cj = "dgx4n21", fj = "dgx4n22", dj = "dgx4n23", hj = "dgx4n24", mj = "dgx4n25", pj = "dgx4n26", gj = "dgx4n27", yj = "dgx4n28", vj = "dgx4n29", bj = "dgx4n2a", xj = "dgx4n2b", Hb = "dgx4n2c", wj = "dgx4n2d", Sj = "dgx4n2e";
function Ej(e) {
  const a = e.trim();
...
function _j({
  ...
  const [l, s] = _.useState(!1), u = _.useMemo(() => H3(e), [e]), c = _.useMemo(() => {
  ...
  return /* @__PURE__ */ b.jsxs("div", { className: bj, children: [
    /* @__PURE__ */ b.jsx("div", { className: uj, role: "radiogroup", "aria-label": "Render presets", children: c.map((v, x) => {
      const S = j3(v), N = v.id === a, C = v.id === Po, R = [
        cj,
        v.legacy ? "" : fj,
        C ? dj : "",
        N ? hj : ""
      ...
      return /* @__PURE__ */ b.jsxs(
        "button",
        {
          ...
          onKeyDown: (z) => m(z, x),
          children: [
            /* @__PURE__ */ b.jsxs("div", { className: pj, children: [
              /* @__PURE__ */ b.jsx("span", { className: gj, children: v.label }),
              C && /* @__PURE__ */ b.jsx(An, { tone: "accent", children: "Default" }),
              /* @__PURE__ */ b.jsx("span", { className: mj, "aria-hidden": "true", children: /* @__PURE__ */ b.jsxs("svg", { viewBox: "0 0 20 20", width: "100%", height: "100%", fill: "none", children: [
            ...
            /* @__PURE__ */ b.jsx("span", { className: yj, children: Ej(v.description) }),
            /* @__PURE__ */ b.jsxs("div", { className: vj, children: [
    ...
    g > 0 && /* @__PURE__ */ b.jsxs("div", { className: xj, children: [
      /* @__PURE__ */ b.jsx("span", { className: Hb, "aria-hidden": "true" }),
      /* @__PURE__ */ b.jsxs(
        "button",
        {
          type: "button",
          ...
          onClick: () => s((v) => !v),
          children: [
            /* @__PURE__ */ b.jsx("span", { className: Sj, "aria-hidden": "true" }),
...
var Nj = "_1ntn2zv0", Cj = "_1ntn2zv1", Rj = "_1ntn2zv2", Tj = "_1ntn2zv3", Mj = "_1ntn2zv4", Dj = "_1ntn2zv5", kb = "_1ntn2zv6", Aj = "_1ntn2zv7", zj = "_1ntn2zv8", Oj = "_1ntn2zv9", jj = "_1ntn2zva";
function Lj({ error: e, textareaId: a }) {
  ...
  return /* @__PURE__ */ b.jsxs("div", { className: Nj, children: [
    /* @__PURE__ */ b.jsx("div", { className: Cj, children: /* @__PURE__ */ b.jsxs("span", { className: Rj, children: [
      /* @__PURE__ */ b.jsx(
        "button",
        {
          type: "button",
          ...
          className: Tj,
          onClick: () => g(!s),
          children: /* @__PURE__ */ b.jsx("span", { className: Mj, "aria-hidden": "true" })
        }
      ),
      "Per-clip prompts"
    ] }) }),
    s ? Array.from({ length: d }, (v, x) => (
      ...
      /* @__PURE__ */ b.jsxs("div", { className: Aj, children: [
        /* @__PURE__ */ b.jsxs("span", { className: zj, children: [
          "Clip ",
          x + 1
        ] }),
        /* @__PURE__ */ b.jsx(
    ...
    p > 0 && /* @__PURE__ */ b.jsxs("output", { className: Dj, children: [
      p,
      " per-clip prompt",
      p > 1 ? "s" : "",
    ...
    /* @__PURE__ */ b.jsx("p", { className: Oj, children: "Use a single prompt for a coherent long take. To change appearance, edit the anchor keyframe (edit-then-animate) — appearance verbs in the prompt fight the anchor and cause drift." }),
    e && /* @__PURE__ */ b.jsx("span", { role: "alert", className: jj, children: e })
  ] });
}
var Hj = "_1itrxk30", kj = "_1itrxk31", Bj = "_1itrxk32", Uj = "_1itrxk33", Vj = "_1itrxk34", qj = "_1itrxk35", $j = "_1itrxk36", Yj = "_1itrxk37";
function Ij() {
  const { qwenEdit: e, setQwenEdit: a } = mn();
  return /* @__PURE__ */ b.jsxs("div", { className: Hj, children: [
    /* @__PURE__ */ b.jsxs("div", { className: kj, children: [
      /* @__PURE__ */ b.jsx(
        "button",
        {
          ...
          children: /* @__PURE__ */ b.jsx("span", { className: Yj, "aria-hidden": "true" })
        }
      ),
      /* @__PURE__ */ b.jsxs("span", { className: Bj, children: [
        /* @__PURE__ */ b.jsx("span", { className: Uj, children: "Transform anchor (edit-then-animate)" }),
        /* @__PURE__ */ b.jsx("span", { className: Vj, children: "Edit the reference keyframe with Qwen-Image-Edit before animating. Coherent transformation without per-frame flicker." })
      ] })
    ] }),
...
var Gj = "ob7g5b0", Xj = "ob7g5b1", Fj = "ob7g5b3", Zj = "ob7g5b4", Qj = "ob7g5b5", Pj = "ob7g5b6", Kj = "ob7g5b7", Jj = "ob7g5b8", Wj = "ob7g5b9", e6 = "ob7g5ba";
function t6({
  src: e,
  poster: a,
  fpsLabel: r,
  ...
  const [x, S] = _.useState("loading"), [N, C] = _.useState(null), R = _.useCallback(() => {
    ...
    [v]
  ), E = [Gj, p].filter(Boolean).join(" ");
  return e ? x === "error" ? /* @__PURE__ */ b.jsx("div", { className: E, role: "alert", "aria-label": d ?? "video playback error", children: /* @__PURE__ */ b.jsxs("div", { className: Kj, children: [
    /* @__PURE__ */ b.jsx("div", { className: Jj, children: "Could not play video" }),
    /* @__PURE__ */ b.jsx("div", { className: Wj, children: N ?? "unknown error" }),
    /* @__PURE__ */ b.jsx("a", { className: e6, href: e, download: !0, target: "_blank", rel: "noreferrer", children: "Download file" })
  ] }) }) : /* @__PURE__ */ b.jsxs("div", { className: E, children: [
    x === "loading" && /* @__PURE__ */ b.jsx("div", { className: Fj, "aria-hidden": "true", children: /* @__PURE__ */ b.jsx("div", { className: Zj }) }),
    r && /* @__PURE__ */ b.jsx("span", { className: Qj, children: r }),
    /* @__PURE__ */ b.jsx(
      "video",
      {
        className: Xj,
  ...
  ] }) : /* @__PURE__ */ b.jsx("div", { className: E, "aria-label": d ?? "no video", children: /* @__PURE__ */ b.jsx("div", { className: Pj, children: m ?? "No video to display yet." }) });
}
const oi = {
...
function n6(e, a) {
  return e !== null && Bb[e] ? Bb[e] : {
    title: "Render error",
    hint: a ?? "An unknown error occurred during the render."
  };
}
function a6(e) {
  return e ? `${pc}/media?path=${encodeURIComponent(e)}` : null;
}
var Lu = "_1ojc56g0", i6 = "_1ojc56g1", r6 = "_1ojc56g2", l6 = "_1ojc56g3", o6 = "_1ojc56g4", s6 = "_1ojc56g5", u6 = "_1ojc56g6", c6 = "_1ojc56g7", f6 = "_1ojc56g8", Hu = "_1ojc56g9", d6 = "_1ojc56ga", h6 = "_1ojc56gb", m6 = "_1ojc56gc", p6 = "_1ojc56gd", g6 = "_1ojc56ge", y6 = "_1ojc56gf", v6 = "_1ojc56gg", b6 = "_1ojc56gh", x6 = "_51y2ql0", w6 = "_51y2ql1", S6 = "_51y2ql2", E6 = "_51y2ql3", _6 = "_51y2ql4", ph = "_51y2ql5", N6 = "_51y2ql6", C6 = "_51y2ql7 _51y2ql6", R6 = "_51y2ql8 _51y2ql6", T6 = "_51y2ql9", M6 = "_51y2qla", D6 = "_51y2qlb", A6 = "_51y2qlc", z6 = "_51y2qld";
const vn = 60, aa = 62, bn = 46, O6 = 180, Bo = 75, Fu = 45, j6 = [0, 0.25, 0.5, 0.75, 1];
function L6(e) {
...
function H6(e) {
  const a = Bo - Fu, r = (Bo - e) / a;
  return Math.min(1, Math.max(0.02, r));
}
function k6(e) {
  return e >= 0.55 ? N6 : e >= 0.25 ? C6 : R6;
}
function B6({ secondsPerStep: e }) {
  const a = e !== null && e > 0, r = a ? H6(e) : 0, l = O6 * r, s = a ? e.toFixed(1) : "—";
  return /* @__PURE__ */ b.jsxs(
    "div",
    {
      className: x6,
      ...
      children: [
        /* @__PURE__ */ b.jsx("span", { className: w6, children: "Speed" }),
        /* @__PURE__ */ b.jsxs("svg", { className: S6, viewBox: "0 0 120 78", "aria-hidden": "true", children: [
          ...
          /* @__PURE__ */ b.jsx("text", { className: ph, x: vn - bn, y: aa + 12, fontSize: 6, textAnchor: "middle", children: Bo }),
          /* @__PURE__ */ b.jsx("text", { className: ph, x: vn, y: 9, fontSize: 6, textAnchor: "middle", children: (Bo + Fu) / 2 }),
          /* @__PURE__ */ b.jsx("text", { className: ph, x: vn + bn, y: aa + 12, fontSize: 6, textAnchor: "middle", children: Fu }),
          a && /* @__PURE__ */ b.jsx(
            "path",
            {
              className: k6(r),
          ...
          /* @__PURE__ */ b.jsx("circle", { className: D6, cx: vn, cy: aa, r: 3.6 }),
          /* @__PURE__ */ b.jsx("text", { className: A6, x: vn, y: 44, fontSize: 15, textAnchor: "middle", children: s }),
          /* @__PURE__ */ b.jsx("text", { className: z6, x: vn, y: 55, fontSize: 7.5, textAnchor: "middle", children: "s/it" })
        ] })
      ]
    }
  );
}
function U6({ state: e, onCancel: a, onReset: r }) {
  ...
  if (e.phase === "error") {
    const m = n6(e.errorCode, e.errorMessage);
    return /* @__PURE__ */ b.jsxs("div", { className: Lu, children: [
      /* @__PURE__ */ b.jsxs("div", { className: y6, role: "alert", children: [
        /* @__PURE__ */ b.jsx("span", { className: v6, children: m.title }),
        /* @__PURE__ */ b.jsx("span", { className: b6, children: m.hint })
      ] }),
      /* @__PURE__ */ b.jsx("div", { className: Hu, children: /* @__PURE__ */ b.jsx(Ha, { variant: "secondary", onClick: r, children: "Dismiss" }) })
    ] });
  }
  if (e.phase === "cancelled")
    return /* @__PURE__ */ b.jsxs("div", { className: Lu, children: [
      /* @__PURE__ */ b.jsx(sc, { title: "Render cancelled", detail: "The render was stopped before completion." }),
      /* @__PURE__ */ b.jsx("div", { className: Hu, children: /* @__PURE__ */ b.jsx(Ha, { variant: "secondary", onClick: r, children: "Reset" }) })
    ] });
  const c = e.renderReport?.fps, d = typeof c == "number" ? c : void 0;
  if (e.phase === "done")
    return /* @__PURE__ */ b.jsxs("output", { className: Lu, children: [
      /* @__PURE__ */ b.jsx(
        t6,
        {
          src: a6(e.outputPath),
      ...
      /* @__PURE__ */ b.jsx(Y6, { state: e }),
      /* @__PURE__ */ b.jsx("div", { className: Hu, children: /* @__PURE__ */ b.jsx(Ha, { variant: "secondary", onClick: r, children: "New render" }) })
    ] });
  const p = Math.round(e.overallFraction * 100);
  return /* @__PURE__ */ b.jsxs("div", { className: Lu, children: [
    /* @__PURE__ */ b.jsx("output", { className: i6, "aria-live": "polite", children: $6(e) }),
    /* @__PURE__ */ b.jsx(
      "div",
      {
        className: c6,
    ...
    e.stalled && /* @__PURE__ */ b.jsx("output", { className: g6, children: "Still working… no progress for a while — the connection may be lost. The render may still be running; check History if it does not resume." }),
    /* @__PURE__ */ b.jsxs("div", { className: r6, "aria-live": "polite", children: [
      /* @__PURE__ */ b.jsx(B6, { secondsPerStep: e.secondsPerStep }),
      /* @__PURE__ */ b.jsxs("div", { className: l6, children: [
        ...
        /* @__PURE__ */ b.jsx(Do, { label: "ETA", value: V6(b3(e)) }),
        /* @__PURE__ */ b.jsx(
          Do,
          {
            label: "VRAM peak",
    ...
    /* @__PURE__ */ b.jsx("div", { className: Hu, children: /* @__PURE__ */ b.jsx(Ha, { variant: "danger", onClick: u, loading: l, disabled: l, children: l ? "Cancelling…" : "Cancel render" }) })
  ] });
}
function V6(e) {
  if (e === null) return "—";
...
function Do({ label: e, value: a }) {
  return /* @__PURE__ */ b.jsxs("div", { className: o6, children: [
    /* @__PURE__ */ b.jsx("span", { className: s6, children: e }),
    /* @__PURE__ */ b.jsx("span", { className: u6, children: a })
  ] });
}
function Y6({ state: e }) {
...
function G6({ presets: e }) {
  const { params: a, updateParam: r } = mn(), l = _.useMemo(() => Lm(e), [e]);
  if (l.length === 0) return null;
  const s = Hm(a, l);
  return /* @__PURE__ */ b.jsxs("div", { className: Dl, children: [
    /* @__PURE__ */ b.jsx("span", { className: Al, id: "svi2-resolution-label", children: "Generation resolution" }),
    /* @__PURE__ */ b.jsx("div", { className: Pz, role: "radiogroup", "aria-labelledby": "svi2-resolution-label", children: l.map((u) => {
      const c = s === u.id, d = [Kz, c ? Jz : ""].filter(Boolean).join(" "), p = [tO, c ? nO : ""].filter(Boolean).join(" ");
      return /* @__PURE__ */ b.jsxs(
        "button",
        {
          type: "button",
          ...
          children: [
            /* @__PURE__ */ b.jsxs("span", { className: Wz, children: [
              /* @__PURE__ */ b.jsxs("span", { className: eO, children: [
                u.width,
                "×",
                u.height
              ] }),
              /* @__PURE__ */ b.jsx("span", { className: p, children: /* @__PURE__ */ b.jsx(I6, {}) })
            ] }),
            /* @__PURE__ */ b.jsx("span", { className: aO, children: u.label }),
            /* @__PURE__ */ b.jsx("span", { className: iO, children: u.sub }),
            u.stepsDown > 0 && /* @__PURE__ */ b.jsx(
              "span",
              {
                className: u.stepsDown >= 2 ? lO : rO,
    ...
    s === Ac && /* @__PURE__ */ b.jsx("div", { className: cO, children: /* @__PURE__ */ b.jsxs(An, { tone: "warning", children: [
      "custom ",
      a.width,
      "×",
      a.height
...
function Q6() {
  ...
  return /* @__PURE__ */ b.jsxs("div", { className: Dl, children: [
    ...
    /* @__PURE__ */ b.jsxs("div", { className: Dc, children: [
      ...
      /* @__PURE__ */ b.jsx("span", { className: oc, children: "Fixes the synthesized seed frame for reproducible takes. Leave blank to randomize." })
    ] })
  ] });
}
var P6 = "_1hbttwg0", K6 = "_1hbttwg1", J6 = "_1hbttwg2", W6 = "_1hbttwg3", Gw = "_1hbttwg4", eL = "_1hbttwg5", tL = "_1hbttwg7 _1hbttwg6", nL = "_1hbttwg8 _1hbttwg6", Ub = "_1hbttwg9", aL = "_1hbttwga", iL = "_1hbttwgb", rL = "_1hbttwgc", lL = "_1hbttwgd";
function oL({
  spec: e,
  value: a,
  error: r,
  ...
  return /* @__PURE__ */ b.jsxs("div", { className: P6, title: s ? u : void 0, children: [
    /* @__PURE__ */ b.jsxs("div", { className: K6, children: [
      /* @__PURE__ */ b.jsx("label", { className: J6, htmlFor: c, children: e.label }),
      e.control === "slider" && /* @__PURE__ */ b.jsx("span", { className: W6, children: uL(a, e.step) })
    ] }),
    sL(e, a, l, c, p, r !== void 0, s),
    /* @__PURE__ */ b.jsx("span", { id: d, className: Gw, children: s && u ? u : e.help }),
    r && /* @__PURE__ */ b.jsx("span", { id: `${c}-error`, role: "alert", className: eL, children: r })
  ] });
}
function sL(e, a, r, l, s, u, c) {
  switch (e.control) {
    case "toggle": {
      const d = !!a;
      return /* @__PURE__ */ b.jsxs("div", { className: iL, children: [
        /* @__PURE__ */ b.jsx(
          "button",
          {
            type: "button",
            ...
            className: rL,
            onClick: () => r(!d),
            children: /* @__PURE__ */ b.jsx("span", { className: lL, "aria-hidden": "true" })
          }
        ),
        /* @__PURE__ */ b.jsx("span", { className: Gw, children: d ? "On" : "Off" })
      ] });
    }
    case "select":
      return /* @__PURE__ */ b.jsx(
        "select",
        {
          ...
          disabled: c,
          className: [nL, u ? Ub : ""].filter(Boolean).join(" "),
    ...
    case "slider": {
      const d = Vb(a, e), p = e.min ?? 0, m = e.max ?? 100, g = { "--svi2-slider-fill": `${m > p ? (d - p) / (m - p) * 100 : 0}%` };
      return /* @__PURE__ */ b.jsx(
        "input",
        {
          id: l,
    ...
    default:
      return /* @__PURE__ */ b.jsx(
        "input",
        {
          ...
          "aria-invalid": u || void 0,
          disabled: c,
          className: [tL, u ? Ub : ""].filter(Boolean).join(" "),
          min: e.min,
          max: e.max,
          step: e.step,
          value: Vb(a, e),
...
var cL = "_1f0q5gf0", fL = "_1f0q5gf1", dL = "_1f0q5gf2", hL = "_1f0q5gf3", mL = "_1f0q5gf4", pL = "_1f0q5gf5", gL = "_1f0q5gf6", yL = "_1f0q5gf7", vL = "_1f0q5gf8", bL = "_1f0q5gf9", xL = "_1f0q5gfa", wL = "_1f0q5gfb", SL = "_1f0q5gfc";
function EL({
  title: e,
  description: a,
  badge: r,
  ...
  const p = _.useId(), [m, y] = _.useState(u ? s : !1), g = [cL, c].filter(Boolean).join(" "), v = [dL, m ? hL : ""].filter(Boolean).join(" "), x = !u || !m;
  return /* @__PURE__ */ b.jsxs("section", { className: g, children: [
      ...
      "button",
      {
        ...
        children: [
          ...
          /* @__PURE__ */ b.jsxs("span", { className: mL, children: [
            /* @__PURE__ */ b.jsx("span", { className: pL, children: e }),
            a && /* @__PURE__ */ b.jsx("span", { className: gL, children: a })
          ] }),
          (l || r) && /* @__PURE__ */ b.jsxs("span", { className: yL, children: [
            l && /* @__PURE__ */ b.jsx("span", { className: vL, children: l }),
            r
          ] })
        ]
      }
    ...
    /* @__PURE__ */ b.jsx(
      ...
      {
        id: p,
        className: [bL, x ? xL : ""].filter(Boolean).join(" "),
        inert: !x || void 0,
        children: /* @__PURE__ */ b.jsx("div", { className: wL, children: /* @__PURE__ */ b.jsx("div", { className: SL, children: d }) })
      }
    )
  ] });
}
...
function NL(e) {
  return Tc.find((a) => a.key === e)?.default;
}
function ul(e, a) {
  const r = e[a];
...
function CL(e, a) {
  if (e === "core") {
    const r = ul(a, "fps"), l = ul(a, "interpolate_fps"), s = l > 0 ? l : r, u = typeof a.interpolate_method == "string" ? a.interpolate_method : "rife", c = _L[u] ?? u, d = ul(a, "upscale_factor"), p = `${r} → ${s} fps · ${c}`;
    return d > 0 ? `${p} · ${d}× VSR` : p;
  }
  if (e === "quality") {
    const r = ul(a, "num_inference_steps"), l = ul(a, "cfg_scale"), s = ul(a, "sigma_shift");
    return `${r} steps · CFG ${qb(l)} · shift ${qb(s)}`;
  }
  return null;
}
var RL = "kn07ek0", TL = "kn07ek1";
const ML = {
...
function DL({ issues: e }) {
  const { presetId: a, params: r, updateParam: l } = mn(), s = Mc(a, r), u = (c) => e.find((d) => d.field === c && d.severity === "error")?.message;
  return /* @__PURE__ */ b.jsx("div", { className: RL, children: ww.map((c) => {
    const d = w3(c.id);
    return d.length === 0 ? null : /* @__PURE__ */ b.jsx(
      EL,
      {
        ...
        children: /* @__PURE__ */ b.jsx("div", { className: TL, children: d.map((p) => {
          const m = s ? ML[p.key] : void 0;
          return /* @__PURE__ */ b.jsx(
            oL,
            {
              spec: p,
...
var AL = "_1w9jfpf0", zL = "_1w9jfpf1", OL = "_1w9jfpf2", jL = "_1w9jfpf3", LL = "_1w9jfpf4", HL = "_1w9jfpf5";
const Fh = "svi2-anchor-panel", Xw = "svi2-prompt-input";
function kL() {
  const {
    presetId: e,
    presetApplied: a,
    ...
    resetRender: c,
    showJobResult: d
  } = mn(), { issues: p, blocked: m, busy: y, submit: g, cancel: v, focusRequest: x } = Dw();
  UL(x);
  const S = Xh("svi2/presets", z1), N = Xh("svi2/history", () => k3(25)), C = S.data?.presets ?? [];
  _.useEffect(() => {
    if (a || C.length === 0) return;
    const te = C.find(($) => $.id === e) ?? C[0];
    te && s(te);
  }, [a, C, e, s]);
  const R = N.data?.jobs ?? [], z = r.mode ?? "image_to_video", E = z !== "text_to_video", O = Dm(e, r), k = p.find((te) => te.field === "ref_image_path")?.message, B = p.find((te) => te.field === "last_image_path")?.message, V = p.find((te) => te.field === "prompts")?.message, A = p.find(
    ...
    /* @__PURE__ */ b.jsxs("div", { className: zL, children: [
      /* @__PURE__ */ b.jsx(
        Oa,
        {
          ...
          children: /* @__PURE__ */ b.jsx(_j, { presets: C, selectedId: e, onSelect: s })
        }
      ),
      /* @__PURE__ */ b.jsxs(
        Oa,
        {
          ...
          children: [
            /* @__PURE__ */ b.jsx(HO, { value: z, onChange: u }),
            z === "text_to_video" && /* @__PURE__ */ b.jsx(Q6, {})
          ]
        }
      ),
      /* @__PURE__ */ b.jsx("div", { id: Fh, children: /* @__PURE__ */ b.jsx(
        Oa,
        {
          title: "Anchor",
      ...
      /* @__PURE__ */ b.jsx(Oa, { title: "Prompt", description: "One prompt for a coherent take, or per-clip when needed.", children: /* @__PURE__ */ b.jsx(Lj, { error: V, textareaId: Xw }) }),
      /* @__PURE__ */ b.jsx(Oa, { title: "Transform", description: "Edit the anchor before animating it.", children: /* @__PURE__ */ b.jsx(Ij, {}) }),
      /* @__PURE__ */ b.jsxs(
        Oa,
        {
          title: /* @__PURE__ */ b.jsxs(b.Fragment, { children: [
            /* @__PURE__ */ b.jsx("span", { className: LL, children: "Inference · Parameters" }),
            "Parameters"
          ] }),
          ...
          children: [
            /* @__PURE__ */ b.jsx(DO, { presets: C, warningText: A }),
            /* @__PURE__ */ b.jsxs("div", { className: HL, children: [
              /* @__PURE__ */ b.jsx(JO, {}),
              /* @__PURE__ */ b.jsx(G6, { presets: C }),
              /* @__PURE__ */ b.jsx(fO, {})
            ] }),
            /* @__PURE__ */ b.jsx(DL, { issues: p }),
            /* @__PURE__ */ b.jsx(sj, { presets: C })
          ]
        }
      )
    ] }),
    /* @__PURE__ */ b.jsxs("div", { className: OL, children: [
      /* @__PURE__ */ b.jsxs(
        Oa,
        {
          ...
          children: [
            /* @__PURE__ */ b.jsx(U6, { state: l, onCancel: v, onReset: c }),
      ...
      /* @__PURE__ */ b.jsx(Oa, { title: "History", description: "Past renders for this deployment.", children: /* @__PURE__ */ b.jsx(ZO, { jobs: R, onOpen: Y }) })
    ] })
  ] });
}
const BL = {
...
function VL(e) {
  const a = Tc.find((s) => s.key === e);
  if (!a) return;
  const r = ww.find((s) => s.id === a.tier);
  if (!r) return;
...
var qL = "_1smvon90", dr = "_1smvon91", hr = "_1smvon92", mr = "_1smvon93", ku = "_1smvon94", gh = "_1smvon95 _1smvon94", $L = "_1smvon96", YL = "_1smvon97";
const IL = [
  { value: "rife", label: "RIFE (auto)" },
  { value: "rife_torch", label: "RIFE torch" },
  { value: "rife_ncnn", label: "RIFE ncnn" },
    ...
    Oa,
    {
      ...
      children: [
          ...
          /* @__PURE__ */ b.jsxs("label", { className: dr, children: [
            ...
            /* @__PURE__ */ b.jsx(
              "select",
              {
                ...
                children: zN.map((m) => /* @__PURE__ */ b.jsx("option", { value: m.value, children: m.label }, m.value))
              }
            ),
          ...
          /* @__PURE__ */ b.jsxs("label", { className: dr, children: [
            ...
            /* @__PURE__ */ b.jsx(
              "select",
              {
                ...
                children: IL.map((m) => /* @__PURE__ */ b.jsx("option", { value: m.value, children: m.label }, m.value))
              }
            ),
        ...
        /* @__PURE__ */ b.jsxs("div", { className: $L, children: [
          ...
          c && /* @__PURE__ */ b.jsx("output", { className: YL, children: "Unsaved changes" })
        ] })
      ]
    }
  );
}
var XL = "_1ugwva20", FL = "_1ugwva21", ZL = "_1ugwva22", QL = "_1ugwva23", PL = "_1ugwva24", KL = "_1ugwva25";
function JL() {
  const e = B2(), a = WL(e.catalog?.presets ?? []);
  return /* @__PURE__ */ b.jsxs(G3, { initialSettings: e.settings, initialPreset: a, children: [
    /* @__PURE__ */ b.jsxs("div", { className: XL, children: [
      /* @__PURE__ */ b.jsx("header", { className: FL, children: /* @__PURE__ */ b.jsxs("div", { className: ZL, children: [
        /* @__PURE__ */ b.jsx("h1", { className: QL, children: "SVI 2.0 Pro" }),
        /* @__PURE__ */ b.jsx("p", { className: PL, children: "Long, identity-locked image-to-video from a single anchor image. Chain 4n+1-frame clips with the error-recycling SVI LoRA for coherent long takes." })
      ] }) }),
      /* @__PURE__ */ b.jsx("main", { className: KL, children: /* @__PURE__ */ b.jsx(K2, {}) })
    ] }),
    /* @__PURE__ */ b.jsx(v5, { position: "bottom-right", theme: "dark", richColors: !0 })
  ] });
}
function WL(e) {
  ...
  return [
    ...
    },
    {
      ...
      children: [
        {
          index: !0,
          loader: ({ params: e }) => Oy(`/${n8(e, "deploymentId")}/recipe`)
        },
        { path: "recipe", Component: kL },
        { path: "dag", Component: P5 },
        { path: "settings", Component: GL }
      ]
    }
  ];
}
...
const Yb = "ext-actions-request", a8 = "ext-actions-declare", i8 = "ext-action-state", Ib = "ext-action-invoke", Gb = "svi2-pro:navigate", Xb = "svi2-pro.render";
function r8(e, a) {
  let r = !1, l = !1;
  const s = () => ({
    id: Xb,
  ...
  return e.addEventListener(Yb, p), e.addEventListener(Ib, m), c(), {
    dispose: () => {
      y(), e.removeEventListener(Yb, p), e.removeEventListener(Ib, m);
    }
  };
}
const Zh = "svi2-pro-app", l8 = "ext-event", Fb = "svi2-pro-stylesheet", Zb = ["accent", "density", "card"];
function o8(e) {
...
function s8() {
  ...
  a.id = Fb, a.rel = "stylesheet", a.href = e, document.head.appendChild(a);
}
s8();
class u8 extends HTMLElement {
  ...
  connectedCallback() {
    this.root = s_.createRoot(this), this.syncTweaksFromBody(), this.observeBodyTweaks(), this.installNavigateListener(), this.paint(), this.refreshActionBridge();
  }
  attributeChangedCallback() {
    this.paint(), this.refreshActionBridge();
  }
  disconnectedCallback() {
    this.root?.unmount(), this.root = null, this.observer?.disconnect(), this.observer = null, this.actionBridge?.dispose(), this.actionBridge = null, this.actionBridgeDeploymentId = null, this.navigateListener && (this.removeEventListener(Gb, this.navigateListener), this.navigateListener = null), this.router = null;
  }
  refreshActionBridge() {
    const a = this.getAttribute("deployment-id");
    a && a !== this.actionBridgeDeploymentId ? (this.actionBridge?.dispose(), this.actionBridge = r8(this), this.actionBridgeDeploymentId = a) : !a && this.actionBridge && (this.actionBridge.dispose(), this.actionBridge = null, this.actionBridgeDeploymentId = null);
  }
  installNavigateListener() {
    ...
    this.navigateListener = a, this.addEventListener(Gb, a);
  }
  syncTweaksFromBody() {
    for (const a of Zb) {
      const r = o8(a);
  ...
  observeBodyTweaks() {
    typeof MutationObserver > "u" || !document.body || (this.observer && this.observer.disconnect(), this.observer = new MutationObserver(() => this.syncTweaksFromBody()), this.observer.observe(document.body, {
      attributes: !0,
      attributeFilter: Zb.map((a) => `data-${a}`)
    }));
  }
  set hostContext(a) {
  ...
  paint() {
    ...
    const a = this.resolveInitialEntry(), r = X2(t8(), { initialEntries: [a] });
    this.router = r, this.root.render(
      /* @__PURE__ */ b.jsx(_.StrictMode, { children: /* @__PURE__ */ b.jsx(Z2, { router: r }) })
    );
  }
  resolveInitialEntry() {
...
function c8() {
  typeof customElements > "u" || customElements.get(Zh) || customElements.define(Zh, u8);
}
typeof customElements < "u" && !customElements.get(Zh) && c8();
export {
  c8 as register
};
