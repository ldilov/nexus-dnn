...
export const bar = style({
  ...
  background: `color-mix(in oklab, ${vars.color.surfaceHighest} 94%, transparent)`,
  boxShadow: `0 18px 44px -12px rgba(0, 0, 0, 0.7), 0 6px 18px -6px rgba(0, 0, 0, 0.55), inset 0 0 0 1px color-mix(in oklab, ${vars.color.accent} 38%, transparent), inset 0 1px 0 0 color-mix(in oklab, white 9%, transparent)`,
