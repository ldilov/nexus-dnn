...
export const vars = createGlobalTheme("faceavatar-app", {
  color: {
...
globalStyle('faceavatar-app[data-accent="primary"], faceavatar-app:not([data-accent])', {
  vars: {
    "--accent": "#ba9eff",
    "--accent-dim": "#8455ef",
...
globalStyle('faceavatar-app[data-accent="secondary"]', {
  vars: {
    "--accent": "#9093ff",
    "--accent-dim": "#6063ee",
...
globalStyle('faceavatar-app[data-accent="tertiary"]', {
  vars: {
    "--accent": "#ff8439",
    "--accent-dim": "#fd761a",
...
globalStyle('faceavatar-app[data-density="compact"]', {
  vars: {
    "--d-1": "2px",
    "--d-2": "6px",
    "--d-3": "8px",
...
globalStyle('faceavatar-app[data-density="cozy"], faceavatar-app:not([data-density])', {
  vars: {
    "--d-1": "4px",
    "--d-2": "8px",
    "--d-3": "12px",
...
globalStyle('faceavatar-app[data-density="spacious"]', {
  vars: {
    "--d-1": "6px",
    "--d-2": "10px",
    "--d-3": "16px",
...
globalStyle("faceavatar-app *, faceavatar-app *::before, faceavatar-app *::after", {
  boxSizing: "border-box",
});

globalStyle("faceavatar-app ::selection", {
  background: `color-mix(in oklab, ${vars.color.accent} 38%, transparent)`,
  color: vars.color.text,
});

globalStyle("faceavatar-app code, faceavatar-app pre", {
  fontFamily: vars.font.mono,
});

globalStyle(
  [
    "faceavatar-app button:focus-visible",
    "faceavatar-app a:focus-visible",
    "faceavatar-app input:focus-visible",
    "faceavatar-app select:focus-visible",
    "faceavatar-app [tabindex]:focus-visible",
  ].join(", "),
  {
    outline: "none",
...
globalStyle("faceavatar-app *::-webkit-scrollbar", {
  width: "10px",
  height: "10px",
});

globalStyle("faceavatar-app *::-webkit-scrollbar-track", {
  background: "transparent",
});

globalStyle("faceavatar-app *::-webkit-scrollbar-thumb", {
...
globalStyle("faceavatar-app *::-webkit-scrollbar-thumb:hover", {
  background: "color-mix(in oklab, var(--outline-variant, #46484a) 100%, transparent)",
  backgroundClip: "padding-box",
});

globalStyle("faceavatar-app *::-webkit-scrollbar-thumb:active", {
