...
const TAG = "faceavatar-app";
const HOST_EVENT = "ext-event";
const STYLESHEET_ID = "faceavatar-stylesheet";
...
function ensureStylesheet(): void {
  ...
  const href = new URL("./faceavatar.css", import.meta.url).href;
...
class FaceAvatarAppElement extends HTMLElement {
...
export function register(): void {
  ...
  customElements.define(TAG, FaceAvatarAppElement);
}
