...
def tune_custom_lora_scale(model, scale_factor):
    # Traverse the model's modules and adjust the scaling factor of LoRA layers
    for name, module in model.named_modules():
        if isinstance(module, LoRALinearLayer):  # Check if the module is a LoRA layer
            module.scale_factor = scale_factor  # Adjust the scale factor
