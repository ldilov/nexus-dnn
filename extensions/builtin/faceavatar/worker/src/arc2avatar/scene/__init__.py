...
from scene.dataset_readers import sceneLoadTypeCallbacks,GeneratePurnCameras,GenerateCircleCameras, GenerateRandomCameras
from scene.gaussian_model import GaussianModel
from arguments import ModelParams, GenerateCamParams
from utils.camera_utils import camera_to_JSON, cameraList_from_RcamInfos
import trimesh
...
class Scene:
    ...
    def __init__(self, args : ModelParams, pose_args : GenerateCamParams, gaussians : GaussianModel, load_iteration=None, shuffle=False, resolution_scales=[1.0],
                 template_path="scene/template/masked_template.ply"):
        """b
        ...
        self.cameras_extent = pose_args.default_radius 
    ...
    def getRandTrainCameras(self, scale=1.0, rad_scale=1, fov=1):
        rand_train_cameras = GenerateRandomCameras(self.pose_args, self.args.batch, SSAA=True, fov=fov)
        train_cameras = {}
