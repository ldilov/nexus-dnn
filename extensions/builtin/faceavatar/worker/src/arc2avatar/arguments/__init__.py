...
class OptimizationParams(ParamGroup):
    def __init__(self, parser, opts=None):
        ...
        self.position_lr_init = 0.00014
        self.position_lr_final = 0.0000014
        self.position_lr_delay_mult = 0.01
        self.position_lr_max_steps = 30_000
        self.feature_lr = 0.005
        self.feature_lr_masked = 0.005 
        self.feature_lr_final = 0.003

        self.opacity_lr = 0.0175
        self.opacity_lr_masked = 0.0175
        self.scaling_lr = 0.0025
        self.scaling_lr_masked = 0.0025
        self.scaling_lr_final = 0.0005

        self.rotation_lr = 0.001
        self.rotation_lr_final = 0.0002

        # ─────────────────── alternate (expr) hyper-parameters ──────────────────
        self.expr_position_lr_init   = 0.00014
        self.expr_position_lr_final  = 0.0000014
        self.expr_feature_lr         = 0.0050
        self.expr_feature_lr_final   = 0.0030

        self.expr_opacity_lr         = 0.05
        self.expr_scaling_lr         = 0.005
        self.expr_scaling_lr_final   = 0.0005

        self.expr_rotation_lr        = 0.001
        self.expr_rotation_lr_final  = 0.0002
        # ──────────────────────────────────────────────────────────────────────────
...
class GenerateCamParams(ParamGroup):
    def __init__(self, parser):
        self.radius_range = [5.2, 5.5] #[3.8, 4
        self.max_radius_range = [3.5, 5.0]
        self.back_radius_range = [5.2, 5.5] #[3.8, 4
        self.back_max_radius_range = [3.5, 5.0]
