...
const TAG = "trellis2-app";
const HOST_EVENT = "ext-event";
const STYLESHEET_ID = "trellis2-stylesheet";
...
function ensureStylesheet(): void {
  ...
  const href = new URL("./trellis2.css", import.meta.url).href;
...
class Trellis2AppElement extends HTMLElement {
...
export function register(): void {
  ...
  customElements.define(TAG, Trellis2AppElement);
}
