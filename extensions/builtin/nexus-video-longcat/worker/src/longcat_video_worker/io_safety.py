...
_UV_ENV_ALLOWLIST = frozenset(
    {
        ...
        # Nexus-specific
        "NEXUS_HOST_DATA_DIR",
        "NEXUS_VIDEO_LONGCAT_MODEL_DIR",
        "NEXUS_VIDEO_LONGCAT_RUNTIME",
        "NEXUS_VIDEO_LONGCAT_DIT_FP8",
        "NEXUS_VIDEO_LONGCAT_VENDOR_DIR",
        "NEXUS_VIDEO_LONGCAT_LORA_DIR",
        "NEXUS_VIDEO_LONGCAT_ATTN",
        "NEXUS_VIDEO_LONGCAT_BLOCK_SWAP",
        "NEXUS_VIDEO_LONGCAT_OFFLOAD_MODE",
    }
)
