...
pub struct AppState {
    ...
    pub dep_handler_registry:
        Option<Arc<nexus_extension_deps::HandlerRegistry>>,
    pub dep_install_state:
        Arc<dashmap::DashMap<String, Arc<tokio::sync::Mutex<nexus_extension_deps::ExtensionInstallState>>>>,
    pub dep_runtime_bootstrapper:
        Option<Arc<dyn nexus_extension_deps::RuntimeBootstrapper>>,
