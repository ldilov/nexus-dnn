...
pub use bundle::{
    BUNDLE_PACKAGE_VERSION, BundleCompatSummary, BundleError, BundleWorkflowSnapshot,
    ExtensionRequirement, Integrity, OperatorRequirement, RecipeBundle, RecipeManifest,
    Requirements, export_recipe_bundle, validate_bundle,
};
...
pub use migrate::{MigrationCopyPlan, MigrationSource, NewUserRecipe, build_migration_copy};
...
pub use upgrade::{
    BrokenBinding, NodeChange, NodeChangeKind, RecipePinDiff, UpgradeRisk, diff_recipe_pin,
};
