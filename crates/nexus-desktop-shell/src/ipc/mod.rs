...
//! it routes commands by name, not by domain. Every Phase-2 stub returns
//! [`crate::IpcError::not_implemented`]; Phase 3+ tasks fill in the real
//! bodies once the embedded `nexus-api` host is linked into the desktop
//! binary.
...
/// a command requires three changes: (1) the stub function, (2) inclusion in
/// `tauri::generate_handler![..]` below, (3) the corresponding allow entry
